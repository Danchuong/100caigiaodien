...
- Refero URL: https://styles.refero.design/style/7c38e84b-aea0-4c8f-b3e9-60b994ee6c6b
- Site URL: https://www.slash.com
- ID: 7c38e84b-aea0-4c8f-b3e9-60b994ee6c6b
- Theme: dark
- Industry: fintech
- Created: 2026-04-30T00:26:09.009Z
- Ranks: newest: 801, popular: 174, trending: 107
...
| --- | --- | --- | --- | --- | --- |
| Inter | system-ui | 300, 400, 500, 600, 700 | 12px, 13px, 14px, 15px, 16px, 18px, 20px, 24px, 32px, 48px, 52px | 1.00, 1.13, 1.25, 1.33, 1.38, 1.43, 1.50, 1.56 | Primary typeface for all UI elements, body text, and functional components. Its clean, sans-serif design maintains legibility and a modern, technical feel across various densities and scales. |
| Ivy Presto | Playfair Display | 400, 500 | 32px, 52px, 64px, 88px | 1.00, 1.13, 1.25 | Decorative display typeface for large, impactful headlines and hero text. The serif design provides an air of traditional luxury and authority, contrasting with the utilitarian Inter. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777508741958-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777508741958-thumb.jpg |
