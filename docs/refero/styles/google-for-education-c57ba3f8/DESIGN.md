# Google for Education — Refero Style

- Refero URL: https://styles.refero.design/style/c57ba3f8-1d76-4660-8ba4-48ddce26e759
- Site URL: https://classroom.google.com
- ID: c57ba3f8-1d76-4660-8ba4-48ddce26e759
- Theme: light
- Industry: other
- Created: 2026-03-19T17:02:30.000Z
- Ranks: newest: 1024, popular: 484, trending: 664
...
| --- | --- | --- | --- | --- | --- |
| Google Sans Display | system-ui | 400, 500, 700 | 16px, 18px, 20px, 22px, 28px, 48px, 80px | 1.09, 1.15, 1.17, 1.20, 1.29, 1.40, 1.50, 1.56, 1.75 | Used for all major headings and display text. Its sans-serif clarity and relatively generous letter-spacing at larger sizes ensure prominent yet approachable statements. The careful weight distinctions from 400 to 700 help establish a clear hierarchy. |
| Google Sans Text | system-ui | 300, 400, 500 | 12px, 14px, 16px, 18px | 1.00, 1.44, 1.50, 1.56, 1.63, 1.67, 1.71 | The primary font for body text, navigation, buttons, and other UI elements. Its legibility across various sizes and weights (especially the lighter 300) contributes to the system's clean, understated feel, making information easy to process. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775933086240-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775933086240-thumb.jpg |
