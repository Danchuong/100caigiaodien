# Essie Wine — Refero Style

- Refero URL: https://styles.refero.design/style/07f5281d-2a18-4e12-a8ff-d54d3e03d198
- Site URL: https://www.essiewine.com
- ID: 07f5281d-2a18-4e12-a8ff-d54d3e03d198
- Theme: light
- Industry: other
- Created: 2026-04-30T03:36:23.532Z
- Ranks: newest: 115, popular: 1251, trending: 1268
...
| --- | --- | --- | --- | --- | --- |
| BasicCommercial LT Com Roman | Inter | 300, 400 | 19px, 38px, 49px | 1.16, 1.18, 1.20 | Main navigation, larger headings, and body text. Its clean, condensed sans-serif provides modern legibility against the serif. |
| Adobe Caslon Pro | Libre Baskerville | 300 | 49px | 1.18 | Primary headings, subheadings, and featured text blocks. The traditional serif conveys authority and elegance, creating an established, classic brand feel. Its lightness at 300 weight is distinctive, suggesting understated professionalism. |
| Elementa | Graphik | 300, 400 | 16px, 19px | 1.00, 1.16 | Paragraph text, small labels, and detailed content. A highly readable sans-serif for practical information. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777520161697-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777520161697-thumb.jpg |
