...
- Refero URL: https://styles.refero.design/style/1b44386e-31a8-40b0-a577-27c088b51264
- Site URL: https://lusion.co
- ID: 1b44386e-31a8-40b0-a577-27c088b51264
- Theme: light
- Industry: agency
- Created: 2026-01-28T19:49:45.000Z
- Ranks: newest: 1261, popular: 501, trending: 619
...
| --- | --- | --- | --- | --- | --- |
| Aeonik | system-ui (sans-serif) | 400, 500 | 12px, 13px, 14px, 16px, 18px, 20px, 22px, 26px, 36px, 38px, 43px, 49px, 50px, 108px, 115px, 144px | 0.90, 1.00, 1.10, 1.15, 1.20, 1.40, 1.50 | All textual content: headings, body text, buttons, links, and inputs. The consistent application of Aeonik across all roles contributes to the system's coherent, slightly technical feel, with negative letter spacing adding to the precise aesthetic. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775925120639-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775925120639-thumb.jpg |
