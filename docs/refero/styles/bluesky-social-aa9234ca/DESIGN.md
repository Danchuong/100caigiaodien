# Bluesky Social — Refero Style

- Refero URL: https://styles.refero.design/style/aa9234ca-0cc8-470b-bd38-398712de3e95
- Site URL: https://bsky.app
- ID: aa9234ca-0cc8-470b-bd38-398712de3e95
- Theme: light
- Industry: media
- Created: 2026-02-25T12:36:25.000Z
- Ranks: newest: 1132, popular: 555, trending: 665
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Canvas White | #ffffff | neutral | Page backgrounds, dialogs, primary surfaces |
| Ebony Text | #000000 | neutral | Body text, primary headings, essential UI elements for maximum legibility |
| Sky Blue | #006aff | brand | Interactive elements, primary call-to-action buttons, active states, links — signaling interactive affordances with a burst of color on an otherwise monochrome canvas |
| Horizon Gray | #dce2ea | neutral | Subtle borders, dividers, inactive states, subtle backgrounds for content separation without harsh lines |
| Cloud Cover | #f9fafb | neutral | Secondary background surfaces, subtle elevation differences, card backgrounds |
| Ghost Button Background | #eff2f6 | neutral | Background for secondary buttons, search bars, and interactive components that require a soft, non-intrusive fill |
| Slate Text | #405168 | neutral | Secondary text, metadata, tooltips — providing hierarchical differentiation from primary text |
| Steel Icon | #667b99 | neutral | Default iconography, less emphasized UI elements — receding into the background without disappearing |
| Icon Gray | #8798b0 | neutral | Subtle icons, inactive states on interactive elements |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| InterVariable | Inter | 400, 500, 600, 700 | 11px, 12px, 13px, 15px, 16px, 24px | 1.00, 1.13, 1.20, 1.25, 1.30, 1.33 | The primary and only typeface, covering all text elements from small captions to large headlines. Its high legibility and variable nature allow for precise visual hierarchy and density control within a minimalist interface. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775926047160-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775926047160-thumb.jpg |
