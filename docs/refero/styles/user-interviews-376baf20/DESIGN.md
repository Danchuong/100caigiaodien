# User Interviews — Refero Style

- Refero URL: https://styles.refero.design/style/376baf20-9ace-405d-bf4a-086016f2b1e3
- Site URL: https://www.userinterviews.com
- ID: 376baf20-9ace-405d-bf4a-086016f2b1e3
- Theme: light
- Industry: saas
- Created: 2026-04-30T00:56:37.047Z
- Ranks: newest: 657, popular: 256, trending: 168
...
| --- | --- | --- | --- | --- | --- |
| sofia-pro | Montserrat, Lato | 400, 500, 700 | 12px, 13px, 14px, 16px, 18px, 19px, 20px, 22px, 24px | 1.00, 1.27, 1.33, 1.38, 1.40, 1.43, 1.44, 1.46, 1.50, 1.53, 1.56, 1.71, 2.00 | Primary UI text, body copy, navigation, buttons, and form labels. Its geometric yet friendly presence ensures clarity across functional elements. Note the slight negative letter-spacing on larger sizes at -0.01em for improved visual density. |
| p22-mackinac-pro | Merriweather, Playfair Display | 400, 500 | 30px, 44px, 50px, 64px | 1.16, 1.20, 1.32, 1.33 | Primary headings. This serif font provides a distinct, authoritative voice for main titles and section headers, contrasting with the sans-serif body text for clear hierarchy. |
| P 22 Mackinac italic | Merriweather Italic, Playfair Display Italic | 700 | 30px, 36px, 50px | 1.17, 1.20, 1.33 | Emphatic headings and callouts, leveraging its italic style for visual flair within larger headings. |
| IBM Plex Mono | Roboto Mono, Space Mono | 400, 500, 600 | 13px, 14px, 15px, 17px, 20px | 1.30, 1.57, 1.69, 2.24, 2.76 | Used for code snippets, data displays, and instances requiring a technical or structured feel, providing clear legibility for numerical or code-like information. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777510566424-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777510566424-thumb.jpg |
