...
- Refero URL: https://styles.refero.design/style/ef44a995-6745-4dc7-86ab-f7227f108f81
- Site URL: https://mobbin.com
- ID: ef44a995-6745-4dc7-86ab-f7227f108f81
- Theme: light
- Industry: design
- Created: 2026-04-04T09:08:41.000Z
- Ranks: newest: 960, popular: 210, trending: 615
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Midnight Ink | #141414 | neutral | Primary text, headings, filled CTA buttons, nav items, icon strokes — the single chromatic workhorse of an achromatic system |
| Pure Canvas | #ffffff | neutral | Page background, card surfaces, button text on dark fills |
| Graphite | #707070 | neutral | Body copy, secondary links, descriptive text |
| Ash | #adadad | neutral | Tertiary text, disabled/muted button borders, placeholder icons |
| Fog | #ededed | neutral | Dividers, subtle borders, card outlines |
| Mist | #f2f2f2 | neutral | Nav background tint, input fields, inner surface elevation |
| Silver | #c2c2c2 | neutral | Skeleton loaders, inactive UI fills |
| Slate Shadow | #e0e0e0 | neutral | Inset button shadow ring (rgba(64,64,64,0.16) 0px 0px 0px 1px) |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| saans | Inter Variable or Geist (closest variable-axis fallbacks with comparable optical geometry) | 400, 440, 456, 600, 652 | 12px, 14px, 16px, 20px, 32px, 56px, 80px | 1.00–1.50 (tight 1.00–1.15 at display, looser 1.38–1.50 at body) | Every text element on the site. Fractional weights (440, 456, 652) are the signature — they occupy visual mass between Regular and Semibold that no variable-axis font exposes as named stops. Display headlines at 80px/56px run weight 600–652 at lineHeight 1.00–1.13 with negative letter-spacing (-0.011em at large sizes). Body runs 14–16px at weight 400 with tracking +0.013–0.017em for small-size legibility. |
...
| body-sm | 14 | 20 |  |
| body | 16 | 22 | 0.21 |
| subheading | 20 | 28 | 0.28 |
| heading | 32 | 42 |  |
| heading-lg | 56 | 63 | -0.39 |
| display | 80 | 80 | -0.88 |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775938447226-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775938447226-thumb.jpg |
| preview video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/ef44a995-6745-4dc7-86ab-f7227f108f81-1777560077230-preview.mp4 |
| preview video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/ef44a995-6745-4dc7-86ab-f7227f108f81-1777560077230-preview-poster.jpg |
| detail video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/ef44a995-6745-4dc7-86ab-f7227f108f81-1777560077230-preview-detail.mp4 |
| detail video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/ef44a995-6745-4dc7-86ab-f7227f108f81-1777560077230-preview-detail-poster.jpg |
