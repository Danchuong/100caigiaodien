# Julia Krantz — Refero Style

- Refero URL: https://styles.refero.design/style/92857b05-1c01-4c7a-b196-beb4e4871998
- Site URL: https://juliakrantz.com
- ID: 92857b05-1c01-4c7a-b196-beb4e4871998
- Theme: dark
- Industry: agency
- Created: 2026-04-28T21:33:22.049Z
- Ranks: newest: 898, popular: 1207, trending: 1166
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Void | #000000 | neutral | Page canvas, all section backgrounds — the true floor of the UI; every element floats above absolute black |
| Salt | #f8f8f8 | neutral | All text, links, nav labels, borders, icons — the single foreground tone serving every text and UI edge function against black |
| Ash | #707070 | neutral | Secondary labels, muted nav text, subdued body copy — mid-tone for visual hierarchy without introducing any hue |
| Ghost Line | #f8f8f8 | neutral | Grid tile borders, dividers — rgba(248,248,248,0.12) at 12% opacity; nearly invisible structural seams |
| Veil | #f8f8f8 | neutral | Overlay labels, secondary text on image tiles — rgba(248,248,248,0.45) at 45% opacity for text sitting over photography |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| DM Sans | DM Sans (Google Fonts — same family) | 300 | 10px, 12px, 13px, 14px | 1.30 – 1.72 | All body copy, navigation labels, press list items, links, captions. Weight 300 across every size — the site refuses to bold anything in this family, keeping the text layer visually quiet against photography. |
| ClashDisplay | Cabinet Grotesk (Fontshare) or Space Grotesk (Google Fonts) | 300, 500 | 10px, 12px, 14px, 29px, 44px | 1.00 at display / 1.72 at text sizes | Project initials on tiles (44px weight 300, tracking -0.04em), section codes and labels (12-14px weight 300, tracking +0.05em to +0.14em), name logotype. The 44px weight-300 display setting — a nearly invisible letterform over a photograph — is the signature visual move of the portfolio. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777411901935-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777411901935-thumb.jpg |
