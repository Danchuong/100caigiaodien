# Hyper Tria — Refero Style

- Refero URL: https://styles.refero.design/style/6665a3dd-606f-4fd1-80dd-a84e3b3a6226
- Site URL: https://hypertria.com
- ID: 6665a3dd-606f-4fd1-80dd-a84e3b3a6226
- Theme: light
- Industry: agency
- Created: 2026-04-30T02:43:42.170Z
- Ranks: newest: 307, popular: 871, trending: 807
...
| --- | --- | --- | --- | --- | --- |
| Aeonik | system-ui | 300, 400, 500 | 13px, 14px, 19px, 20px, 27px, 30px, 35px, 75px, 90px | 0.90, 1.00, 1.11, 1.16, 1.45, 1.48, 1.70, 2.23 | Primary brand typeface for all headings and body text, providing a premium, contemporary feel with its distinct tracking at larger sizes. |
| -apple-system |  | 400 | 14px, 28px, 30px | 1.50, 1.70 | Fallback system font for navigation, labels, and smaller text, ensuring broad compatibility while aligning with a clean aesthetic. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777516999150-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777516999150-thumb.jpg |
