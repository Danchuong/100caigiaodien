# Helloivy — Refero Style

- Refero URL: https://styles.refero.design/style/5af6b791-6cad-4497-9e94-ace28e4fbd51
- Site URL: https://helloivy.co
- ID: 5af6b791-6cad-4497-9e94-ace28e4fbd51
- Theme: light
- Industry: productivity
- Created: 2026-03-26T18:48:42.000Z
- Ranks: newest: 995, popular: 578, trending: 978
...
| --- | --- | --- | --- | --- | --- |
| Unbounded | Montserrat, Poppins | 400, 500 | 20px, 34px, 62px, 82px | 1.10, 1.20, 1.40 | Display headlines and section titles — its geometric, strong character provides a modern, impactful presence, especially when rendered in high weights and large sizes. The increased letter-spacing at larger sizes adds an airy, deliberate feel. |
| Inter | Inter | 400, 500, 600, 700 | 12px, 14px, 16px, 18px, 24px, 27px, 32px | 1.20, 1.40, 1.50, 1.57, 1.60 | Primary body text, subheadings, and UI labels — its legibility and modern geometric construction make it ideal for dense information. The consistent slight negative letter-spacing (-0.02em) across all sizes enhances text density without sacrificing readability. |
| system-ui (sans-serif fallback) | inherit | 400 | 12px | 1.20 | Small utility text, inline links, and discreet UI elements where Inter might be too strong — provides a lighter touch for less critical information or when a subtle system font is preferred. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775932463602-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775932463602-thumb.jpg |
