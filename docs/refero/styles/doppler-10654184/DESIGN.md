# Doppler — Refero Style

- Refero URL: https://styles.refero.design/style/10654184-eb92-4b75-a7af-bd92bc6cdc5c
- Site URL: https://doppler.com
- ID: 10654184-eb92-4b75-a7af-bd92bc6cdc5c
- Theme: dark
- Industry: devtools
- Created: 2026-03-31T13:42:47.000Z
- Ranks: newest: 974, popular: 395, trending: 445
...
| --- | --- | --- | --- | --- | --- |
| Doppler Repro | Inter | 400, 450, 500, 700 | 12px, 14px, 15px, 16px, 18px, 24px, 32px, 48px, 64px, 96px | 1.00, 1.05, 1.15, 1.20, 1.40, 1.50 | The sole typeface for all content. Its versatility across weights and sizes, combined with micro letter-spacing adjustments, maintains a sleek, optimized feel across headlines and body text. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775932284864-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775932284864-thumb.jpg |
