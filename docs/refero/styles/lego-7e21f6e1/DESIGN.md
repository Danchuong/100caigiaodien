...
- Refero URL: https://styles.refero.design/style/7e21f6e1-deec-4bc4-a30e-f2c9d3320314
- Site URL: https://lego.com
- ID: 7e21f6e1-deec-4bc4-a30e-f2c9d3320314
- Theme: light
- Industry: ecommerce
- Created: 2026-03-27T19:15:39.000Z
- Ranks: newest: 988, popular: 154, trending: 884
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| LEGO Yellow | #FFD502 | brand | Logo background, badges, active nav indicators, brand accent — the single chromatic constant that appears regardless of page section, making every badge feel like a price sticker on a toy box. |
| Brick Orange | #F47D20 | brand | Primary CTA buttons ('Buy now', 'Add to Bag', 'Become a member') — warm against white product backgrounds, the only pill button fill color for purchase actions. |
...
| Action Blue | #005AD2 | accent | Secondary action buttons ('Become a member', 'Learn more'), interactive link emphasis — the outlined pill button border and text color. |
...
| Graphite | #2C2C2C | neutral | Secondary text, badge labels, footer body text, nav items. |
| Pitch | #000000 | neutral | Button label text on orange CTAs, heavy borders on ghost buttons. |
| Snow | #FFFFFF | neutral | Page background, card surfaces, input backgrounds, text on dark surfaces. |
| Fog | #F2F2F2 | neutral | Secondary button fill (icon-only circular buttons, wishlist/cart controls), subtle surface backgrounds. |
| Pebble | #F6F6F6 | neutral | Page section backgrounds, list row fills — one step warmer than pure white. |
| Steel | #757575 | neutral | Disabled state text, muted borders, helper text. |
| Silver | #E0E0E0 | neutral | Input borders in default state. |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Cera Pro | Nunito, Poppins | 400, 500, 700 | 12px, 14px, 16px, 18px, 19px, 20px, 24px, 30px, 37px | 1.15–1.62 (display: 1.15, body: 1.50–1.58) | The only typeface on the site. Weight 700 at 24–37px for headings with -0.02em tracking — the negative spacing compensates for the geometric roundness of Cera Pro at large sizes, preventing letters from floating apart. Weight 500 for subheadings and labels. Weight 400 for body, nav links, and badge text. The custom geometric rounded sans directly mirrors LEGO brick corner geometry — a system font would read as generic where Cera Pro reads as branded. |
| Cera Pro Italic | Nunito Italic | 400 | 12px | 1.58 | Caption-level italic, used for fine-print disclaimers and legal copy only. |

## Type Scale

| Role | Size | Line Height | Letter Spacing |
| --- | --- | --- | --- |
| caption | 12 | 1.58 | 0.12 |
| body-sm | 14 | 1.56 |  |
| body | 16 | 1.5 |  |
| subheading | 18 | 1.36 |  |
| heading-sm | 20 | 1.35 |  |
| heading | 24 | 1.19 | -0.48 |
| heading-lg | 30 | 1.15 | -0.3 |
| display | 37 | 1.15 | -0.74 |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775934799588-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775934799588-thumb.jpg |
