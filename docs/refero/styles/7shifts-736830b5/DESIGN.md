# 7shifts — Refero Style

- Refero URL: https://styles.refero.design/style/736830b5-90b1-47b0-99dd-d79454a0d22a
- Site URL: https://www.7shifts.com
- ID: 736830b5-90b1-47b0-99dd-d79454a0d22a
- Theme: light
- Industry: saas
- Created: 2026-04-30T00:44:25.717Z
- Ranks: newest: 712, popular: 536, trending: 319
...
| --- | --- | --- | --- | --- | --- |
| Regular | Inter | 400 | 11px, 12px, 14px, 16px, 18px, 36px, 64px | 1.00, 1.11, 1.14, 1.20, 1.30, 1.33, 1.38, 1.40, 1.50, 1.56 | Body text, navigation items, descriptive content, and primary headlines — a versatile, compact sans-serif that balances readability with a contemporary feel across all textual elements. |
| Medium | Inter | 500 | 11px, 12px, 14px, 16px, 18px, 24px, 28px, 36px, 40px, 48px, 64px, 120px, 150px | 0.75, 0.90, 0.93, 1.00, 1.10, 1.11, 1.33, 1.40, 1.43, 1.50 | Call-to-action text, sub-headings, and emphasized content — providing subtle weight distinction for prominence without heavy boldness. |
| Nanum Pen Script | Kalam | 400, 500 | 28px, 30px | 1.00, 1.50 | Decorative headlines and accent text — a handwritten script that adds a personal, informal touch to selected titles. |
| Bold | Inter | 700 | 14px | 1.14 | Strong emphasis on small-form headings or labels — used sparingly for high impact within compact UI elements. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777509832474-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777509832474-thumb.jpg |
