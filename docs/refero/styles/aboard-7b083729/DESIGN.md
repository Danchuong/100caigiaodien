...
- Refero URL: https://styles.refero.design/style/7b083729-e694-4b66-82a3-befb08451722
- Site URL: https://aboard.com
- ID: 7b083729-e694-4b66-82a3-befb08451722
- Theme: dark
- Industry: ai
- Created: 2026-04-30T00:54:00.003Z
- Ranks: newest: 669, popular: 179, trending: 127
...
| --- | --- | --- | --- | --- | --- |
| Tobias | Playfair Display | 300 | 24px, 32px, 72px | 1.10, 1.30 | Display and major headings — its elegant structure and light 300 weight command attention without shouting, providing sophistication. |
| Atkinson Hyperlegible Mono | IBM Plex Mono | 300 | 10px, 12px, 14px, 16px | 1.57, 1.60, 1.63, 1.83 | Specialized text, code snippets, and certain list items — its monospaced nature anchors technical references and offers a distinct textural contrast. |
| Work Sans | Inter | 400 | 12px, 16px | 1.63, 1.83 | Navigation, body text, and button labels — a clean, legible workhorse that maintains consistency across interactive elements. |
| ui-sans-serif | system-ui | 400 | 16px | 1.50 | Default system font for general UI elements, ensuring broad compatibility and accessibility for supplementary text. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777510407125-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777510407125-thumb.jpg |
