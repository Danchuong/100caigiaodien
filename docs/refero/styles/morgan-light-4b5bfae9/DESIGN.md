# Morgan Light — Refero Style

- Refero URL: https://styles.refero.design/style/4b5bfae9-69ef-46ec-ad6d-ff9a8bfe3525
- Site URL: https://morganlight.com
- ID: 4b5bfae9-69ef-46ec-ad6d-ff9a8bfe3525
- Theme: light
- Industry: design
- Created: 2026-04-30T03:25:50.371Z
- Ranks: newest: 156, popular: 1153, trending: 1131
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Canvas White | #e5e7eb | neutral | Hairline borders, dividers, input outlines, and card edges on light surfaces. Do not promote it to the primary CTA color |
| Ink Black | #000000 | neutral | Primary text, headings, links, and bold accents for navigation items |
| Subtle Gray | #b5b5b5 | neutral | Muted helper text, secondary information, and subtle category labels |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Neue | Helvetica Neue, Arial | 400 | 14px, 16px | 1.14, 1.50 | The primary typeface for all text content, from navigation to body text. Its singular, moderate weight contributes to the system's unassuming and direct presentation, acting as a label rather than a statement. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777519537661-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777519537661-thumb.jpg |
