...
- Refero URL: https://styles.refero.design/style/17d0a00e-5de6-48c7-9f3b-25b04f7dab4c
- Site URL: https://www.canva.com
- ID: 17d0a00e-5de6-48c7-9f3b-25b04f7dab4c
- Theme: light
- Industry: design
- Created: 2026-04-29T00:42:44.652Z
- Ranks: newest: 890, popular: 839, trending: 576
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Canvas White | #ffffff | neutral | Page backgrounds, default foreground for most UI components, card backgrounds for feature cards. |
| Ink Black | #000000 | neutral | Primary text, critical headings, borders for ghost buttons and text links. |
| Midnight Graphite | #0f1015 | neutral | Darkest card backgrounds, background for various UI elements in feature sections, text on light backgrounds. |
| Storm Gray | #575a5f | neutral | Secondary text, muted interactive elements, button text on lighter backgrounds, borders for some interactive components. |
| Porcelain Accent | #d7d9de | neutral | Subtle border accents, box shadows for elevated elements. |
| Canva Violet | #8b3dff | brand | Primary action background, links, accents for interactive states. |
| Subtle Violet | #a370fc | accent | Decorative borders, secondary link accents. |
| Deep Violet | #9729ff | accent | Fills for icons and decorative elements, borders in specific UI contexts. |
| Coral Glow | #ff6105 | accent | Accent for status indicators, small icons, highlight elements. |
| Passion Red | #ff3d4d | accent | Accent for status indicators, small icons, highlight elements. |
| Fuchsia Pop | #e950f7 | accent | Accent for status indicators, small icons, highlight elements. |
| Hero Aqua-Violet Gradient | #00c4cc | brand | Primary hero section background, providing a dynamic and inviting visual entry point. |
| Multi-Spectrum Gradient | #992bff | brand | Complex background fills for large marketing areas, representing creative diversity. |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Times | serif | 400 | 10px | 1.20 | System fallback text. Used for very small labels or browser-default elements when Canva Sans is unavailable or explicitly overridden. |
| Canva Sans | ui-sans-serif, system-ui | 400, 500, 600 | 14px, 16px, 18px, 21px, 24px, 28px, 32px, 36px, 56px, 64px, 84px | 1.06, 1.10, 1.25, 1.33, 1.38, 1.40, 1.50, 1.57 | Primary brand typeface for all headings, body text, and UI elements. Its strong yet approachable geometric forms convey professionalism without being overly formal, especially at larger sizes. |
| Arial | sans-serif | 400 | 13px | 1.20 | System fallback or context-specific UI text. Appears in some button and body contexts, ensuring readability on a variety of systems. |
...
| body | 16 | 1.5 | -0.16 |
| subheading | 18 | 1.4 | -0.324 |
| heading-sm | 21 | 1.38 | -0.378 |
| heading | 24 | 1.33 | -0.432 |
| display-md | 32 | 1.1 | -0.576 |
| display-lg | 36 | 1.06 | -0.648 |
| display-xl | 56 | 1.06 | -1.008 |
| display-2xl | 64 | 1.06 | -1.152 |
| display-3xl | 84 | 1.06 | -1.512 |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777423334875-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777423334875-thumb.jpg |
