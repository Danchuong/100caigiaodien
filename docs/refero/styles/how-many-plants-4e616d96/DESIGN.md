# How Many Plants — Refero Style

- Refero URL: https://styles.refero.design/style/4e616d96-14ea-43d6-9662-0ad3fa19ef7c
- Site URL: https://howmanyplants.com
- ID: 4e616d96-14ea-43d6-9662-0ad3fa19ef7c
- Theme: light
- Industry: design
- Created: 2026-04-30T03:56:12.149Z
- Ranks: newest: 25, popular: 940, trending: 924
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Canvas Cream | #f9f5f1 | neutral | Page backgrounds, card surfaces, ghost button background, active link borders |
| Inkwell Black | #222222 | neutral | Primary text, heading text, icon fills, strong borders, active button text, search input borders |
| Sprout Green | #bfb33b | brand | Decorative accents, illustrative elements, button outline (as a shadow), subtle surface background occasionally |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Chromatica | Playfair Display | 400, 500 | 14px, 16px, 20px, 24px, 36px | 0.89, 1.33, 1.43, 1.60, 2.00 | Headlines, navigation links, and prominent display text capitalize on its custom serif character for an illustrative, editorial feel. Its tight leading for larger sizes creates a stacked effect, enhancing visual density. |
| Hellenictypewriter | Roboto Mono | 400, 500 | 16px, 20px, 28px, 36px | 1.14, 1.25, 1.33, 1.60 | Body text, input fields, and button labels gain a warm, approachable, and slightly retro tone through this custom typewriter sans-serif. Its monospaced feel contrasts with the serifs, providing a grounded, readable counterpoint. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777521343288-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777521343288-thumb.jpg |
