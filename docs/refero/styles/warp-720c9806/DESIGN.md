...
- Refero URL: https://styles.refero.design/style/720c9806-2d70-4dd1-9a19-12efd71fc742
- Site URL: https://warp.dev/terminal
- ID: 720c9806-2d70-4dd1-9a19-12efd71fc742
- Theme: dark
- Industry: devtools
- Created: 2026-04-13T15:40:05.000Z
- Ranks: newest: 916, popular: 205, trending: 222
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Void Canvas | #121212 | neutral | Primary page background, dominant surface beneath all content |
| Obsidian Deep | #090909 | neutral | Deepest layer — nav overlays, announcement bar background |
| Charcoal Surface | #1e1e1d | neutral | Footer background, slightly elevated surface above canvas |
| Iron Surface | #353534 | neutral | Raised card surfaces, pill button backgrounds, interactive containers |
| Graphite Lift | #2f2f2f | neutral | Nav borders, filled dark button backgrounds — the primary interactive fill |
| Slate Hover | #40403f | neutral | Hover-state surfaces, slightly elevated overlays |
| Ash Text | #868684 | neutral | Secondary body text, muted link text, hairline borders |
| Fog Text | #afaeac | neutral | Tertiary body text, disabled or de-emphasized labels |
| Smoke Text | #e3e2e0 | neutral | Announcement bar text, code snippet text, subheadings at reduced emphasis |
| Warm White | #faf9f6 | neutral | Highest-contrast text on dark backgrounds, filled light button backgrounds |
| Pure White | #ffffff | neutral | Nav background on scroll, download button fill, icon fills |
| Terminal Sage | #799c92 | accent | Gray outline accent for tags, dividers, and focused UI edges. |
...
| Matter | General Sans, Manrope, or DM Sans | 400, 600 | 12px, 14px, 16px, 18px, 20px, 24px, 32px, 40px, 48px, 56px, 64px | 0.90–1.56 (tight at display: 0.90–1.00; relaxed at body: 1.40–1.56) | The system's primary voice — all headings, body copy, buttons, and nav labels. Custom OpenType features give characters precision-cut angles not present in generic alternatives. Negative tracking scales from -0.04em at 64px down to -0.01em at 20px, tightening the display headline into a monolithic slab. Weight 400 handles everything from captions to large headlines — 600 is used sparingly for emphasis. |
| Inter | Inter (already a Google font) | 400, 500 | 14px, 16px | 1.00–1.38 | Secondary UI text — appears in body descriptions and headings within the product UI screenshot. Carries the same OpenType features as Matter to maintain visual harmony. Used when Matter is unavailable in an embedded context. |
| Geist Mono | JetBrains Mono, Fira Code | 400 | 16px | 1.00 | Terminal commands and code snippets — 'brew install --cask warp' displayed in the hero. Monospaced rendering reinforces the product's terminal identity. |
| Matter Mono Regular |  | 400 | 16px | 1.00 | Inline code and terminal output text within prose contexts — distinct from Geist Mono by its custom optical tuning matching the Matter family. |
| Matter Regular |  | 400, 600 | 12px, 14px, 16px, 18px, 20px, 24px, 32px, 40px, 48px, 56px, 64px | 0.9, 1, 1.1, 1.12, 1.15, 1.19, 1.2, 1.35, 1.38, 1.4, 1.5, 1.56 | Matter Regular — detected in extracted data but not described by AI |
| Matter Medium |  | 400, 500 | 16px, 20px, 22px | 1, 1.14, 1.2 | Matter Medium — detected in extracted data but not described by AI |
| DM Mono |  | 400 | 16px | 1.4 | DM Mono — detected in extracted data but not described by AI |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777500969700-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777500969700-thumb.jpg |
| preview video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/720c9806-2d70-4dd1-9a19-12efd71fc742-1777568128019-preview.mp4 |
| preview video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/720c9806-2d70-4dd1-9a19-12efd71fc742-1777568128019-preview-poster.jpg |
| detail video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/720c9806-2d70-4dd1-9a19-12efd71fc742-1777568128019-preview-detail.mp4 |
| detail video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/720c9806-2d70-4dd1-9a19-12efd71fc742-1777568128019-preview-detail-poster.jpg |
