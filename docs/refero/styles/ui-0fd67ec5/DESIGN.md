...
- Refero URL: https://styles.refero.design/style/0fd67ec5-7e9c-4ca9-b368-5d9c7388477a
- Site URL: https://ui.shadcn.com
- ID: 0fd67ec5-7e9c-4ca9-b368-5d9c7388477a
- Theme: light
- Industry: ai
- Created: 2026-04-16T19:16:42.818Z
- Ranks: newest: 905, popular: 64, trending: 35
...
| --- | --- | --- | --- | --- | --- |
| Geist | Inter | 400, 500, 600 | 12px, 13px, 14px, 16px, 18px, 48px | 1.00, 1.10, 1.20, 1.33, 1.38, 1.43, 1.50, 1.56, 1.63, 2.00 | Primary brand font for all UI text, headings, and body. Its varied weights and precise tracking create a modern, technical feel. |
| Geist Mono | IBM Plex Mono | 400 | 14px | 1.43 | Used for code snippets or specific input fields requiring monospaced characters. Reinforces a technical aesthetic. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1776366980055-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1776366980055-thumb.jpg |
