# Haley Park — Refero Style

- Refero URL: https://styles.refero.design/style/c47654a9-7d7a-4b2c-8e0a-cd9296719c69
- Site URL: https://haleys.design
- ID: c47654a9-7d7a-4b2c-8e0a-cd9296719c69
- Theme: dark
- Industry: design
- Created: 2026-04-30T03:24:46.720Z
- Ranks: newest: 162, popular: 426, trending: 283
...
| --- | --- | --- | --- | --- | --- |
| EditorialOld | Lora | 200 | 16px, 19px, 21px, 22px, 27px, 32px | 1.20, 1.30, 1.50 | Primary body text, links, list items, and smaller headings. Its classic serif forms contribute to the traditional, manuscript-like character. |
| Wispy | Recursive Sans | 100 | 96px | 1.00 | Display headlines – extremely light weight and tight tracking create an ethereal, elegant title that feels whispered rather than shouted. |
| Old Standard TT | Old Standard TT | 200 | 13px, 16px | 1.50 | Auxiliary body text, helper text, and secondary information presented in a highly readable, classic serif. |
| GTA | Playfair Display | 300 | 15px, 21px | 1.60 | Secondary textual content, possibly for smaller annotations or details where a slightly more contemporary serif is desired. |
| bodoni-classic-ornaments | Decorative Dingbats or Zapf Dingbats | 200, 300, 400 | 16px, 21px | 1.44, 1.50 | Decorative icons and ornamental text elements, evoking historical printing. |
| altesse-std-24pt | Perpetua Titling MT | 300 | 27px | 1.10 | A distinct heading font for specific sections, offering a unique, elegant serif character that complements the primary heading style. |
| ui-sans-serif |  | 100, 400 | 16px | 1.5 | ui-sans-serif — detected in extracted data but not described by AI |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777519465539-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777519465539-thumb.jpg |
