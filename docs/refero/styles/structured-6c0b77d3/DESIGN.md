# Structured — Refero Style

- Refero URL: https://styles.refero.design/style/6c0b77d3-71f9-469d-98aa-4ce1d6d76ac8
- Site URL: https://structured.money
- ID: 6c0b77d3-71f9-469d-98aa-4ce1d6d76ac8
- Theme: light
- Industry: fintech
- Created: 2026-04-30T00:18:18.109Z
- Ranks: newest: 841, popular: 226, trending: 156
...
| --- | --- | --- | --- | --- | --- |
| Davinci | Playfair Display or Lora (though Davinci's sharp serifs and specific tracking are key) | 400, 500 | 16px, 24px, 34px, 52px, 94px, 374px | 0.84, 1.00, 1.10, 1.33, 1.50 | Captivating serif headlines and titles. Its distinct character and spacing at large sizes provide a sense of established gravitas and artistic flair, contrasting with the utilitarian sans-serif for body copy. |
| Helvetica Now | Inter or Helvetica Neue | 400, 500 | 9px, 12px, 15px, 16px, 22px, 24px, 26px, 43px | 1.25, 1.50 | Compact and precise sans-serif for all body text, navigation, and functional UI elements. It provides readability and a modern counterpoint to the decorative serif, handling dense information efficiently. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777508276565-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777508276565-thumb.jpg |
