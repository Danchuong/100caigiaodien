# HashiCorp — Refero Style

- Refero URL: https://styles.refero.design/style/834ce97f-61f2-4b12-bf5c-e9fad2544456
- Site URL: https://hashicorp.com
- ID: 834ce97f-61f2-4b12-bf5c-e9fad2544456
- Theme: dark
- Industry: devtools
- Created: 2026-02-12T17:53:47.000Z
- Ranks: newest: 1195, popular: 419, trending: 914
...
| --- | --- | --- | --- | --- | --- |
| system-ui | Inter | 400, 500, 600 | 13px, 14px, 15px, 16px, 17px | 1.14, 1.20, 1.35, 1.38, 1.50, 1.60, 1.63, 1.69, 1.71 | Default UI text, small body copy, navigation links, button labels. Its neutrality underpins the content-focused approach. |
| Hashicorp Sans | Inter | 600, 700 | 13px, 17px, 19px, 26px, 34px, 42px, 52px, 82px | 1.17, 1.18, 1.19, 1.21, 1.35, 1.69 | Headlines and prominent marketing text. The tight letter spacing for larger sizes (-0.01em) provides a serious, professional edge, while looser spacing (0.10em) is used for specific uppercase treatments, creating a distinctive modern feel. |
| Arial | Helvetica Neue | 400 | 16px | 1.20 | Input field text and some button text. A utilitarian font choice ensuring clarity in interactive forms. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775923501573-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775923501573-thumb.jpg |
