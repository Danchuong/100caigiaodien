...
- Refero URL: https://styles.refero.design/style/edc0c03e-8c20-4e22-badd-2735fcb9f4a8
- Site URL: https://vol.co
- ID: edc0c03e-8c20-4e22-badd-2735fcb9f4a8
- Theme: light
- Industry: media
- Created: 2026-04-30T03:31:40.548Z
- Ranks: newest: 130, popular: 366, trending: 220
...
| --- | --- | --- | --- | --- | --- |
| Messina Sans | system-ui, sans-serif | 300, 350 | 14px, 18px, 20px, 32px, 50px, 80px | 1.00, 1.18, 1.40, 2.00 | The primary typeface for all text. Its lightness (300) for large headlines creates a refined, understated impact, while the moderate spacing (0.0700em) in smaller sizes ensures legibility and a classic, almost monospaced editorial feel. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777519877971-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777519877971-thumb.jpg |
