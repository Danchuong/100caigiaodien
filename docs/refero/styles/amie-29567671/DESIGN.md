...
- Refero URL: https://styles.refero.design/style/29567671-da1e-4f85-ae52-8b611fecc384
- Site URL: https://amie.so
- ID: 29567671-da1e-4f85-ae52-8b611fecc384
- Theme: light
- Industry: productivity
- Created: 2026-01-16T12:16:31.000Z
- Ranks: newest: 1310, popular: 365, trending: 408
...
| --- | --- | --- | --- | --- | --- |
| Inter | Inter (Google Fonts) | 400, 500, 550, 600, 700 | 12px, 13px, 14px, 16px, 20px, 40px, 56px | 1.00–1.75 (display: 1.00–1.14, body: 1.50–1.75) | Single typeface for all contexts — headlines to captions. Weight 700 at 56px for hero display, 600 at 40px for section headings, 400–500 for body and UI. The -0.025em tracking at large sizes (≈-1.4px at 56px, ≈-0.48px at 40px) compresses headlines into tight confident blocks. No decorative or serif counterpart — mono-typographic system. |
| Inter var |  | 400 | 16px | 1.75 | Inter var — detected in extracted data but not described by AI |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777496407562-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777496407562-thumb.jpg |
