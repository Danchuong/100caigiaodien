# Yinka Ilori Studio — Refero Style

- Refero URL: https://styles.refero.design/style/deccaba1-8d53-4a82-b4c7-e2b99a3dc326
- Site URL: https://yinkailori.com
- ID: deccaba1-8d53-4a82-b4c7-e2b99a3dc326
- Theme: light
- Industry: design
- Created: 2026-04-30T03:37:32.390Z
- Ranks: newest: 108, popular: 751, trending: 585
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Ink | #000000 | neutral | Primary text, navigation links, borders, icon fills. Provides high contrast against vibrant and light backgrounds |
| Canvas Blush | #f5e5e5 | neutral | Primary page background, card surfaces, footer background. A soft, light canvas for high-chroma elements |
| Passion Pink | #d9698c | brand | Main accent color for graphic elements, dynamic backgrounds, and thematic blocks. Creates high-energy contrast |
| Zesty Orange | #ee6d22 | accent | Secondary accent color for graphic elements and background patterns. Often paired with Passion Pink for dynamic visual interplay |
| Lush Green | #1f8029 | accent | Supporting palette color for small decorative accents when the core palette needs contrast. Do not promote it to the primary CTA color |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Yinka Sans Ultra | Bebas Neue | 400, 500 | 120px | 1.10 | Primary display typeface for large, impactful headlines. Its bold, geometric character defines the brand's expressive visual voice. |
| Haas Grotesk Display R Web | Public Sans | 400, 500 | 14px, 20px, 120px | 1.00, 1.05, 1.30, 1.50 | General text, navigation, and smaller headings. Provides clarity and legibility, contrasting with the more stylized display font. Its use at 120px for some headings suggests versatility in its application. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777520232930-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777520232930-thumb.jpg |
