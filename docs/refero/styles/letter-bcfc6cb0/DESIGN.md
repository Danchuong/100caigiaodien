...
- Refero URL: https://styles.refero.design/style/bcfc6cb0-1b39-4f3f-a95e-bd7b563b0efc
- Site URL: https://letter.co
- ID: bcfc6cb0-1b39-4f3f-a95e-bd7b563b0efc
- Theme: light
- Industry: fintech
- Created: 2026-04-30T03:00:57.609Z
- Ranks: newest: 250, popular: 855, trending: 787
...
| --- | --- | --- | --- | --- | --- |
| Albra Sans | Playfair Display | 600 | 22px, 46px, 80px | 1.10, 1.20 | Display and large headings — evokes a sense of established authority and refined impact through its robust weight and subtle tracking. |
| Neufile Grotesk Extended | Inter | 400, 500 | 13px, 16px, 28px | 1.00, 1.30, 1.40, 2.00 | Body copy, navigation, buttons, and subheadings — a compact, strong sans-serif that provides modern legibility without sacrificing character. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777518029337-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777518029337-thumb.jpg |
