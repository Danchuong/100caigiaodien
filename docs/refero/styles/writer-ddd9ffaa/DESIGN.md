...
- Refero URL: https://styles.refero.design/style/ddd9ffaa-d831-4cb4-a5bf-a1efce421dca
- Site URL: https://writer.com
- ID: ddd9ffaa-d831-4cb4-a5bf-a1efce421dca
- Theme: light
- Industry: ai
- Created: 2026-02-13T15:49:55.000Z
- Ranks: newest: 1190, popular: 320, trending: 379
...
| --- | --- | --- | --- | --- | --- |
| Poppins | system-ui, sans-serif | 400, 500, 600, 700 | 11px, 12px, 13px, 14px, 16px, 18px, 20px, 25px, 40px, 44px, 64px | 1.00, 1.15, 1.20, 1.25, 1.40, 1.50, 1.55, 1.60, 1.66, 1.67, 1.75 | Primary text font, used for both headings and body copy. Its extensive weights and precise letter-spacing control allow for distinct hierarchical expression, from prominent display text to fine print. The default 'clig' and 'liga' features suggest precise character spacing. |
| CanelaDeck | serif | 400 | 16px | 1.20 | Used sparingly for decorative elements or specific brand moments. Its unique serif character provides a touch of classic sophistication amidst the modern sans-serif dominance, adding a subtle luxurious feel. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775923786277-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775923786277-thumb.jpg |
