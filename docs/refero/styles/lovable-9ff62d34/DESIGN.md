# Lovable — Refero Style

- Refero URL: https://styles.refero.design/style/9ff62d34-e48d-4fcb-9fd9-c018e2747542
- Site URL: https://lovable.dev
- ID: 9ff62d34-e48d-4fcb-9fd9-c018e2747542
- Theme: light
- Industry: ai
- Created: 2026-04-30T00:44:25.243Z
- Ranks: newest: 713, popular: 628, trending: 461
...
| --- | --- | --- | --- | --- | --- |
| Camera Plain Variable | Inter, Arial, sans-serif | 400, 480, 600 | 12px, 14px, 15px, 16px, 18px, 20px, 36px, 48px, 60px | 1.00, 1.10, 1.25, 1.38, 1.50, 1.60 | The primary typeface for all text content. Its variable nature allows for precise weight control, delivering compact, high-density information without feeling cluttered. The slight negative letter-spacing (-0.0250em) throughout reinforces this compact aesthetic. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777594681909-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777594681909-thumb.jpg |
| icon | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777594681909-icon.png |
