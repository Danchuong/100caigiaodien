...
- Refero URL: https://styles.refero.design/style/6eb5fc89-d0db-4293-8bff-13c5aa530a28
- Site URL: https://wearemotto.com
- ID: 6eb5fc89-d0db-4293-8bff-13c5aa530a28
- Theme: light
- Industry: agency
- Created: 2026-02-12T20:51:19.000Z
- Ranks: newest: 1194, popular: 334, trending: 325
...
| --- | --- | --- | --- | --- | --- |
| sans | Inter, Arial, Helvetica, sans-serif | 500 | 14px, 15px, 17px, 18px, 20px, 25px, 34px, 48px | 1.14, 1.26, 1.30, 1.38, 1.40, 1.60 | UI elements, body text, subheadings, and captions. The consistent medium weight (500) across various sizes provides a clean, readable, and authoritative voice for all functional text. |
| disp | Oswald, Impact, sans-serif | 500 | 61px, 99px, 138px, 139px, 154px | 1.00, 1.10 | Headlines and display text. Its large scale and medium weight dictate a commanding visual presence, allowing key messages to dominate without being overtly aggressive. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775925232923-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775925232923-thumb.jpg |
