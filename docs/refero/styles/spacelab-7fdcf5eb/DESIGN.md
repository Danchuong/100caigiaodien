# Spacelab — Refero Style

- Refero URL: https://styles.refero.design/style/7fdcf5eb-4d65-49a2-b887-60119bca4edc
- Site URL: https://spacelab.co.uk
- ID: 7fdcf5eb-4d65-49a2-b887-60119bca4edc
- Theme: light
- Industry: design
- Created: 2026-04-30T02:07:58.777Z
- Ranks: newest: 437, popular: 889, trending: 706
...
| Graphite | #2c2222 | neutral | Body text, secondary text, subtle card borders, default icon fill |
| Stone Gray | #b2b4b1 | neutral | Muted secondary text, inactive link states, hairline borders |
| Deep Violet | #495472 | brand | Primary brand accent, button backgrounds, active card states. This muted, deep tone provides authority without aggression |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Helvetica Neue | Arial | 400 | 15px, 17px, 19px, 21px, 30px, 62px | 1.00, 1.07, 1.10, 1.15, 1.20 | The primary typeface for all content. Its crisp, neutral form supports the system's objective clarity. The wide range of sizes with consistent letter-spacing across all weights maintains a precise, consistent visual texture. |
| HelveticaNeue-Light |  | 400 | 17px | 1.2 | HelveticaNeue-Light — detected in extracted data but not described by AI |
...
| --- | --- | --- | --- |
| caption | 15 | 1 | 0.011 |
| body-sm | 17 | 1.2 | 0.011 |
| body | 19 | 1.1 | 0.011 |
| subheading | 21 | 1.15 | 0.011 |
| heading | 30 | 1.2 | 0.011 |
| display | 62 | 1.07 | 0.011 |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777514854361-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777514854361-thumb.jpg |
