# Exo Ape — Refero Style

- Refero URL: https://styles.refero.design/style/18e84ffd-4a5d-453d-aeff-dae2847aa3c9
- Site URL: https://www.exoape.com
- ID: 18e84ffd-4a5d-453d-aeff-dae2847aa3c9
- Theme: light
- Industry: agency
- Created: 2026-04-30T01:52:07.151Z
- Ranks: newest: 502, popular: 873, trending: 789
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Carbon | #0d0e13 | neutral | Primary text, dark backgrounds for contrast, borders, subtle icons |
| Paper White | #ffffff | neutral | Page backgrounds, navigational elements, reversed text in dark sections, borders |
| Plaster | #e4e0db | neutral | Subtle background surfaces, subdued text, borders for architectural elements |
| Sandstone | #e0ccbb | neutral | Decorative borders, accents in footers and lists, subtle background fills |
| Parchment | #e6d7ca | neutral | Text for body content and links, outlines for interactive elements |
| Ink Black | #070707 | neutral | Footer background |
| Slate | #6e6e71 | neutral | Muted body text, borders |
| Stone Gray | #9e9fa1 | neutral | Subtle background fills for secondary elements |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Lausanne-400 |  | 400 | 14px | 2.64 | Lausanne-400 — detected in extracted data but not described by AI |
| Lausanne | Inter, Montserrat | 400 | 14px, 16px, 24px, 144px, 250px | 0.73, 0.76, 0.90, 1.00, 1.33, 1.50, 1.88 | Dominant branding and large display headlines use Lausanne-400 at massive sizes, characterized by tight negative letter-spacing for impact and a contemporary feel. |
| Times | serif system font | 400 | 16px | 1.20, 2.00 | Used sparingly for traditional elements and general body text, providing a classic counterpoint to the modern display font. Often found in detailed content sections and navigation. |
...
| body | 14 | 1.88 | 0.084 |
| body-lg | 16 | 1.5 | -0.56 |
| subheading | 24 | 1.33 | -0.84 |
| display-lg | 144 | 0.9 | -6.624 |
| display | 250 | 0.73 | -11.5 |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777513890739-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777513890739-thumb.jpg |
