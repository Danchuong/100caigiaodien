# Paragraph — Refero Style

- Refero URL: https://styles.refero.design/style/37dd9612-4df0-4cdd-b942-bd97dd0efbd2
- Site URL: https://mirror.xyz
- ID: 37dd9612-4df0-4cdd-b942-bd97dd0efbd2
- Theme: light
- Industry: media
- Created: 2026-04-30T02:14:58.812Z
- Ranks: newest: 408, popular: 1164, trending: 1154
...
| --- | --- | --- | --- | --- | --- |
| Google Sans Flex | system-ui | 400, 500, 600 | 14px, 16px, 18px | 1.25, 1.43, 1.50, 1.56, 1.63 | Primary sans-serif for body text, buttons, navigation, and interface elements. Its multiple weights support a clear information hierarchy without needing extra fonts. |
| IvyOra | serif | 400 | 18px, 24px, 64px | 1.00, 1.33, 1.56 | Headline font, providing a classic, editorial feel with distinct tracking for different sizes. Its generous kerning at large sizes creates an opulent feel. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777515275444-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777515275444-thumb.jpg |
