...
- Refero URL: https://styles.refero.design/style/917048a3-53b3-44e6-ab33-faefc4dcc9df
- Site URL: https://kippo.com
- ID: 917048a3-53b3-44e6-ab33-faefc4dcc9df
- Theme: dark
- Industry: other
- Created: 2026-04-30T01:40:54.453Z
- Ranks: newest: 547, popular: 1240, trending: 1234
...
| --- | --- | --- | --- | --- | --- |
| Source Code Pro | monospace | 400, 600, 700 | 10px, 12px, 16px, 42px | 1.19, 1.67, 1.88, 2.00 | Body text, captions, and secondary information, maintaining a legible, compact density. |
| Source Code Pro | monospace | 400, 600, 700 | 10px, 12px, 16px, 42px | 1.19, 1.67, 1.88, 2.00 | Subheadings and emphasized text, providing a slightly bolder voice while retaining the monospace aesthetic. |
| Source Code Pro | monospace | 400, 600, 700 | 10px, 12px, 16px, 42px | 1.19, 1.67, 1.88, 2.00 | Primary headlines and impactful statements, using increased weight and generous letter spacing to command attention within the dark theme. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777513222160-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777513222160-thumb.jpg |
