# 12th Berlin Biennale for Contemporary Art — Refero Style

- Refero URL: https://styles.refero.design/style/1c2d4a33-7ee4-4b61-a77e-dab91631d19b
- Site URL: https://12.berlinbiennale.de
- ID: 1c2d4a33-7ee4-4b61-a77e-dab91631d19b
- Theme: light
- Industry: design
- Created: 2026-04-30T02:40:05.176Z
- Ranks: newest: 324, popular: 1192, trending: 1204
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Midnight | #000000 | neutral | Primary text, surface backgrounds, borders, navigation elements. Creates dominant dark areas and strong contrast |
| Canvas | #ffffff | neutral | Page backgrounds, card surfaces, interactive accent text. Provides a clean, bright backdrop |
| Fog | #f2f2f2 | neutral | Subtle background for interactive list items and secondary buttons. Creates a gentle visual separation without stark contrast |
| Ash | #e7e7e7 | neutral | Background for navigation items. A slightly darker variant of fog for subtle layering |
| Vivid Violet | #7373ff | brand | Primary interactive element borders (links, buttons, cards), secondary text, and accents. This color is the main chromatic identifier and action indicator |
| Muted Violet | #23234d | brand | Decorative fills and icon accents. A deeper, less saturated brand hue for subtle graphic elements |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| ABCMonumentGroteskWeb | Arial, Helvetica, sans-serif | 400, 700 | 12px, 14px, 16px, 17px, 19px, 20px, 22px, 25px, 29px, 32px | 1.02, 1.03, 1.15, 1.20, 2.00, 2.40 | Primary typeface for all UI elements, body text, and most headings. Its precise, contemporary feel supports the minimal aesthetic with tight tracking for a dense, architectural look. |
| BradfordLLSub | Georgia, serif | 400 | 20px, 23px, 30px | 1.03, 1.15 | Used sparingly for stylistic accents in headings and input fields. Its subtly tracked, serif quality provides a refined contrast to the primary sans-serif. |
...
| caption | 12 | 2.4 | 0.01 |
| body-sm | 14 | 2 | -0.004 |
| heading-sm | 19 | 1.15 | -0.004 |
| heading-lg | 22 | 1.03 | -0.004 |
| display | 32 | 1.02 | -0.01 |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777516784417-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777516784417-thumb.jpg |
