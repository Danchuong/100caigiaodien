...
- Refero URL: https://styles.refero.design/style/c81d2be0-05b7-4755-8046-f2d19fbc448c
- Site URL: https://wonder.design
- ID: c81d2be0-05b7-4755-8046-f2d19fbc448c
- Theme: dark
- Industry: devtools
- Created: 2026-04-16T17:21:12.629Z
- Ranks: newest: 906, popular: 254, trending: 197
...
| --- | --- | --- | --- | --- | --- |
| Uncut Sans Variable | system-ui, sans-serif | 400, 500, 600 | 14px, 15px, 16px, 18px, 24px, 38px, 50px | 1.10, 1.12, 1.33, 1.43, 1.45, 1.50, 1.56 | Headings and prominent display text. The variable font offers nuanced expressiveness, with tighter tracking for larger sizes to maintain visual density. |
| Inter | Inter, sans-serif | 400, 500, 600, 700 | 8px, 10px, 11px, 12px, 14px, 15px, 16px, 24px, 28px | 1.20, 1.25, 1.33, 1.43, 1.50, 1.60, 1.63 | Body copy, navigation, and general UI text. It provides clarity and a modern feel, with subtle adjustments in letter-spacing across sizes to optimize readability. |
| Martian Mono | monospace | 400 | 10px, 11px, 12px | 1.50, 1.63 | Specialized for code blocks, badges, and areas requiring a fixed-width, technical aesthetic. Its mono-spaced nature reinforces the code-centric aspects of the product. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777595159441-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777595159441-thumb.jpg |
| icon | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777595159441-icon.png |
| preview video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/c81d2be0-05b7-4755-8046-f2d19fbc448c-1777581481411-preview.mp4 |
| preview video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/c81d2be0-05b7-4755-8046-f2d19fbc448c-1777581481411-preview-poster.jpg |
| detail video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/c81d2be0-05b7-4755-8046-f2d19fbc448c-1777581481411-preview-detail.mp4 |
| detail video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/c81d2be0-05b7-4755-8046-f2d19fbc448c-1777581481411-preview-detail-poster.jpg |
