# Branding — Refero Style

- Refero URL: https://styles.refero.design/style/4d4772a3-e1da-415f-a6d7-658dcefdcecd
- Site URL: https://www.svz.io
- ID: 4d4772a3-e1da-415f-a6d7-658dcefdcecd
- Theme: dark
- Industry: agency
- Created: 2026-04-30T03:07:48.002Z
- Ranks: newest: 224, popular: 274, trending: 169
...
| --- | --- | --- | --- | --- | --- |
| Kmr Waldenburg | Montserrat | 300, 400, 700 | 10px, 12px, 14px, 24px, 32px, 42px, 64px, 80px, 160px | 0.90, 1.00, 1.05, 1.10, 1.20, 1.50 | Primary typeface for headings, navigation, and key textual elements. Its variable weights and tight letter-spacing contribute to a deliberate, crafted feel, demanding attention without screaming. |
| system-ui | Inter | 300, 400 | 12px, 14px | 1.20, 1.50 | System font used for utilitarian body text, icons, and supporting information, providing clarity and legibility without competing with the custom display fonts. |
| Editorialnew | Playfair Display | 300 | 14px, 20px, 32px | 1.00, 1.10, 1.50 | Supplementary display font for select body text and headings, offering a refined, slightly more traditional counterpoint, often with negative tracking to maintain a sleek density. |
| Dirtyline 36 Daysoftype 2022 | Oswald | 400 | 24px, 64px, 80px | 0.90, 1.05, 1.10 | Distinctive display font reserved for hero headlines and impactful, artistic typography, characterized by extremely tight tracking and condensed forms for a bold, almost sculptural presence. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777518442538-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777518442538-thumb.jpg |
