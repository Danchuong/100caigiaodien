...
- Refero URL: https://styles.refero.design/style/3da7b444-ded8-406b-90b7-96851604b92b
- Site URL: https://luffu.com
- ID: 3da7b444-ded8-406b-90b7-96851604b92b
- Theme: light
- Industry: ai
- Created: 2026-03-23T12:41:22.000Z
- Ranks: newest: 1008, popular: 142, trending: 306
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Deep Ink | #192830 | brand | Primary CTA button fill, nav border, interactive controls — this single dark-teal anchor is the only departure from the black/cream palette, creating a subtle aquatic undertone that reads health-adjacent without being clinical |
| Parchment | #f5f5ee | neutral | Page background, section fills — the slight warm-green cast separates this from pure white and prevents sterility |
| Linen | #e4e7da | neutral | Subtle section dividers, secondary surface tinting |
| Pressed Cotton | #d7d7cb | neutral | Tertiary surface, card backgrounds in feature sections |
| Graphite | #2f3136 | neutral | Body text, headings, primary readable content |
| Slate | #535557 | neutral | Secondary body text, captions, supporting copy |
| Dusk | #424e52 | neutral | Tertiary text, footer links, subdued labels |
| White | #ffffff | neutral | Button text on dark fills, icon fills, overlay text on photography |
| Ink | #000000 | neutral | Maximum contrast text, SVG fills |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| ABC Arizona Sans | Freight Sans Pro or Cormorant SC | 400 | 14px, 16px, 20px | 1.0–1.2 | Navigation links, body copy, buttons, captions, footer text. Single weight used across all UI text — no bold weight anywhere forces hierarchy through size alone. The tight letter-spacing (-0.016em at 20px, -0.020em at 16px, -0.025em at 14px) gives a condensed editorial feel at every size. |
| ABC Arizona Flare | Playfair Display or Cormorant Garamond | 400 | 40px, 48px, 64px | 1.0 | Display headings and the oversized brand wordmark. The flare-serif construction (hairline terminal spurs) at very tight -0.05em spacing at 64px collapses letterforms together like editorial magazine typography — the 'Luffu' logotype treatment at display scale is the signature visual moment of this system. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775990540363-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775990540363-thumb.jpg |
| preview video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/3da7b444-ded8-406b-90b7-96851604b92b-1777556483770-preview.mp4 |
| preview video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/3da7b444-ded8-406b-90b7-96851604b92b-1777556483770-preview-poster.jpg |
| detail video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/3da7b444-ded8-406b-90b7-96851604b92b-1777556483770-preview-detail.mp4 |
| detail video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/3da7b444-ded8-406b-90b7-96851604b92b-1777556483770-preview-detail-poster.jpg |
