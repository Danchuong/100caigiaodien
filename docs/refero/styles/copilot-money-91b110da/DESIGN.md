# Copilot Money — Refero Style

- Refero URL: https://styles.refero.design/style/91b110da-902b-4d09-8bf0-26bd1f25f8b2
- Site URL: https://copilot.money
- ID: 91b110da-902b-4d09-8bf0-26bd1f25f8b2
- Theme: dark
- Industry: fintech
- Created: 2026-04-30T03:05:31.221Z
- Ranks: newest: 234, popular: 623, trending: 468
...
| --- | --- | --- | --- | --- | --- |
| Matter Variable Thin |  | 100 | 11px, 12px, 13px, 14px, 15px, 16px, 18px, 22px, 38px, 56px | 1.20, 1.30, 1.40, 1.60 | Primary body and sub-heading text, creating a light, modern feel with its variable weight and precise tracking. Its thinness makes larger headlines feel restrained. |
| Jokker Medium |  | 500 | 12px, 14px, 16px, 18px, 22px, 24px, 32px, 64px | 1.00, 1.09, 1.10, 1.20, 1.40, 1.60 | Accent headings and prominent body text; its medium weight provides structure and readability for key information. |
| Matter-TRIAL SemiBold |  | 670 | 28px | 1.00 | Feature headings and callouts, designed for impact and distinctiveness with its tighter tracking. |
| Jokker Semibold |  | 600 | 24px, 64px, 148px | 0.90, 1.10, 1.20 | Large display headings and section titles, commanding attention with its semi-bold weight and generous scale. |
| Jokker Regular |  | 400 | 13px, 24px | 1.40 | Standard body text, providing clarity and readability at smaller sizes for detailed information blocks. |
| sans-serif |  | 400 | 12px | 1.20 | Fallback for system text, ensuring basic readability where custom fonts might not load. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777518297346-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777518297346-thumb.jpg |
