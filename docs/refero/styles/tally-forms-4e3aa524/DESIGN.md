# Tally Forms — Refero Style

- Refero URL: https://styles.refero.design/style/4e3aa524-b146-416c-907f-382c079ea80c
- Site URL: https://tally.so
- ID: 4e3aa524-b146-416c-907f-382c079ea80c
- Theme: light
- Industry: productivity
- Created: 2026-04-30T00:48:38.677Z
- Ranks: newest: 693, popular: 663, trending: 474
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Midnight Charcoal | #37352f | neutral | Primary text, prominent borders, strong icons |
...
| Soft Mist | #e0e0df | neutral | Subtle background washes, light card shadows |
| Ash Gray | #898884 | neutral | Muted text, secondary borders, helper text |
| Steel Gray | #777672 | neutral | Link text, medium contrast text, less prominent borders |
| Jet Black | #000000 | neutral | Heading text, button text on light backgrounds, strong borders |
| Faded Ink | #45433e | neutral | Secondary link text, subtle icon fills, footer text |
| Tally Blue | #0070d7 | brand | Primary action button backgrounds, active states, key interactive indicators — a beacon of interaction in an otherwise monochrome UI |
| Sketch Pink | #f81ce5 | accent | Accent for hand-drawn annotations, decorative icons, highlighted card borders — adds a flash of playful energy |
| Soft Sketch Pink | #fcadf6 | accent | Subtle glow for card shadows, accent for background illustration details |
| Gradient Aura | #8a46ff | accent | Decorative background accents, occasional illustrative elements — a vibrant, shifting focal point |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Inter | system-ui, sans-serif | 400, 500, 600, 700, 800 | 13px, 14px, 15px, 16px, 18px, 22px, 26px, 30px, 36px, 64px | 1.00, 1.15, 1.25, 1.50, 1.80 | The primary typeface for all text content, from headings to body, links and buttons. Its clean, modern character supports both clarity and approachability across the product. |

## Type Scale

| Role | Size | Line Height | Letter Spacing |
| --- | --- | --- | --- |
| caption | 13 | 1.5 | -0.403 |
| body | 15 | 1.5 | -0.465 |
| subheading | 18 | 1.25 | -0.558 |
| heading-sm | 22 | 1.25 | -0.682 |
| heading | 26 | 1.25 | -0.806 |
| heading-lg | 36 | 1.15 | -1.116 |
| display | 64 | 1 | -1.984 |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777510088018-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777510088018-thumb.jpg |
