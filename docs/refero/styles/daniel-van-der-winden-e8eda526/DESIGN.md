# Daniël van der Winden — Refero Style

- Refero URL: https://styles.refero.design/style/e8eda526-d686-4e45-a60d-61b6503a8eda
- Site URL: https://www.daniel.pizza
- ID: e8eda526-d686-4e45-a60d-61b6503a8eda
- Theme: light
- Industry: design
- Created: 2026-04-30T02:05:33.966Z
- Ranks: newest: 446, popular: 977, trending: 926
...
| --- | --- | --- | --- | --- | --- |
| Degular | Inter | 400, 500, 600, 700 | 14px, 16px, 18px, 22px, 24px, 28px, 32px, 40px | 1.25, 1.50 | Primary grotesque sans-serif for headings, body text, and interactive elements. Its neutral yet confident presence provides the main voice of the content, with moderate tracking at larger sizes to maintain clarity. |
| Blanco | Lora | 400 | 14px, 20px, 22px, 28px | 1.40, 1.50 | A serif font used for select headings, links, and specific long-form content. Its classic proportions provide an intellectual counterpoint to the sans-serif, signaling depth and traditional editorial quality. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777514710269-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777514710269-thumb.jpg |
