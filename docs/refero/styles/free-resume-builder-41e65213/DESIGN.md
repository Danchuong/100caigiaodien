# Free Resume Builder — Refero Style

- Refero URL: https://styles.refero.design/style/41e65213-1c4a-41c4-b715-50427fa8926e
- Site URL: https://resume.io
- ID: 41e65213-1c4a-41c4-b715-50427fa8926e
- Theme: light
- Industry: productivity
- Created: 2026-03-10T14:21:49.000Z
- Ranks: newest: 1063, popular: 476, trending: 562
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Page Graphite | #0f141 | neutral | Deepest primary text, page headers and footers — provides strong contrast to the light background. |
| Slate Text | #1e2532 | neutral | Standard body text, headings, and icon fills, establishing a consistent dark-on-light readability. |
| Midtone Gray | #656e83 | neutral | Secondary text and subtle details, offering visual hierarchy without harsh contrast. |
| Soft Gray | #828ba2 | neutral | Muted text, placeholder text, and subtle borders, ideal for less prominent information. |
| Hover Gray | #9fa6bb | neutral | List item hover states, adding a soft visual feedback. |
| Light Steel | #d9deeb | neutral | Subtle borders and dividers, providing structure without visual weight. |
| Faded Blueprint | #f1f2ff | neutral | Background for certain interactive areas or subtle distinction, like a muted blueprint showing the foundation. |
| Whisper White | #f7f9fc | neutral | Card backgrounds and lighter section fills, creating a sense of cleanliness and space. |
| Pure White | #ffffff | neutral | Dominant page background, essential for the overall light theme and high contrast. |
| Action Blue | #1a91f0 | brand | Primary calls to action, interactive elements, and key visual accents — this vibrant blue guides user interaction. |
| Recruiter Blue | #1a1c6a | brand | Background for certain button variants, offering a darker, more authoritative blue contrasting the main action blue. |
| Trustpilot Green | #00b67a | semantic | Trust indicators and success states, a clear and recognizable signifier. |
| Error Red | #fb4458 | semantic | Error messages and negative feedback. |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| TT Commons | Inter | 400, 500, 600 | 14px, 15px, 16px, 18px, 19px, 22px, 24px, 28px, 31px, 40px, 52px, 67px | 0.96, 1.00, 1.07, 1.14, 1.16, 1.17, 1.20, 1.22, 1.25, 1.26, 1.27, 1.43 | Primary typeface for all UI elements, headings, body text. Its clean, geometric form supports readability across all sizes, suitable for the professional context of resume building. |

## Type Scale

| Role | Size | Line Height | Letter Spacing |
| --- | --- | --- | --- |
| caption | 14 | 1.43 | 0.29 |
| body | 16 | 1.26 |  |
| subheading | 18 | 1.22 |  |
| heading | 22 | 1.14 |  |
| heading-lg | 28 | 1.16 |  |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775933552888-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775933552888-thumb.jpg |
