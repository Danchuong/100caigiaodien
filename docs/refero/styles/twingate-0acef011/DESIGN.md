# Twingate — Refero Style

- Refero URL: https://styles.refero.design/style/0acef011-07da-4416-b874-ccdd675140f6
- Site URL: https://twingate.com
- ID: 0acef011-07da-4416-b874-ccdd675140f6
- Theme: dark
- Industry: saas
- Created: 2026-03-02T14:05:05.000Z
- Ranks: newest: 1107, popular: 263, trending: 428
...
| --- | --- | --- | --- | --- | --- |
| TT Hoves Light | Open Sans Light | 300, 400 | 22px, 24px, 48px, 54px, 55px, 62px, 68px | 1.10, 1.20, 1.30, 1.50 | Headlines and display text. The distinctive light weights at large sizes create an impression of quiet authority and modern elegance, contrasting with the often bolder choices of competitors. This 'whisper, don't shout' approach is a core brand identifier. |
| TT Hoves Medium | Open Sans Medium | 400, 500 | 11px, 12px, 13px, 14px, 15px, 16px, 17px, 20px, 32px | 1.04, 1.12, 1.13, 1.14, 1.20, 1.27, 1.29, 1.50 | Sub-headings, prominent body text, and key UI labels. Provides legibility and clear hierarchy due to its moderate weight, supporting the whisper-weight headlines without competing with them. |
| TT Hoves Regular | Open Sans Regular | 400 | 11px, 12px, 14px, 15px, 16px, 17px | 1.14, 1.20, 1.31, 1.50, 1.70 | Standard body text, descriptive copy, and general UI elements. Its neutrality ensures readability for extended passages. |
| Basis Grotesque Mono Pro Medium | IBM Plex Mono Medium | 400 | 13px | 1.50 | Used for code snippets, technical details, or unique data representations, leveraging a mono typeface for clarity and distinction. |
| Basis Grotesque Mono Pro Regular | IBM Plex Mono Regular | 400 | 13px, 21px | 1.20, 1.60 | Complementary to the Medium weight mono font, used for inline code or smaller technical annotations. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775925893964-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775925893964-thumb.jpg |
| preview video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/0acef011-07da-4416-b874-ccdd675140f6-1777560744773-preview.mp4 |
| preview video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/0acef011-07da-4416-b874-ccdd675140f6-1777560744773-preview-poster.jpg |
| detail video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/0acef011-07da-4416-b874-ccdd675140f6-1777560744773-preview-detail.mp4 |
| detail video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/0acef011-07da-4416-b874-ccdd675140f6-1777560744773-preview-detail-poster.jpg |
