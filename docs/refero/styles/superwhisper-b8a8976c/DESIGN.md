# Superwhisper — Refero Style

- Refero URL: https://styles.refero.design/style/b8a8976c-52d9-4ebb-95ea-4c40f4a9acab
- Site URL: https://superwhisper.com
- ID: b8a8976c-52d9-4ebb-95ea-4c40f4a9acab
- Theme: dark
- Industry: ai
- Created: 2026-04-05T11:44:17.000Z
- Ranks: newest: 955, popular: 127, trending: 129
...
| --- | --- | --- | --- | --- | --- |
| Inter | system-ui | 300, 400, 500, 600, 700 | 8px, 9px, 10px, 11px, 12px, 13px, 14px, 15px, 16px, 18px, 20px, 24px, 30px, 31px, 48px, 60px | 1.00, 1.06, 1.07, 1.20, 1.25, 1.33, 1.40, 1.43, 1.45, 1.50, 1.56, 1.60, 1.63, 1.71 | Primary typeface for all UI elements, headings, and body text. Its clean, geometric forms maintain readability across sizes and weights, providing a digital-native but approachable feel. The precise letter-spacing at larger sizes contributes to the sharp, modern aesthetic. |
| ui-monospace | monospace | 300, 400 | 11px | 1.00, 1.30, 1.50 | Used sparingly for technical details, code snippets, or monospace display, offering a precise, fixed-width contrast to Inter. |
| -apple-system | system-ui | 500 | 9px, 10px | 1.60, 1.78 | System fallback, or for specific native OS-like UI elements, ensuring consistent rendering on Apple devices. |
| Flow Circular | system-ui | 400 | 14px, 16px | 1.43, 1.50 | A decorative, custom typeface used for unique design accents, probably within illustrations or specific brand callouts. Its circular nature adds a playful, organic touch contrasting the overall sharp UI. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1776122642610-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1776122642610-thumb.jpg |
| preview video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/b8a8976c-52d9-4ebb-95ea-4c40f4a9acab-1777560919300-preview.mp4 |
| preview video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/b8a8976c-52d9-4ebb-95ea-4c40f4a9acab-1777560919300-preview-poster.jpg |
| detail video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/b8a8976c-52d9-4ebb-95ea-4c40f4a9acab-1777560919300-preview-detail.mp4 |
| detail video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/b8a8976c-52d9-4ebb-95ea-4c40f4a9acab-1777560919300-preview-detail-poster.jpg |
