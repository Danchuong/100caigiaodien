# Promova — Refero Style

- Refero URL: https://styles.refero.design/style/dae5e893-ca18-44c3-8f83-358cb52af237
- Site URL: https://promova.com
- ID: dae5e893-ca18-44c3-8f83-358cb52af237
- Theme: dark
- Industry: other
- Created: 2026-03-01T14:42:31.000Z
- Ranks: newest: 1108, popular: 478, trending: 727
...
| --- | --- | --- | --- | --- | --- |
| Manrope | system-ui | 200, 400, 500, 700 | 10px, 14px, 15px, 16px, 18px, 20px, 24px, 25px, 140px | 1.00, 1.20, 1.40, 1.42, 1.44, 1.50, 1.67 | Primary text font, used widely for body copy, navigation, buttons, and detailed information. Its geometric clarity ensures readability across all weights and sizes. |
| Nekst |  | 400 | 14px, 15px, 16px, 18px, 19px, 24px, 40px, 50px, 60px, 70px, 100px, 120px | 1.00, 1.20, 1.67 | Display font used primarily for prominent headings and titles. Its distinct character provides a strong brand voice and visual differentiation, especially at larger sizes where it demands attention. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775933101837-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775933101837-thumb.jpg |
