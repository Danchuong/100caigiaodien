# Endel Manifesto — Refero Style

- Refero URL: https://styles.refero.design/style/9949add1-e0f0-4093-8002-db1f3a7390b7
- Site URL: https://manifesto.endel.io
- ID: 9949add1-e0f0-4093-8002-db1f3a7390b7
- Theme: dark
- Industry: other
- Created: 2026-04-30T01:44:46.861Z
- Ranks: newest: 528, popular: 1064, trending: 969
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Midnight Void | #000000 | neutral | Page backgrounds, large decorative fills |
...
| Steel Gray | #636363 | neutral | Decorative strokes, secondary graphic elements |
| Muted Ash | #4d4d4d | neutral | Button background for primary actions, subtle elevation surface |
| Soft Fog | #6f6f6f | neutral | Muted link text color, secondary borders |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Roboto | system-ui, sans-serif | 400 | 16px, 20px, 24px, 40px | 1.13, 1.15, 1.25, 1.30, 1.33 | All textual content, from body text to prominent headlines, using varying sizes to establish hierarchy without additional typefaces or weights. All letterspacing is normal, supporting legibility in a content-focused display. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777513471008-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777513471008-thumb.jpg |
