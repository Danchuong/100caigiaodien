# Glideapps — Refero Style

- Refero URL: https://styles.refero.design/style/a80cb179-2d90-4896-b52d-4e674b421498
- Site URL: https://www.glideapps.com
- ID: a80cb179-2d90-4896-b52d-4e674b421498
- Theme: light
- Industry: saas
- Created: 2026-04-30T00:58:12.877Z
- Ranks: newest: 652, popular: 156, trending: 97
...
| --- | --- | --- | --- | --- | --- |
| bootonFont | Inter | 400, 575, 600, 700 | 12px, 14px, 16px, 20px, 22px, 48px, 60px, 85px | 1.00, 1.10, 1.30, 1.40, 1.50 | Primary typeface for all UI elements, body text, and most headings. Its varied weights support a robust typographic hierarchy with a precise, condensed feel at display sizes due to tight letter-spacing. |
| affairsFont | Georgia | 400 | 36px, 80px | 1.05, 1.20 | Used for specific large display headings and quotes, offering a slightly more elegant and less technical counterpoint to bootonFont, with a distinct presence at very large sizes. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777510666074-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777510666074-thumb.jpg |
