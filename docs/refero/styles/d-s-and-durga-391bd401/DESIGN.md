# D.S. & DURGA — Refero Style

- Refero URL: https://styles.refero.design/style/391bd401-06d7-4444-8243-8573e96eab24
- Site URL: https://www.dsanddurga.com
- ID: 391bd401-06d7-4444-8243-8573e96eab24
- Theme: light
- Industry: ecommerce
- Created: 2026-04-30T01:34:18.216Z
- Ranks: newest: 572, popular: 874, trending: 770
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Canvas Parchment | #f2e9de | neutral | Page backgrounds, card surfaces, ghost button backgrounds — a warm, light neutral creating a natural paper-like base |
| Midnight Ink | #000000 | neutral | Primary text, headings, strong borders, icons, interactive elements — providing high contrast and graphic boldness against light surfaces |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Sofia Pro | Montserrat | 400, 600, 800 | 12px, 14px, 16px, 18px, 30px, 60px, 120px | 0.83, 0.92, 1.17, 1.22, 1.25, 1.27, 1.43 | All textual content, from navigation to product titles. The varied weights and precise letter-spacing create distinct hierarchies and give a modern, authoritative tone. Tighter tracking for larger sizes enhances the impact of display text. |
...
| body-sm | 14 | 1.27 | 0.7 |
| body | 16 | 1.25 | 0.8 |
| subheading | 18 | 1.22 | 0.9 |
| heading | 30 | 1.17 | -1.5 |
| heading-lg | 60 | 0.92 | -3 |
| display | 120 | 0.83 | -6 |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777512821196-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777512821196-thumb.jpg |
