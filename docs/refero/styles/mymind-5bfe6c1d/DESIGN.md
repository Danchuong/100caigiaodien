...
- Refero URL: https://styles.refero.design/style/5bfe6c1d-1b15-4f8d-b0c9-677a33291c5d
- Site URL: https://mymind.com
- ID: 5bfe6c1d-1b15-4f8d-b0c9-677a33291c5d
- Theme: light
- Industry: productivity
- Created: 2026-03-27T17:23:21.000Z
- Ranks: newest: 991, popular: 34, trending: 86
...
| --- | --- | --- | --- | --- | --- |
| Open Sans | Open Sans (Google Fonts) | 400 | 18px, 22px | 1.00–1.67 | Fallback / supporting body text in specific CMS-driven content blocks. |
| Louize-Regular-205TF | Freight Display Pro, or Playfair Display at weight 400 | 400 | 18px, 32px, 36px, 42px, 52px, 54px, 80px, 96px, 140px | 0.80–1.30 | Editorial display and section headlines. The defining typographic voice — a transitional serif with ink-trap details. At 96–140px with -0.062em tracking, letterforms compress into a single visual mass. Anti-conventional: weight 400 (not bold) at enormous sizes creates authority through mass and scale rather than weight. |
| Louize-Italic-205TF | Freight Display Pro Italic | 400 | 80px, 84px | 0.88 | Italic variant for editorial emphasis within headlines — creates contrast between upright and italic forms at the same display size |
| Nunito-SemiBold / Nunito-Regular | Nunito (Google Fonts) | 400–500 | 15px, 16px, 18px, 20px | 1.20–1.75 | UI micro-labels, button text, nav items, section eyebrows. Tracked out at +0.025em to +0.125em for uppercase labels — the widest positive tracking in the system, contrasting sharply with Louize's negative tracking. Rounded forms soften UI chrome against the editorial serif. |
| Avenir LT W01_45 Book1475508 | DM Sans or Nunito Sans | 400 | 15px, 16px, 20px, 24px, 32px, 40px, 42px, 48px, 54px, 80px, 96px, 140px | 0.85–1.83 | Body copy and long-form explanatory text. Humanist geometric grotesque — bridges the editorial serif headlines and the rounded UI labels. Letter-spacing held at -0.06em across all sizes. |
| Inter-Medium / Inter-Regular | Inter (Google Fonts) | 400 | 16px, 18px, 20px, 24px, 40px | 1.11–1.67 | Navigation labels, UI body text, list items. Neutral workhorse for medium-density interface contexts where Avenir's personality would compete. Tracking at -0.04em to -0.013em. |
| neue-haas-grotesk-display | Helvetica Neue | 500 | 16px, 24px | 1.00–1.25 | Small-caps section category labels and UI micro-headings. Tracked out at +0.063em — used where Nunito's roundness is too informal. |
| Louize-Bold-205TF |  | 400 | 42px | 1.19 | Louize-Bold-205TF — detected in extracted data but not described by AI |
| Louize-Medium-205TF |  | 400 | 48px | 0.92 | Louize-Medium-205TF — detected in extracted data but not described by AI |
| mymindai-Regular |  | 400 | 96px | 0.88 | mymindai-Regular — detected in extracted data but not described by AI |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777459186324-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777459186324-thumb.jpg |
| preview video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/5bfe6c1d-1b15-4f8d-b0c9-677a33291c5d-1777556900670-preview.mp4 |
| preview video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/5bfe6c1d-1b15-4f8d-b0c9-677a33291c5d-1777556900670-preview-poster.jpg |
| detail video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/5bfe6c1d-1b15-4f8d-b0c9-677a33291c5d-1777556900670-preview-detail.mp4 |
| detail video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/5bfe6c1d-1b15-4f8d-b0c9-677a33291c5d-1777556900670-preview-detail-poster.jpg |
