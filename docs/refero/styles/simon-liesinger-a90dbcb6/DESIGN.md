# Simon Liesinger — Refero Style

- Refero URL: https://styles.refero.design/style/a90dbcb6-e42c-4992-a83b-94879699dd4f
- Site URL: https://www.liesingers.com
- ID: a90dbcb6-e42c-4992-a83b-94879699dd4f
- Theme: light
- Industry: design
- Created: 2026-04-30T03:07:30.657Z
- Ranks: newest: 225, popular: 762, trending: 648
...
| --- | --- | --- | --- | --- | --- |
| Times | serif | 400 | 10px | 1.20 | Captions, annotations, and subtle metadata text. Its classic feel grounds the starkness elsewhere. |
| GaramondRg | Garamond | 400 | 25px, 29px, 36px | 0.86, 1.00, 1.22, 1.28 | Headlines and prominent body text. The slightly generous letter-spacing provides an open, refined feel typical of editorial design. |
| HelveticaRg | Helvetica Neue | 400 | 12px | 0.83, 1.20, 1.67 | Interactive links and compact body text. Specific font features enhance legibility for numerical and capitalized content, fitting for a portfolio site. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777518433326-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777518433326-thumb.jpg |
