...
- Refero URL: https://styles.refero.design/style/72b85d0a-1ff8-4dd3-b33a-f55aad6df5c9
- Site URL: https://busuu.com
- ID: 72b85d0a-1ff8-4dd3-b33a-f55aad6df5c9
- Theme: light
- Industry: other
- Created: 2026-02-28T15:24:13.000Z
- Ranks: newest: 1110, popular: 467, trending: 517
...
| --- | --- | --- | --- | --- | --- |
| Nista | system-ui, sans-serif | 400, 700, 800 | 10px, 12px, 14px, 16px, 18px, 24px, 36px, 40px | 1.14, 1.20, 1.30, 1.33, 1.50, 1.70 | The primary typeface for all text elements, from body copy to headlines, maintaining a consistent, approachable brand voice across all sizes and weights. Weight 400 is standard for body text, 700 and 800 for emphasizing headlines and navigation. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775933069275-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775933069275-thumb.jpg |
