# Squarespace — Refero Style

- Refero URL: https://styles.refero.design/style/8618f649-6d1c-45ca-aff8-e7f04928d8dd
- Site URL: https://www.squarespace.com
- ID: 8618f649-6d1c-45ca-aff8-e7f04928d8dd
- Theme: light
- Industry: design
- Created: 2026-04-30T00:15:18.194Z
- Ranks: newest: 855, popular: 1077, trending: 995
...
| --- | --- | --- | --- | --- | --- |
| Clarkson | Open Sans | 300, 400, 500 | 12px, 13px, 14px, 15px, 20px, 26px, 40px, 64px, 72px | 0.93, 1.00, 1.20, 1.40 | Primary typeface for all headings, body text, and interactive elements. Its variable weights and precise letter-spacing create a sophisticated, modern feel, prioritizing clarity and presence. |
| Clarkson Serif | Playfair Display | 400 | 26px | 1.00 | Used for specific stylized headings, providing a classic, elegant contrast to the primary sans-serif. Distinctive for its unique letter-spacing at its size. |
| sans-serif | system-ui | 400 | 16px | 1.20 | Fallback for system text, used rarely, primarily for accessibility or default browser styles where custom fonts may fail to load. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777508092046-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777508092046-thumb.jpg |
