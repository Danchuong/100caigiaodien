# Visitors — Refero Style

- Refero URL: https://styles.refero.design/style/e7876363-181a-44a9-9e5c-2255cf98aea5
- Site URL: https://visitors.now
- ID: e7876363-181a-44a9-9e5c-2255cf98aea5
- Theme: light
- Industry: saas
- Created: 2026-04-30T00:23:04.533Z
- Ranks: newest: 816, popular: 112, trending: 74
...
| --- | --- | --- | --- | --- | --- |
| OpenRunde | system-ui, sans-serif | 400, 500, 600, 700 | 12px, 13px, 14px, 16px, 18px, 20px, 24px, 36px, 48px, 60px | 1.00, 1.11, 1.13, 1.17, 1.22, 1.33, 1.40, 1.43, 1.50, 1.56 | Primary typeface for all UI elements, headings, and body text. Its compact metrics and varied letter spacing across sizes reinforce the analytical yet modern feel of the interface. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777508553847-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777508553847-thumb.jpg |
