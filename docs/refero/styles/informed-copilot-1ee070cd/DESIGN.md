# informed Copilot — Refero Style

- Refero URL: https://styles.refero.design/style/1ee070cd-3be5-4efb-aa4f-06bce9eb5fe4
- Site URL: https://www.informed.so
- ID: 1ee070cd-3be5-4efb-aa4f-06bce9eb5fe4
- Theme: light
- Industry: ai
- Created: 2026-04-30T02:09:35.908Z
- Ranks: newest: 430, popular: 1233, trending: 1221
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Canopy Green | #08c474 | brand | Primary accent for interactive elements like CTA buttons, input borders, and active states. It signals action and key information without overwhelming the clean, white canvas |
| Midnight Ink | #000000 | neutral | Primary text color for headlines and strong body content, ensuring highest contrast on light backgrounds. Also used for primary borders and structural outlines |
| Cloud Gray | #f8f8f7 | neutral | Secondary surface background for cards and subtle content sections, providing a slight elevation from the pure white canvas. Also used for ghost button backgrounds |
| Ash Gray | #7e838f | neutral | Muted text for helper content, descriptions, and secondary labels. Provides a legible but softer presence than primary text |
| Slate Text | #31343b | neutral | Used for some body text and subheadings, offering a slightly softer contrast than pure black for dense content |
| Coal Text | #252525 | neutral | Subtle text and button-text variant, providing a softer contrast than Midnight Ink |
| Canvas White | #ffffff | neutral | Dominant page background, providing a clean, expansive canvas. Also used for text on green buttons and as a decorative border for ghost buttons |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Times |  | 400 | 17px, 28px | 1 | Times — detected in extracted data but not described by AI |
| Questrial | Montserrat | 400, 700 | 13px, 15px, 17px, 20px, 22px, 24px, 52px, 69px | 1.00, 1.25, 1.50, 2.88, 3.00 | Primary typeface for headings and prominent UI elements. Its clean, geometric forms, combined with slightly condensed letter-spacing, create a contemporary and precise feel. The use of a single, consistent letter-spacing across all sizes contributes to a unified visual rhythm. |
| Roboto | Inter | 100, 400 | 20px, 26px | 1.50, 2.56 | Used for more technical input elements and some secondary body text, providing a highly legible and functional counterpoint to Questrial. The normal letter spacing ensures clarity in smaller contexts. |
...
| --- | --- | --- | --- |
| body | 15 | 1.5 | -0.062 |
| heading-sm | 20 | 1.5 | -0.062 |
| heading | 22 | 1.5 | -0.062 |
| heading-lg | 24 | 1.5 | -0.062 |
| display | 52 | 1 | -0.062 |
| display-lg | 69 | 1 | -0.062 |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777514936306-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777514936306-thumb.jpg |
