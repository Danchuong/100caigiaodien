# Incident — Refero Style

- Refero URL: https://styles.refero.design/style/d9a60077-619a-4cb7-95ed-0c428c2b51ed
- Site URL: https://incident.io
- ID: d9a60077-619a-4cb7-95ed-0c428c2b51ed
- Theme: light
- Industry: saas
- Created: 2026-04-30T00:21:46.602Z
- Ranks: newest: 823, popular: 937, trending: 898
...
| --- | --- | --- | --- | --- | --- |
| Times | serif | 400, 700 | 16px, 19px, 24px, 32px | 1.20 | Primary headings, body text, and links – a classic serif choice that grounds the technical content with a sense of established authority rather than modern digital slickness. |
| Arial | sans-serif | 400 | 13px | 1.20 | Used for smaller functional text such as button labels and navigation, providing a universally legible sans-serif counterpoint to the serif body. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777508483688-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777508483688-thumb.jpg |
