...
- Refero URL: https://styles.refero.design/style/31903c2b-99bf-4fa8-8c92-238858f3563c
- Site URL: https://walden.us
- ID: 31903c2b-99bf-4fa8-8c92-238858f3563c
- Theme: light
- Industry: ecommerce
- Created: 2026-04-30T03:21:34.951Z
- Ranks: newest: 172, popular: 922, trending: 875
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Forest Shadow | #3f3f3f | neutral | Primary text, informational body copy, general UI elements, icon fill |
| Canvas White | #ffffff | neutral | Page backgrounds, card surfaces, ghost button text on dark backgrounds, primary navigation text |
| Earth Stone | #d3cec5 | neutral | Medium-contrast borders, control outlines, and structural separators. Do not promote it to the primary CTA color |
| True Black | #030302 | neutral | Action button backgrounds, strong borders for interactive elements, primary navigation text on light backgrounds |
| Muted Grey | #686867 | neutral | Dark borders and separators for elevated surfaces and inverted UI. Do not promote it to the primary CTA color |
| Light Stone | #acacac | neutral | Lightest border lines, dividers |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Graphik | system-ui, sans-serif | 400, 600 | 10px, 12px, 14px, 16px, 18px, 20px | 1.00, 1.10, 1.20, 1.30, 1.40, 1.67 | Primary typeface for all text content: body, headings, navigation, and input fields. Its clean, geometric form maintains the minimal aesthetic. |
| Geist | monospace | 400 | 14px | 1.00, 1.10, 1.20, 1.40 | Used for specific interactive elements and labels, providing a distinct, slightly more technical feel while maintaining legibility. |
| GTStandard-M | monospace | 400 | 14px | 1.50 | A distinct serif-like typeface employed for specialized content or decorative text elements, enhancing perceived craftsmanship and quality. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777519276822-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777519276822-thumb.jpg |
