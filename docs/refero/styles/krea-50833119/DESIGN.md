...
- Refero URL: https://styles.refero.design/style/50833119-cb36-4b75-b0cc-be48afea050a
- Site URL: https://krea.ai
- ID: 50833119-cb36-4b75-b0cc-be48afea050a
- Theme: dark
- Industry: ai
- Created: 2026-02-27T18:32:49.000Z
- Ranks: newest: 1114, popular: 101, trending: 87
...
| --- | --- | --- | --- | --- | --- |
| Suisse Intl | Inter | 400, 450, 500, 600, 700 | 12px, 13px, 14px, 15px, 16px, 18px, 20px, 24px, 30px, 36px, 48px, 60px, 72px, 96px | 1.00, 1.05, 1.11, 1.20, 1.25, 1.33, 1.38, 1.40, 1.43, 1.50, 1.56 | Dominant and sole typeface, maintaining a consistent, precise tone across all content from large display headings to small body text. The tight letter-spacing for larger sizes gives headlines a carved, intentional feel, while wider spacing for small text aids readability. Its custom nature highlights a brand commitment to distinct visual identity. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775932585962-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775932585962-thumb.jpg |
