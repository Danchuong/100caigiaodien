# Leonid Kostetskyi — Refero Style

- Refero URL: https://styles.refero.design/style/5a7ba5ff-0476-4f3f-99f9-0b920534dde5
- Site URL: https://leonidkostetskyi.com
- ID: 5a7ba5ff-0476-4f3f-99f9-0b920534dde5
- Theme: light
- Industry: design
- Created: 2026-04-30T03:08:27.693Z
- Ranks: newest: 221, popular: 167, trending: 118
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Canvas Parchment | #fdfaf3 | neutral | Page background; a soft, warm off-white providing an antique paper-like feel to the entire experience |
| Cocoa Ink | #472425 | brand | Primary text, headings, outline borders, and a subtle action indicator. Its deep red-brown provides strong contrast without the harshness of true black, defining the brand's sophisticated warmth |
| Pure White | #ffffff | neutral | Background for certain interactive states, subtle borders, and an alternative text color on dark backgrounds |
| Absolute Black | #000000 | neutral | Background for dark themed sections, and inverse text color. This color is used sparingly to create visual breaks |
| Deep Charcoal | #121212 | neutral | Secondary text and outline borders, providing a slightly softer dark tone than Absolute Black |
| Alert Crimson | #e73737 | accent | Red outline accent for tags, dividers, and focused UI edges. Use as a supporting accent, not as a status color |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| SFUIDisplay | system-ui | 300, 400 | 8px, 9px, 11px, 12px, 15px, 18px, 19px, 20px, 21px | 1.00, 1.10, 1.33, 1.40, 1.60 | Primary text for body content, navigational elements, and descriptive links. Its neutrality supports legibility across various UI elements. |
| NeueHaasDisplay | system-ui | 400 | 11px, 12px, 15px, 27px, 135px, 143px, 165px, 188px | 0.86, 1.00 | Distinctive display font for large headlines and titles. The tight letter-spacing and very large sizes create a strong, imposing, and modern visual statement, prioritizing form over immediate readability at extreme scales. |
| Arial | Arial | 400 | 13px | 1.20 | Used for a specific functional button style, acting as a system fallback or for very minor interface text where a standard sans-serif is preferred. |
...
| --- | --- | --- | --- |
| heading | 27 | 1 | -0.54 |
| display-lg | 135 | 0.86 | -3.375 |
| display | 188 | 0.86 | -4.7 |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777518482963-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777518482963-thumb.jpg |
| preview video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/5a7ba5ff-0476-4f3f-99f9-0b920534dde5-1777582955538-preview.mp4 |
| preview video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/5a7ba5ff-0476-4f3f-99f9-0b920534dde5-1777582955538-preview-poster.jpg |
| detail video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/5a7ba5ff-0476-4f3f-99f9-0b920534dde5-1777582955538-preview-detail.mp4 |
| detail video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/5a7ba5ff-0476-4f3f-99f9-0b920534dde5-1777582955538-preview-detail-poster.jpg |
