# AngelList — Refero Style

- Refero URL: https://styles.refero.design/style/c75603c7-492d-4c26-9744-9acc22fe6225
- Site URL: https://www.angellist.com
- ID: c75603c7-492d-4c26-9744-9acc22fe6225
- Theme: dark
- Industry: fintech
- Created: 2026-04-30T00:24:54.737Z
- Ranks: newest: 808, popular: 810, trending: 751
...
| --- | --- | --- | --- | --- | --- |
| angellist | Inter, Arial, sans-serif | 400, 500, 600, 700 | 11px, 12px, 13px, 14px, 16px, 18px, 90px, 216px | 0.90, 1.10, 1.20, 1.40, 1.45, 1.50, 1.60, 2.64 | Primary typeface for body text, interface elements, and smaller headings. Features stylistic alternates and tabular figures for precise data display, embodying a structured yet clean feel. |
| angellistDisplay | Inter, Arial, sans-serif | 400 | 28px, 38px, 60px, 90px, 112px, 216px | 0.90, 1.10, 1.15, 1.25, 1.30 | Used exclusively for large, impactful display headings. Its slightly tighter tracking at larger sizes maintains legibility and prominence without feeling bloated. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777508647113-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777508647113-thumb.jpg |
