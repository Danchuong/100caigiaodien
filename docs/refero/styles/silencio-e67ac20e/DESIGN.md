# Silencio — Refero Style

- Refero URL: https://styles.refero.design/style/e67ac20e-6497-4756-b7e2-17859a794fb6
- Site URL: https://silencio.es
- ID: e67ac20e-6497-4756-b7e2-17859a794fb6
- Theme: light
- Industry: agency
- Created: 2026-02-27T09:21:05.000Z
- Ranks: newest: 1121, popular: 456, trending: 581
...
| --- | --- | --- | --- | --- | --- |
| HaasR | Inter | 100, 400, 700 | 12px, 16px, 19px, 22px, 39px, 58px | 0.90, 1.00, 1.10, 1.20, 1.40 | Primary body, subtitles, and smaller headings. The range of weights and tight line heights are crucial for its precise, often compact presentation. |
| HaasT | Inter | 100, 400 | 141px | 0.90, 1.20 | Display headings. The extremely large size and tightest possible line height emphasize impact through scale rather than color or bold weight, typical for a design agency's self-presentation. |
| PT Mono | PT Mono | 400 | 11px | 1.20 | Monospace for subtle annotations, references, and code-like elements, adding a technical, detailed footnote feel. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775925330339-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775925330339-thumb.jpg |
