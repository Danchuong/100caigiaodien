# Becklyn — Refero Style

- Refero URL: https://styles.refero.design/style/3389358b-68b2-4fca-82a8-52c07b3a3475
- Site URL: https://becklyn.com
- ID: 3389358b-68b2-4fca-82a8-52c07b3a3475
- Theme: dark
- Industry: agency
- Created: 2026-04-30T01:41:38.678Z
- Ranks: newest: 543, popular: 1066, trending: 1028
...
| --- | --- | --- | --- | --- | --- |
| UniversalSans | Inter | 400 | 12px, 20px, 22px, 36px, 42px, 68px, 92px | 1.00, 1.05, 1.15, 1.20 | Primary content typeface for most headings, body text, and interactive elements. Its modern, geometric feel provides a sharp and contemporary voice. |
| Cambon | Playfair Display | 400 | 22px, 68px, 92px | 1.00, 1.15 | Decorative serif typeface used sparingly for impactful headlines and large display text, providing an elegant and authoritative counterpoint to the dominant sans-serif. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777513276160-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777513276160-thumb.jpg |
