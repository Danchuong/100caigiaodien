...
- Refero URL: https://styles.refero.design/style/635b7769-7517-48ac-bb95-2ad7fa337e54
- Site URL: https://ifttt.com
- ID: 635b7769-7517-48ac-bb95-2ad7fa337e54
- Theme: dark
- Industry: productivity
- Created: 2026-04-30T01:02:43.139Z
- Ranks: newest: 637, popular: 1244, trending: 1237
...
| --- | --- | --- | --- | --- | --- |
| Avenir Next | system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol' | 400, 500, 600, 700, 800, 900 | 14px, 15px, 16px, 18px, 20px, 24px, 25px, 28px, 29px, 32px, 36px, 38px, 43px, 48px, 68px | 1.00, 1.11, 1.17, 1.18, 1.19, 1.20, 1.32, 1.33, 1.36, 1.40, 1.43, 1.50, 1.71, 1.75, 1.90, 2.67, 3.00 | The primary typeface for all textual content, from headings to body text and UI elements. Its strong, geometric character provides a clear, authoritative voice for headlines at heavy weights, while maintaining legibility for small interface labels at lighter weights. The consistent, slightly open letter-spacing helps legibility across varied sizes and content densities. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777510930080-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777510930080-thumb.jpg |
