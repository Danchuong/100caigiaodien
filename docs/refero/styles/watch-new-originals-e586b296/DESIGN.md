# Watch new Originals — Refero Style

- Refero URL: https://styles.refero.design/style/e586b296-bfac-4e93-add2-daa384712b39
- Site URL: https://www.disneyplus.com
- ID: e586b296-bfac-4e93-add2-daa384712b39
- Theme: dark
- Industry: media
- Created: 2026-04-30T01:04:39.731Z
- Ranks: newest: 632, popular: 834, trending: 693
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Deep Midnight | #040714 | neutral | Primary page background, core content surface. Provides an immersive, dark canvas for media |
| Cool Graphite | #282a36 | neutral | Input field backgrounds, subtle borders, secondary surface elements. A slightly lighter dark gray for contrast |
| Sky Blue | #33ddff | brand | Primary call-to-action button backgrounds. A vibrant accent to guide user action |
| Electric Teal | #02d6e8 | accent | Secondary call-to-action details, selected active states, descriptive text emphasizing value |
| Text Dark | #02172a | neutral | Text on very light backgrounds (e.g. within active buttons) |
| Muted Silver | #e5e7eb | neutral | Neutral form states, badge text, and quiet UI feedback where color should stay understated. Do not promote it to the primary CTA color |
| Light Gray | #c0c0c0 | neutral | Secondary text, unselected icons, helper text for content metadata |
| Off-White | #fafafa | neutral | Primary text, headlines, navigation labels. High-contrast text on dark backgrounds |
| Deep Space | #0e0b14 | neutral | Footer background, elevated sections for visual separation |
| Ghost Gray | #b7b8bd | neutral | Placeholder text in input fields, less prominent body copy |
| Accent Gray | #1e1f24 | neutral | Subtle background for UI elements that need mild distinction from Deep Midnight |
| Button Dark Text | #17171c | neutral | Text color for primary buttons with vibrant backgrounds |
| Faint Border | #6f717b | neutral | Decorative borders on certain navigation elements |
| Canvas Blue Black | #010104 | neutral | Navigation bar background. Provides a distinct and consistent top-level UI element |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Inspire | system-ui, sans-serif | 400, 700 | 12px, 14px, 16px, 18px, 20px, 28px, 40px | 1.20, 1.38, 1.40, 1.50, 1.83 | Primary typeface for all text content, from body copy to headlines. Its consistent tracking provides a unified and readable experience across different scales. Weight 400 is used for general content, while 700 emphasizes critical information. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777511054614-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777511054614-thumb.jpg |
