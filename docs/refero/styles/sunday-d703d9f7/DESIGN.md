...
- Refero URL: https://styles.refero.design/style/d703d9f7-4821-468e-8fe4-c8b5790b00ed
- Site URL: https://sundayapp.com
- ID: d703d9f7-4821-468e-8fe4-c8b5790b00ed
- Theme: light
- Industry: fintech
- Created: 2026-04-30T03:53:20.776Z
- Ranks: newest: 37, popular: 414, trending: 246
...
| --- | --- | --- | --- | --- | --- |
| Helvetica Neue | Arial, sans-serif | 400 | 12px, 14px, 16px, 18px, 24px, 32px, 48px, 64px, 200px | 0.80, 0.95, 1.00, 1.13, 1.14, 1.20, 1.25, 1.33, 1.78 | The sole typeface, Helvetica Neue, is used across all text elements. Its clean, geometric form supports the modern aesthetic. Varying weights, sizes, and a precise letter-spacing system create hierarchy, ensuring impact for headlines and legibility for body text without introducing visual noise. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777521169635-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777521169635-thumb.jpg |
