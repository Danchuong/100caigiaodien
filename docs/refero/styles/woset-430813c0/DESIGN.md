...
- Refero URL: https://styles.refero.design/style/430813c0-f0c7-434f-92ef-d3a0780ba734
- Site URL: https://www.woset.world
- ID: 430813c0-f0c7-434f-92ef-d3a0780ba734
- Theme: light
- Industry: ecommerce
- Created: 2026-04-30T02:53:53.294Z
- Ranks: newest: 274, popular: 842, trending: 817
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Canvas | #e5e7eb | neutral | Page backgrounds, muted borders, subtle surface accents — a near-white canvas allowing product illustrations to be the focal point |
| Ink Black | #000000 | neutral | Primary text, headings, prominent borders, filled button backgrounds. The core dark for high contrast |
| Muted Ash | #bbbab7 | neutral | Button borders for ghost buttons, subtle dividers. A softer boundary than direct black |
| Graphite | #8d8c8a | neutral | Secondary body text, price listings, less prominent textual elements — a gentle contrast against the canvas |
| Crayon Yellow | #ecca53 | brand | Primary action background, active state accent, secondary surface treatments — the key optimistic brand color. Its vibrancy makes interactive elements feel distinct |
| Deep Violet | #2d5193 | brand | Decorative background fills for visual sections or product showcases — a rich, cool tone that complements the playful primary yellow |
| Forest Green | #054331 | brand | Decorative background fills for visual sections or product showcases — a grounding, earthy hue |
| Artisan Red | #a5001b | brand | Decorative background fills for visual sections or product showcases — a strong, warm accent |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| ts-unused |  | 500 | 15px | 1 | ts-unused — detected in extracted data but not described by AI |
| Macan | Inter | 400, 500 | 15px, 24px, 25px, 95px | 1.00, 1.20, 1.35 | Primary brand typeface for headings, body text, and interactive elements. Its custom nature provides a unique friendly yet authoritative feel. Weight 400 is common for body text (15px), while larger headings use 500 (25px, 95px) with tighter letter spacing for impact. The generous letter spacing for 24px text softens the content. |
| A1 Gothic M | Inter | 400 | 16px | 1.00 | Used for specific body text elements, likely a display-focused variation. Its tight letter spacing (-0.019em) creates a compact, refined appearance, contrasting with the slightly more open Macan. |
| GTStandard-M |  | 400 | 15px | 1.5 | GTStandard-M — detected in extracted data but not described by AI |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777517610542-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777517610542-thumb.jpg |
