# OFF+BRAND. — Refero Style

- Refero URL: https://styles.refero.design/style/6b667ffc-5158-4000-9252-3a107d5161ee
- Site URL: https://www.itsoffbrand.com
- ID: 6b667ffc-5158-4000-9252-3a107d5161ee
- Theme: light
- Industry: agency
- Created: 2026-04-30T00:38:53.364Z
- Ranks: newest: 740, popular: 324, trending: 201
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Midnight Ink | #1d1d1d | neutral | Primary text, darkest UI element borders, prominent headings |
| Canvas White | #e5e4e0 | neutral | Page background, main surface color, light UI element borders, muted text |
| Pure White | #ffffff | neutral | Elevated surfaces, secondary backgrounds, icon fills |
| Frost Gray | #bfbebe | neutral | Subtle dividers, ghost button borders, decorative strokes |
| Gradient Aura | #facb00 | brand | Hero background element, large decorative shapes, occasional icon accent — a central visual motif that introduces dynamic color |
| Brand Orange | #ff642f | brand | Supporting palette color for small decorative accents when the core palette needs contrast. Do not promote it to the primary CTA color |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Ataero Retina OB Edition | Inter | 400, 700 | 11px, 15px, 18px, 34px, 46px, 70px, 76px, 103px | 0.80, 1.00, 1.40 | The primary typeface for all text. The custom nature and broad range of weights and sizes allow for both headline impact and readable body copy. The high letter-spacing on larger sizes creates an airy, uncrowded feel. |

## Type Scale

| Role | Size | Line Height | Letter Spacing |
| --- | --- | --- | --- |
| caption | 11 | 1.4 | 0.078 |
| body-sm | 15 | 1.4 | 0.078 |
| body | 18 | 1.4 | 0.078 |
| subheading | 34 | 1 | 0.078 |
| heading-sm | 46 | 0.8 | 0.69 |
| heading | 70 | 0.8 | 0.88 |
| heading-lg | 76 | 0.8 | 0.99 |
| display | 103 | 0.8 | 1.2 |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777509507380-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777509507380-thumb.jpg |
