# 10X HUB — Refero Style

- Refero URL: https://styles.refero.design/style/4acc13a0-c553-40d7-b78d-a9b6a4e94486
- Site URL: https://10xdesigners.co
- ID: 4acc13a0-c553-40d7-b78d-a9b6a4e94486
- Theme: mixed
- Industry: agency
- Created: 2026-02-21T11:29:41.000Z
- Ranks: newest: 1151, popular: 362, trending: 498
...
| --- | --- | --- | --- | --- | --- |
| Arial | Arial | 400 | 10px, 13px | 1.20 | System font for small UI elements, buttons, and general body text where efficiency is key. |
| helvetica-w01-roman | Helvetica Neue | 400 | 13px, 14px, 15px, 18px, 31px, 45px | 1.00, 1.20, 1.40, 1.60 | Standard body text, subheadings, and form labels. Its neutrality underpins the visual hierarchy. |
| wfont_9aea05_daebdda91ced4d119f7837b7bae26e19 | Roboto Mono | 400 | 24px, 298px | 1.00 | Used for large, impactful display headings (e.g., '10X HUB'). The monospaced nature at extreme sizes provides a technical, almost blueprint-like authority. |
| madefor-text | Inter | 400 | 187px | 1.20 | Signature display font for hero headlines. Its extreme size and negative letter-spacing create a visual tension and modern, impactful statement. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775925424211-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775925424211-thumb.jpg |
