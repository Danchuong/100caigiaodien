...
- Refero URL: https://styles.refero.design/style/f1bff240-fa05-41db-9ae1-b165ea6ea2cb
- Site URL: https://cohere.com
- ID: f1bff240-fa05-41db-9ae1-b165ea6ea2cb
- Theme: light
- Industry: ai
- Created: 2026-01-30T16:51:12.000Z
- Ranks: newest: 1256, popular: 347, trending: 430
...
| --- | --- | --- | --- | --- | --- |
| Unica77 Cohere Web | Inter | 400, 700 | 12px, 14px, 16px, 18px, 24px, 32px, 48px | 1.20, 1.30, 1.40, 1.50 | Primary branding sans-serif. Used for body text, navigation, buttons, and most headings up to display size. Its subtle negative letter-spacing contributes to the precise, engineered feel. |
| CohereText | Outfit | 400 | 60px, 72px | 1.00 | Signature display font for large headlines. Its extremely tight letter-spacing and substantial size command attention without being visually disruptive, embodying the brand's confident but refined voice. |
| CohereMono | Space Mono | 400 | 14px | 1.40 | Monospaced font for code snippets or specific technical labels in navigation. The slight positive letter-spacing ensures readability of technical terms, contrasting with the tighter Unica77. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775923740564-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775923740564-thumb.jpg |
