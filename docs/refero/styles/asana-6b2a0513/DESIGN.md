...
- Refero URL: https://styles.refero.design/style/6b2a0513-df80-4140-87a8-38b1fef34313
- Site URL: https://asana.com
- ID: 6b2a0513-df80-4140-87a8-38b1fef34313
- Theme: light
- Industry: productivity
- Created: 2026-03-11T12:24:28.000Z
- Ranks: newest: 1054, popular: 171, trending: 476
...
| --- | --- | --- | --- | --- | --- |
| Ghost | Neue Haas Grotesk Display, Aktiv Grotesk Ex | 500 | 60px, 72px | 1.00 | Display headlines only — the hero statement and major section titles. Weight 500 at 60-72px with tight -0.007em tracking compresses letter forms into dense editorial blocks. No other font on the site operates at this scale, making Ghost the unambiguous voice of authority. |
| TWK Lausanne | Lausanne (Weltkern), Inter, DM Sans | 300, 400, 500 | 11px, 12px, 13px, 14px, 16px, 20px, 22px, 24px, 30px, 36px | 1.20 – 2.57 depending on size (large sizes ~1.20, body ~1.50, captions ~1.75) | Everything except hero display text: nav labels (weight 400, 14px), body copy (weight 300–400, 16px), subheadings (weight 500, 20-30px), section headings (weight 500, 24-36px). Weight 300 for body imparts an open, non-urgent reading texture. Weight 500 for UI labels and mid-hierarchy headings. Positive letter-spacing at small sizes (+0.025–0.04em) prevents optical crowding in captions and badges. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775934085899-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775934085899-thumb.jpg |
| preview video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/6b2a0513-df80-4140-87a8-38b1fef34313-1777559683938-preview.mp4 |
| preview video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/6b2a0513-df80-4140-87a8-38b1fef34313-1777559683938-preview-poster.jpg |
| detail video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/6b2a0513-df80-4140-87a8-38b1fef34313-1777559683938-preview-detail.mp4 |
| detail video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/6b2a0513-df80-4140-87a8-38b1fef34313-1777559683938-preview-detail-poster.jpg |
