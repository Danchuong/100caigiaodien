...
- Refero URL: https://styles.refero.design/style/98ab0172-9474-43b5-9055-98cf1a6a2401
- Site URL: https://analogue.co
- ID: 98ab0172-9474-43b5-9055-98cf1a6a2401
- Theme: dark
- Industry: other
- Created: 2026-01-28T18:21:12.000Z
- Ranks: newest: 1262, popular: 342, trending: 438
...
| --- | --- | --- | --- | --- | --- |
| circularXx | Circular Std | 400 | 13px, 15px, 16px, 18px, 19px, 21px, 26px, 35px, 47px, 53px | 0.80, 1.00, 1.11, 1.14, 1.15, 1.20, 1.23, 1.50 | Body text, navigation, input fields, and smaller headings. The slightly condensed, geometric linearity at weight 400 with subtle letter-spacing creates a technical, precise voice. |
| circularXx | Circular Std | 450 | 13px, 15px, 16px, 18px, 19px, 21px, 26px, 35px, 47px, 53px | 0.80, 1.00, 1.11, 1.14, 1.15, 1.20, 1.23, 1.50 | Primary headings and display text. The medium weight with tight, negative letter-spacing for larger sizes gives display headlines a strong, impactful presence while retaining the technical precision. |
| circularXx | Circular Std | 500 | 13px, 15px, 16px, 18px, 19px, 21px, 26px, 35px, 47px, 53px | 0.80, 1.00, 1.11, 1.14, 1.15, 1.20, 1.23, 1.50 | Emphasized text, subheadings, and interactive elements where a slightly stronger voice than weight 400 is desired without resorting to bold. Maintains the precise character of the typeface. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775924960172-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775924960172-thumb.jpg |
