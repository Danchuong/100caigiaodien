# Norgram — Refero Style

- Refero URL: https://styles.refero.design/style/17e5ff99-38c1-4ad6-8910-648f5798b3a5
- Site URL: https://www.norgram.co
- ID: 17e5ff99-38c1-4ad6-8910-648f5798b3a5
- Theme: mixed
- Industry: design
- Created: 2026-04-30T03:01:24.516Z
- Ranks: newest: 248, popular: 1159, trending: 1133
...
| --- | --- | --- | --- | --- | --- |
| Helvetica Now Display | Inter | 400 | 10px, 12px, 36px, 87px | 1.00, 1.10, 1.17, 1.67 | Primary display text, headlines, main body content, and navigation elements. Its precise tracking at larger sizes maintains clarity and strong visual presence. |
| Times | Times New Roman | 400 | 14px, 16px | 1.43, 1.50 | Long-form editorial body text, detailed descriptions, and footer content. The serif choice adds a touch of classic sophistication against the clean sans-serif displays. |
| Helvetica Now Display | Inter | 400, 500 |  |  | Interactive link text, small labels, and button text when a slightly bolder or more compact presentation is needed than the regular weight. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777518022298-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777518022298-thumb.jpg |
