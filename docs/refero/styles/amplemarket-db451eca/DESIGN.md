# Amplemarket — Refero Style

- Refero URL: https://styles.refero.design/style/db451eca-8de6-43a9-a5d5-35271befdffd
- Site URL: https://www.amplemarket.com
- ID: db451eca-8de6-43a9-a5d5-35271befdffd
- Theme: light
- Industry: ai
- Created: 2026-04-30T00:21:42.206Z
- Ranks: newest: 824, popular: 80, trending: 51
...
| --- | --- | --- | --- | --- | --- |
| Labil Grotesk Variable | Inter | 400, 500, 700, 900 | 8px, 10px, 12px, 14px, 16px, 20px, 24px, 28px, 36px, 44px, 56px, 84px | 0.80, 1.00, 1.10, 1.20, 1.30 | Primary typeface for all text elements. The variable font allows for fine-tuned expression across headers and body copy, giving a consistent, modern, and precise feel. The distinct letter-spacing adjustments, particularly negative tracking for larger sizes, create a sharp, intentional rhythm for headlines. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777508471223-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777508471223-thumb.jpg |
