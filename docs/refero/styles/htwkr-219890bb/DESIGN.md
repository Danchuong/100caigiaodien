...
- Refero URL: https://styles.refero.design/style/219890bb-aa52-46cb-89a0-459d0519ad04
- Site URL: https://howtotalktowhitekidsaboutracism.com
- ID: 219890bb-aa52-46cb-89a0-459d0519ad04
- Theme: dark
- Industry: other
- Created: 2026-04-30T01:30:17.579Z
- Ranks: newest: 586, popular: 1010, trending: 987
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Ebon | #000000 | neutral | Page and section backgrounds, creating a deep, uniform expanse |
| Chalk | #ffffff | neutral | Primary text across all elements (body, links, other text) and for borders signaling interaction or framing. This is the luminous foreground against the deep Ebon background |
| Muted Ash | #5f5f5f | neutral | Secondary body text and subtle borders, providing a softer contrast for less prominent information |
| Pale Stone | #8f8f8f | neutral | Tertiary text and very faint borders, used for ancillary information or as a subtle structural cue |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Canela Web | serif | 300, 400 | 12px, 14px, 16px, 20px | 1.00, 1.12, 1.20, 1.40, 1.60, 1.87 | The sole typeface, used for all textual content from headings to body text and links. Its elegant serif forms and range of weights, particularly the lighter 300 and 400, contribute to the site's contemplative and refined character, ensuring that text feels legible without being stark. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777512600151-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777512600151-thumb.jpg |
