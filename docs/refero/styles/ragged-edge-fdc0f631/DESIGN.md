# Ragged Edge — Refero Style

- Refero URL: https://styles.refero.design/style/fdc0f631-442c-466d-ab79-e1fff2bfdb7d
- Site URL: https://raggededge.com
- ID: fdc0f631-442c-466d-ab79-e1fff2bfdb7d
- Theme: light
- Industry: agency
- Created: 2026-04-30T00:35:49.924Z
- Ranks: newest: 752, popular: 789, trending: 628
...
| --- | --- | --- | --- | --- | --- |
| Grit-Regular | Inter | 400, 500 | 14px, 16px, 20px, 30px, 56px | 1.00, 1.20, 1.25, 1.43, 1.50, 2.60 | Body text, navigation items, links, and general UI elements. Its strong, humanist character serves as the workhorse typeface. |
| ABCDiatypeExpanded-Bold | Bebas Neue | 400 | 10px, 12px, 16px, 20px, 40px, 78px, 82px | 1.10, 1.15, 1.20, 2.00 | Prominent headlines and impactful statements. Its expanded, bold form demands attention and defines the brand's direct, confident voice. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777509321979-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777509321979-thumb.jpg |
