# Monocle — Refero Style

- Refero URL: https://styles.refero.design/style/9165ecb1-f068-4093-8783-1f3c98898b8a
- Site URL: https://monocle.com
- ID: 9165ecb1-f068-4093-8783-1f3c98898b8a
- Theme: light
- Industry: media
- Created: 2026-02-25T11:35:40.000Z
- Ranks: newest: 1133, popular: 229, trending: 208
...
| --- | --- | --- | --- | --- | --- |
| Plantin | Georgia | 400, 700 | 13px, 16px, 18px, 20px, 24px, 28px, 32px, 34px, 40px | 1.00, 1.13, 1.15, 1.20, 1.25, 1.30, 1.38, 1.44, 1.50 | Primary content, article headlines, body text, and any long-form narrative. The custom serif embodies the brand's traditional editorial authority. |
| Helvetica Neue | Arial | 400, 700 | 13px, 14px, 16px, 24px | 1.00, 1.13, 1.25, 1.29, 1.38, 1.50 | UI elements, navigation, buttons, and short descriptive text – providing a clean, modern contrast to the serif content. |
| Chanel | Playfair Display | 700 | 9px | 1.00 | Distinctive custom display font, likely reserved for branded elements like the main Monocle logo. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775924808321-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775924808321-thumb.jpg |
