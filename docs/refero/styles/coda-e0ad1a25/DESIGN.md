...
- Refero URL: https://styles.refero.design/style/e0ad1a25-5609-45e6-a355-9bdeec86c5ae
- Site URL: https://www.coda.co
- ID: e0ad1a25-5609-45e6-a355-9bdeec86c5ae
- Theme: light
- Industry: fintech
- Created: 2026-04-30T00:41:53.682Z
- Ranks: newest: 727, popular: 233, trending: 149
...
| --- | --- | --- | --- | --- | --- |
| abcMonumentGrotesk | system-ui | 400, 500, 800 | 16px, 18px, 21px, 22px, 25px, 34px, 45px, 54px, 63px, 72px, 134px | 0.90, 1.00, 1.02, 1.13, 1.30, 1.43, 1.50, 1.71 | Primary display font for all headings, impactful calls to action, and prominent text elements. Its condensed structure and variable weight create a modern, direct tone. Use 'normal' letter spacing for smaller sizes, 'tight' for display headings to emphasize impact. |
| ui-sans-serif | sans-serif | 400 | 16px | 1.50 | Fallback and general UI text where a system font is appropriate for readability and less emphasis than 'abcMonumentGrotesk'. Primarily for body and link text. |
| jetBrainsMono | monospace | 400 | 10px, 12px, 14px, 16px | 0.90, 1.00, 1.20, 1.37 | Monospace font for badges, data points, or areas requiring a technical, precise aesthetic. Used sparingly for specific functional emphasis. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777509682974-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777509682974-thumb.jpg |
