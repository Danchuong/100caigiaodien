# Cori Corinne — Refero Style

- Refero URL: https://styles.refero.design/style/2c18e573-0ffb-4f0d-848c-ff72a5839fd3
- Site URL: https://www.coricorinne.com
- ID: 2c18e573-0ffb-4f0d-848c-ff72a5839fd3
- Theme: light
- Industry: design
- Created: 2026-04-30T03:02:18.446Z
- Ranks: newest: 245, popular: 250, trending: 158
...
| --- | --- | --- | --- | --- | --- |
| Open Sans | system-ui, sans-serif | 400 | 18px, 30px | 1.67, 2.33 | Primary text for body content, links, and general informational text. Its clean, readable proportions balance the more expressive display font. |
| neue-haas-grotesk-text | 'EB Garamond', serif | 400 | 18px, 30px | 1.00, 2.33 | Display font for large, impactful headlines and a signature brand mark. Its high contrast and elegant serif forms establish a sophisticated, editorial tone. The 1.0 line height for smaller sizes contributes to a concise, dense feel. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777518116442-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777518116442-thumb.jpg |
