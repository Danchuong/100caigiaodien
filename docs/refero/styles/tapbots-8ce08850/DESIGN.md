# Tapbots — Refero Style

- Refero URL: https://styles.refero.design/style/8ce08850-085e-4954-a2f0-16acfb8dce23
- Site URL: https://tapbots.com/ivory
- ID: 8ce08850-085e-4954-a2f0-16acfb8dce23
- Theme: dark
- Industry: other
- Created: 2026-03-23T20:57:39.000Z
- Ranks: newest: 1006, popular: 431, trending: 709
...
| --- | --- | --- | --- | --- | --- |
| -apple-system | system-ui | 300, 400, 500, 600 | 16px, 18px, 20px, 21px, 24px, 28px, 32px, 36px | 0.84, 1.10, 1.20, 1.29, 1.40, 1.50, 1.70, 1.80 | The `-apple-system` font is the singular choice, used across all weights and sizes for every text element from body content to hero headlines. This deliberate choice creates a cohesive, platform-native feel that prioritizes clarity and system integration over custom branding through typography. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775926068028-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775926068028-thumb.jpg |
