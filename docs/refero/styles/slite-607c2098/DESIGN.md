...
- Refero URL: https://styles.refero.design/style/607c2098-bbbb-40bb-b23e-adf2b72c63dd
- Site URL: https://slite.com
- ID: 607c2098-bbbb-40bb-b23e-adf2b72c63dd
- Theme: light
- Industry: productivity
- Created: 2026-03-27T15:07:05.000Z
- Ranks: newest: 993, popular: 58, trending: 47
...
| --- | --- | --- | --- | --- | --- |
| Garnett | DM Sans or Fraunces for warmth, though neither replicates Garnett's geometric-editorial balance | 400, 500, 700 | 12px, 14px, 16px, 19px, 24px, 32px, 36px, 64px | 1.20–1.88 | Display and heading font. At 64px weight 700 it carries the hero headline — a custom grotesque with editorial warmth missing from Inter or DM Sans. Weight 500 handles subheadings at 24–36px. The ss14/ss15/ss19 OpenType features are active and likely handle specific glyph alternates that distinguish it from substitutes. |
| UniversalSans | Plus Jakarta Sans or Instrument Sans | 400, 600, 700 | 10px, 11px, 12px, 14px, 16px, 24px | 1.00–1.88 | UI and body font. Handles all button labels, body copy, nav items, badges, captions. Weight 400 at 14–16px for body, 600 for button labels and emphasized UI text, 700 for numeric callouts. The custom face has more warmth than Inter — slightly wider apertures that match the cream-toned page feel. |
| Geist Mono | Geist Mono (available via Vercel) or JetBrains Mono | 400 | 12px | 1.50 | Monospace face used sparingly for code snippets or technical labels. Letter-spacing at 0.117em (approximately 1.4px at 12px) — wider than default, creating a deliberate typewriter rhythm. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775934226984-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775934226984-thumb.jpg |
| preview video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/607c2098-bbbb-40bb-b23e-adf2b72c63dd-1777559408311-preview.mp4 |
| preview video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/607c2098-bbbb-40bb-b23e-adf2b72c63dd-1777559408311-preview-poster.jpg |
| detail video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/607c2098-bbbb-40bb-b23e-adf2b72c63dd-1777559408311-preview-detail.mp4 |
| detail video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/607c2098-bbbb-40bb-b23e-adf2b72c63dd-1777559408311-preview-detail-poster.jpg |
