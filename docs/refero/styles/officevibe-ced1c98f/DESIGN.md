# Officevibe — Refero Style

- Refero URL: https://styles.refero.design/style/ced1c98f-d489-48f7-a01f-1fa59a07b706
- Site URL: https://officevibe.com
- ID: ced1c98f-d489-48f7-a01f-1fa59a07b706
- Theme: light
- Industry: saas
- Created: 2026-03-04T12:42:08.000Z
- Ranks: newest: 1098, popular: 107, trending: 80
...
| --- | --- | --- | --- | --- | --- |
| Inter | system-ui, sans-serif | 400, 500, 700 | 12px, 14px, 16px, 20px | 1.10, 1.20, 1.40, 1.43, 1.60 | Body text, navigation, buttons, lists, captions — the primary functional typeface, providing straightforward readability. |
| Abcfavoritvariable | Arial, sans-serif | 400, 500 | 12px, 14px, 16px, 20px, 24px, 32px, 40px, 48px, 64px | 1.00, 1.10, 1.40, 1.50 | Main headings, subheadings, badge text — imparts a distinctive, slightly geometric character to titles, differentiating them from pure system fonts. |
| Martinaplantijn | cursive | 400 | 40px, 64px | 1.00, 1.10 | Emphatic headline accents — used sparingly to highlight key phrases within larger headings, adding a unique, almost handwritten elegance. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775932183863-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775932183863-thumb.jpg |
