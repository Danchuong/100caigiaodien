...
- Refero URL: https://styles.refero.design/style/e549766e-b8b1-48a2-bd72-8cc04e9e4e9d
- Site URL: https://shade.inc
- ID: e549766e-b8b1-48a2-bd72-8cc04e9e4e9d
- Theme: light
- Industry: media
- Created: 2026-04-30T00:18:31.730Z
- Ranks: newest: 840, popular: 720, trending: 590
...
| --- | --- | --- | --- | --- | --- |
| Inter Display |  | 400 | 10px, 14px, 16px, 18px, 20px, 21px, 24px, 28px, 32px, 36px, 40px, 48px, 56px, 72px | 1.00, 1.10, 1.15, 1.20, 1.22, 1.25, 1.30, 1.40, 1.43, 1.57 | Primary headings and body text, providing a distinctive, tightly spaced feel for key content. The custom features tune its appearance for legibility and aesthetic. |
| sans-serif |  | 400 | 12px | 1.20 | Fallback for general UI text, links, and buttons, ensuring basic content readability without demanding specific font support. Used where Inter Display is not explicitly applied. |
| Aux Mono Regular |  | 400 | 14px | 1.00, 1.29 | Monospaced text for specific data points or code examples, offering a technical and precise feel. The tight letter-spacing emphasizes its distinct character. |
| Inter | Inter | 400, 500 | 12px, 14px, 16px | 1.00, 1.20, 1.50 | General body text, card content, and secondary button labels, providing a highly legible and versatile textual layer. This standard variant of Inter balances readability with the custom Inter Display. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777508281494-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777508281494-thumb.jpg |
