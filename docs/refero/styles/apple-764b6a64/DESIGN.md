...
- Refero URL: https://styles.refero.design/style/764b6a64-c233-4e0f-b8e1-bc01e2f8aa16
- Site URL: https://www.apple.com/macbook-pro
- ID: 764b6a64-c233-4e0f-b8e1-bc01e2f8aa16
- Theme: dark
- Industry: ecommerce
- Created: 2026-03-25T11:46:13.000Z
- Ranks: newest: 1000, popular: 120, trending: 114
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Pitch Black | #000000 | neutral | Primary background for dark sections, especially hero content and full-bleed product showcases, absorbing light to make products pop. |
...
| Cloud White | #ffffff | neutral | Text color on dark backgrounds, icon fills, and an alternative background for information-dense sections, providing extreme contrast. |
| Ghost White | #f5f5f7 | neutral | Primary background color for light theme sections (e.g. legal text) and subtle contrast surfaces, nearly achromatic for maximum clarity. |
| Cool Gray | #86868b | neutral | Secondary text and placeholder color in dark contexts, providing a softer alternative to White for less prominent information. |
...
| Highlight Blue | #0066cc | accent | Primary interactive element color for links and accent text in both light and dark contexts. This is the main action color. |
| Vivid Blue | #2997ff | accent | Button backgrounds and active state indicators within dark theme, a brighter complement to Highlight Blue. |
| Interactive Blue | #0071e3 | brand | Background for primary call-to-action buttons, offering a strong, clear focal point. |
| Accent Teal | #00a1b3 | brand | Decorative accent for specific feature callouts or secondary branded elements, used sparingly. |
| Neon Violet | #8668ff | brand | Highlight color for special features or iconography, appearing as a vibrant burst. |
| Incandescent Orange | #ed6300 | brand | Secondary accent color for specific product features or promotional highlights. |
| Muted Orange | #b64400 | brand | Subtle accent for badging or less prominent brand highlights. |
| Sky Blue Gradient | #e4f6e0 | brand | Decorative background gradient used for abstract brand imagery or product showcases. |
| Teal-Lime Gradient | #35a98a | brand | Energetic gradient for dynamic visual elements or calls to action. |
| Ocean Spectrum Gradient | #bfebE0 | brand | Complex, deep gradient for hero backgrounds or immersive content sections. |
| Rainbow Burst Gradient | #0090f7 | brand | Vibrant, attention-grabbing gradient for high-impact promotional elements. |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| SF Pro Text | Inter | 300, 400, 600 | 12px, 14px, 17px, 18px, 20px, 24px, 44px | 1.00, 1.18, 1.24, 1.29, 1.33, 1.43, 1.47, 1.50, 1.83, 2.12, 2.41 | Versatile system font for body text, interface elements, and secondary headings. Its clarity and range of weights provide legibility across all contexts, with subtle negative letter-spacing for a refined, compact appearance. |
| SF Pro Display | Inter | 400, 600 | 17px, 19px, 20px, 21px, 24px, 28px, 32px, 40px, 48px, 56px, 64px, 80px | 1.00, 1.05, 1.06, 1.07, 1.08, 1.10, 1.13, 1.14, 1.17, 1.19, 1.21, 1.38, 1.40 | Optimized for larger text, headlines, and display purposes. Its wider apertures and tailored letter-spacing ensure maximum legibility at large sizes, delivering impact and clarity. |
...
| --- | --- | --- | --- |
| caption | 12 | 1.5 | -0.48 |
| body-sm | 14 | 1.43 | -0.31 |
| body | 17 | 1.29 | -0.32 |
| subheading | 20 | 1.25 | -0.2 |
| heading-sm | 24 | 1.17 | -0.14 |
| heading | 44 | 1.05 | -0.13 |
| heading-lg | 56 | 1.07 | -0.73 |
| display | 80 | 1.05 | -0.45 |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1776178115188-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1776178115188-thumb.jpg |
| preview video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/764b6a64-c233-4e0f-b8e1-bc01e2f8aa16-1777568484496-preview.mp4 |
| preview video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/764b6a64-c233-4e0f-b8e1-bc01e2f8aa16-1777568484496-preview-poster.jpg |
| detail video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/764b6a64-c233-4e0f-b8e1-bc01e2f8aa16-1777568484496-preview-detail.mp4 |
| detail video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/764b6a64-c233-4e0f-b8e1-bc01e2f8aa16-1777568484496-preview-detail-poster.jpg |
