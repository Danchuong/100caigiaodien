# Flowmapp — Refero Style

- Refero URL: https://styles.refero.design/style/caca412f-7fc7-4510-aacc-5664d4f8ce9f
- Site URL: https://flowmapp.com
- ID: caca412f-7fc7-4510-aacc-5664d4f8ce9f
- Theme: light
- Industry: design
- Created: 2026-04-10T17:30:15.000Z
- Ranks: newest: 936, popular: 202, trending: 182
...
| --- | --- | --- | --- | --- | --- |
| Inter | Inter | 400, 500, 600, 700 | 10px, 12px, 13px, 14px, 16px, 18px, 24px, 30px, 36px, 48px, 64px, 72px, 84px, 96px, 118px | 1.0 to 1.67 | All text elements: headlines, body copy, navigation, buttons. Its broad range of weights and sizes supports a clear typographic hierarchy, making it versatile for both display and utilitarian text. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775932778486-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775932778486-thumb.jpg |
