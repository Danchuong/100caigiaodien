...
- Refero URL: https://styles.refero.design/style/d4c51049-58eb-404a-9fcb-f195928b1c99
- Site URL: https://warp.dev
- ID: d4c51049-58eb-404a-9fcb-f195928b1c99
- Theme: dark
- Industry: devtools
- Created: 2026-02-10T19:00:00.000Z
- Ranks: newest: 1205, popular: 413, trending: 425
...
| --- | --- | --- | --- | --- | --- |
| Matter | Inter | 400 | 16px | 1.00, 1.20 | Primary typeface for all headings and most body text. The tight line heights and varying letter spacing, especially negative values at larger sizes, create a dense, technical feel appropriate for a dev tool. The range of weights provides a strong hierarchy without introducing additional families. |
| Inter | system-ui | 400, 500 | 14px, 16px | 1.00, 1.20, 1.30, 1.38 | Secondary sans-serif for supplemental information, fine print, and some body text where a slightly more open feel is desired compared to Matter. |
| Geist Mono | SF Mono, Fira Code | 400 | 16px | 1.00 | Monospaced font used for code snippets, technical commands, and precise data representation, reinforcing the developer tool identity. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775923168907-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775923168907-thumb.jpg |
