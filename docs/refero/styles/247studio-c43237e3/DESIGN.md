# 247Studio — Refero Style

- Refero URL: https://styles.refero.design/style/c43237e3-dae2-4fc6-a917-519b25c870e5
- Site URL: https://247studio.co
- ID: c43237e3-dae2-4fc6-a917-519b25c870e5
- Theme: light
- Industry: agency
- Created: 2026-01-29T13:12:56.000Z
- Ranks: newest: 1258, popular: 280, trending: 281
...
| --- | --- | --- | --- | --- | --- |
| 247 grotesk | Inter | 400, 500 | 10px, 11px, 14px, 16px, 19px, 21px, 28px, 31px, 35px, 48px, 52px, 55px, 73px | 1.00, 1.14, 1.20, 1.25, 1.30, 1.89 | The primary workhorse for all UI elements, headlines, body text, and interactive components. Its prominent usage across all visual hierarchy levels, especially for large, tight headlines, defines the modern, direct tone. |
| Ntbau | Roboto Mono | 400, 500, 700 | 10px, 11px, 12px, 14px, 18px | 1.00, 1.14, 1.20, 1.30 | Used for specific body text and links, its presence with a consistent positive letter-spacing suggests a subtle, technically precise contrast against the often tightly-spaced 247 grotesk. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775925458344-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775925458344-thumb.jpg |
