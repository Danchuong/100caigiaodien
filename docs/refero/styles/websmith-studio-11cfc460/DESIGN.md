# Websmith Studio — Refero Style

- Refero URL: https://styles.refero.design/style/11cfc460-807b-42c5-b10a-7b042c60f3e8
- Site URL: https://websmith.studio
- ID: 11cfc460-807b-42c5-b10a-7b042c60f3e8
- Theme: light
- Industry: agency
- Created: 2026-04-30T02:57:10.434Z
- Ranks: newest: 262, popular: 700, trending: 458
...
| --- | --- | --- | --- | --- | --- |
| -apple-system | system-ui, sans-serif | 400, 500, 600, 700 | 14px, 16px, 20px, 30px, 48px, 88px, 96px | 1.00, 1.20, 1.40, 1.43, 1.50 | All text elements, from large display headlines to body copy and navigation. The consistent use of a system font at a wide range of sizes and precise negative letter-spacing for larger text creates a sense of modern efficiency and clarity. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777517806765-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777517806765-thumb.jpg |
