...
- Refero URL: https://styles.refero.design/style/41547c7a-3bbe-49f0-95d6-9701c9df9a5e
- Site URL: https://tella.tv
- ID: 41547c7a-3bbe-49f0-95d6-9701c9df9a5e
- Theme: mixed
- Industry: saas
- Created: 2026-03-19T16:34:14.000Z
- Ranks: newest: 1025, popular: 124, trending: 393
...
| --- | --- | --- | --- | --- | --- |
| NaN Jaune Midi Bold | Cabinet Grotesk ExtraBold or Clash Display Bold | 700 | 56px, 64px, 84px | 1.10–1.20 | Hero and section display headlines exclusively. The custom font's chunky stroke contrast and tight tracking at display sizes creates broadcast-title energy — unmistakable at a glance, nothing Inter could replicate. The aggressive negative tracking (-0.054em at 56px) squeezes letters into a dense typographic block that reads as a single graphic unit. |
| Inter | Inter (freely available via Google Fonts) | 500, 600, 700 | 12px, 14px, 16px, 18px, 20px, 24px, 28px, 30px | 1.00–1.95 | All UI text: navigation, body copy, subheadings, card titles, buttons, captions. Weight 700 at 24-30px for section subheadings; weight 600 at 18-20px for card headers; weight 500 at 14-16px for body and UI labels. The utilitarian pairing with NaN Jaune Midi is intentional — Inter stays invisible so the display font commands full attention. |
| sans-serif | System sans-serif | 400 | 12px | 1.50 | System fallback at 12px for fine-print labels and browser-rendered micro text. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775935399351-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775935399351-thumb.jpg |
| preview video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/41547c7a-3bbe-49f0-95d6-9701c9df9a5e-1777559472412-preview.mp4 |
| preview video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/41547c7a-3bbe-49f0-95d6-9701c9df9a5e-1777559472412-preview-poster.jpg |
| detail video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/41547c7a-3bbe-49f0-95d6-9701c9df9a5e-1777559472412-preview-detail.mp4 |
| detail video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/41547c7a-3bbe-49f0-95d6-9701c9df9a5e-1777559472412-preview-detail-poster.jpg |
