# AI Product Generation — Refero Style

- Refero URL: https://styles.refero.design/style/186775da-7568-49e5-8110-4fd0bbc7bbe3
- Site URL: https://fourmula.ai
- ID: 186775da-7568-49e5-8110-4fd0bbc7bbe3
- Theme: light
- Industry: ai
- Created: 2026-04-30T00:15:10.683Z
- Ranks: newest: 856, popular: 602, trending: 399
...
| --- | --- | --- | --- | --- | --- |
| SF Pro Display | system-ui | 400, 500 | 8px, 10px, 11px, 12px, 13px, 14px, 15px, 17px, 20px, 27px, 43px, 53px, 73px, 100px | 0.94, 1.00, 1.05, 1.15, 1.20, 1.25, 1.50 | Primary typeface for all headings, body text, and interactive elements. Its wide range of weights and negative letter-spacing at large sizes creates a distinct modern, precise, and compact feel. |
| Arial | Helvetica Neue | 400 | 14px | 1.39 | Fallback or secondary font for specific UI elements, ensuring broad compatibility and clear readability where SF Pro Display may not be available or suitable. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777508074185-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777508074185-thumb.jpg |
