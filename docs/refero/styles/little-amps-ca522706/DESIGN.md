# Little Amps — Refero Style

- Refero URL: https://styles.refero.design/style/ca522706-03ed-48cb-acb3-1bb2a22f2eda
- Site URL: https://littleampscoffee.com
- ID: ca522706-03ed-48cb-acb3-1bb2a22f2eda
- Theme: light
- Industry: ecommerce
- Created: 2026-04-30T00:13:29.997Z
- Ranks: newest: 865, popular: 746, trending: 595
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Cream Canvas | #fff9f2 | neutral | Page backgrounds, card surfaces, button text in darker states — sets a warm, inviting canvas |
| Warm Beige | #f6ede3 | neutral | Secondary card backgrounds, section dividers, subtle background distinction |
| Smoky Ash | #e6dad4 | neutral | Hairline borders, subtle separators and decorative lines |
| Muted Taupe | #977e77 | neutral | Muted text, secondary link states where lower contrast is desired |
| Fawn Gray | #cbbbb4 | neutral | Subtle card backgrounds, low-prominence surface elements |
| Vinyl Brown | #522c25 | brand | Primary text, form input text, base border color, strong contrast against lighter backgrounds — evokes coffee and warm wood |
| Roast Red | #c03001 | brand | Primary action background, prominent accent color for links, highlight elements — adds a punchy, warm accent |
| Mellow Ochre | #c46500 | brand | Accent for certain buttons, secondary interactive states |
| Community Blue | #89b4ca | brand | Accent buttons, specific interactive elements — a soft, cool counterpoint to the warm browns |
| Sunbeam Yellow | #febf6f | brand | Accent buttons, highlights for specific content blocks or links |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Inclusive Sans | Open Sans | 400 | 12px, 13px, 14px, 15px, 16px | 1.00, 1.10, 1.20, 1.60 | Versatile body text and general interface elements, offering a readable yet distinct character through its slightly wider tracking. |
| Necto Mono | Space Mono | 400, 500 | 10px, 12px, 13px, 14px, 16px | 0.80, 0.85, 1.00, 1.10, 1.20 | Used for smaller text, labels, and secondary information, infusing a retro, structured feel due to its monospace nature. |
| Little Amps | League Spartan | 500 | 20px, 22px, 41px, 45px, 50px, 51px | 0.80, 1.00 | Signature display font for headings and brand messaging, its tight kerning and unique character define the brand's playful, vintage-inspired voice. |
| Roboto Mono |  | 400 | 14px, 16px | 1.1 | Roboto Mono — detected in extracted data but not described by AI |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777507977252-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777507977252-thumb.jpg |
