# OpenAI Developers — Refero Style

- Refero URL: https://styles.refero.design/style/5c94c49f-0612-4261-842c-e1d501f3e13d
- Site URL: https://developers.openai.com
- ID: 5c94c49f-0612-4261-842c-e1d501f3e13d
- Theme: light
- Industry: ai
- Created: 2026-04-28T19:33:25.323Z
- Ranks: newest: 902, popular: 444, trending: 280
...
| --- | --- | --- | --- | --- | --- |
| OpenAI Sans | Inter | 400, 500, 600 | 12px, 14px, 16px, 18px, 20px, 30px | 1.00, 1.30, 1.33, 1.38, 1.40, 1.43, 1.50, 1.63, 1.75 | Primary brand typeface. Weight 600 is used for prominent headings, establishing a clear yet understated hierarchy. Weight 500 for subheadings and important text, maintaining a crisp presence. Weight 400 is the default for body text and navigation, ensuring high readability over extended passages. The precise, tighter letter-spacing especially at larger sizes contributes to the technical and modern feel. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777404777849-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777404777849-thumb.jpg |
