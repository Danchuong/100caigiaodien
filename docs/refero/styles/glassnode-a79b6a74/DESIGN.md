# Glassnode — Refero Style

- Refero URL: https://styles.refero.design/style/a79b6a74-6b67-4c9f-9d69-bff80869b943
- Site URL: https://glassnode.com
- ID: a79b6a74-6b67-4c9f-9d69-bff80869b943
- Theme: mixed
- Industry: crypto
- Created: 2026-04-13T09:26:44.000Z
- Ranks: newest: 924, popular: 312, trending: 335
...
| --- | --- | --- | --- | --- | --- |
| Inter | system-ui, sans-serif | 400, 500, 700 | 12px, 14px, 16px, 20px, 24px, 32px | 1.00, 1.20, 1.30, 1.40, 1.50 | Primary text font system-wide. Used for body copy, navigation, buttons, and most informational text. The variety of weights and sizes allows for a clear hierarchy within content sections. |
| Fraktion | Inter, system-ui, sans-serif | 700 | 56px | 1.20 | Exclusive display typeface for hero headings. Its distinct bold character conveys gravitas and establishes the brand's key message with authority. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775933459599-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775933459599-thumb.jpg |
