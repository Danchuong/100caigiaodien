...
- Refero URL: https://styles.refero.design/style/b5ca4e9a-2322-4796-b4c5-3b3bf194821f
- Site URL: https://clay.com
- ID: b5ca4e9a-2322-4796-b4c5-3b3bf194821f
- Theme: light
- Industry: saas
- Created: 2026-02-04T19:10:23.000Z
- Ranks: newest: 1234, popular: 92, trending: 72
...
| --- | --- | --- | --- | --- | --- |
| Roobert | Arial | 400, 500, 600, 700 | 10px, 11px, 12px, 13px, 14px, 15px, 16px, 18px, 20px, 32px, 44px, 60px, 80px | 1.00, 1.10, 1.20, 1.40, 1.50, 1.60 | The primary typeface for all text elements. Its geometric yet friendly character defines the brand's voice, using varying weights and precise letter-spacing to articulate hierarchy and emphasis. |
| Phosphor | system-ui | 400 | 13px, 16px, 20px | 1.00 | Used for specific functional elements or icons, providing a clear, unadorned visual style where ligatures might enhance clarity without decorative flourish. |
| Phosphor-Bold | system-ui | 400 | 16px | 1.00 | A bolder variant of Phosphor, used sparingly for emphasis within functional text or specific icons. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775922832628-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775922832628-thumb.jpg |
