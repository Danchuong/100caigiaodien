# customer.io — Refero Style

- Refero URL: https://styles.refero.design/style/abbaa70a-5fe2-44a9-9c5f-272e68c450c3
- Site URL: https://customer.io
- ID: abbaa70a-5fe2-44a9-9c5f-272e68c450c3
- Theme: light
- Industry: saas
- Created: 2026-04-30T00:54:10.020Z
- Ranks: newest: 668, popular: 56, trending: 30
...
| --- | --- | --- | --- | --- | --- |
| saansFont | Inter | 475, 500, 600, 700 | 12px, 14px, 16px, 18px, 20px, 24px, 30px, 36px, 40px, 48px, 96px | 1.00, 1.25, 1.38 | The primary typeface for all content. Its precise letter-spacing and varied weights allow for clear hierarchy and detail, from headings to small functional text. The custom font contributes to a sharp, modern feel, prioritizing readability at all scales. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777510412953-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777510412953-thumb.jpg |
