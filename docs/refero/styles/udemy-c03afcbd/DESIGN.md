...
- Refero URL: https://styles.refero.design/style/c03afcbd-96ed-4b7f-8d0a-277fc0042ba7
- Site URL: https://www.udemy.com
- ID: c03afcbd-96ed-4b7f-8d0a-277fc0042ba7
- Theme: light
- Industry: other
- Created: 2026-04-30T00:59:57.153Z
- Ranks: newest: 646, popular: 576, trending: 404
...
| --- | --- | --- | --- | --- | --- |
| Udemy Sans | system-ui | 300, 400, 500, 700 | 12px, 14px, 16px, 18px, 24px, 32px | 1.10, 1.20, 1.40, 1.50, 1.60 | The primary typeface for all text content, from headings to body text. Its subtle variations in weight and size provide clear hierarchy while maintaining a consistent brand voice. Weights 300 (light) and 400 (regular) are commonly used for body copy and UI elements, while 500 (medium) and 700 (bold) are reserved for headings and emphasized text. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777510765286-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777510765286-thumb.jpg |
