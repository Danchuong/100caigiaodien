# Locomotive — Refero Style

- Refero URL: https://styles.refero.design/style/131d07b0-f71b-4bd2-8046-f61485ed545c
- Site URL: https://locomotive.ca
- ID: 131d07b0-f71b-4bd2-8046-f61485ed545c
- Theme: light
- Industry: agency
- Created: 2026-02-11T11:03:20.000Z
- Ranks: newest: 1201, popular: 594, trending: 731
...
| --- | --- | --- | --- | --- | --- |
| HelveticaNowDisplay | system-ui | 400 | 15px, 26px | 1.00, 1.20, 1.30 | Body copy (15px), general links, navigation items, descriptive text, and some smaller headings. Its neutrality provides a stable foundation for the more expressive LocomotiveNew. |
| LocomotiveNew | Georgia | 400 | 70px, 110px | 1.00, 1.10 | Display headings (70px, 110px). This custom serif font adds a distinctive editorial and somewhat artistic touch, providing gravitas and a unique brand voice at larger sizes, breaking from the HelveticaNowDisplay's modernism. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775925109290-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775925109290-thumb.jpg |
