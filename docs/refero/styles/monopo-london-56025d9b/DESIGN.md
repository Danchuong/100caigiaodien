# monopo london — Refero Style

- Refero URL: https://styles.refero.design/style/56025d9b-3793-4303-b437-440440045d4c
- Site URL: https://monopo.london
- ID: 56025d9b-3793-4303-b437-440440045d4c
- Theme: dark
- Industry: design
- Created: 2026-04-30T03:06:23.214Z
- Ranks: newest: 229, popular: 74, trending: 45
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Midnight Canvas | #000000 | neutral | Page backgrounds, card surfaces, dominant dark areas |
...
| Subtle Gray | #7f7f7f | neutral | Muted secondary text, inactive link borders, subtle decorative details |
| Medium Gray | #666970 | neutral | Dark borders and separators for elevated surfaces and inverted UI. |
| Nebula Gradient | #cd5a07 | neutral | Immersive full-bleed background for hero sections and abstract visual elements. This gradient sets the mood and provides visual interest for large areas |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Roobert | system-ui, sans-serif or Space Grotesk | 300, 400, 700, 800 | 12px, 14px, 16px, 17px, 22px, 33px, 45px | 1.00, 1.09, 1.15, 1.16, 1.20, 1.23, 1.44 | The primary typeface for all text. Its compact, almost monospaced feel with consistent letter-spacing across weights contributes to the editorial, high-tech brand identity. Light weights (300, 400) are used for body text and navigation, while heavier weights (700, 800) bring punch to headlines and callouts. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777518359518-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777518359518-thumb.jpg |
