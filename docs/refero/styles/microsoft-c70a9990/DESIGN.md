# Microsoft — Refero Style

- Refero URL: https://styles.refero.design/style/c70a9990-bc4b-4a64-a69b-aeb7b344fb74
- Site URL: https://www.microsoft.com
- ID: c70a9990-bc4b-4a64-a69b-aeb7b344fb74
- Theme: light
- Industry: other
- Created: 2026-04-29T00:44:50.581Z
- Ranks: newest: 888, popular: 1322, trending: 1321
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Ocean Blue | #0067b8 | brand | Primary action buttons, interactive link highlights, brand accents in navigation and icons — provides a consistent chromatic touchpoint for interactivity and brand recognition. |
| Charcoal Black | #000000 | neutral | Primary text across headings, body content, and navigation elements; outlines for cards and other structural components. |
| Graphite Gray | #616161 | neutral | Secondary text for less prominent information, footer navigation links, and subtle icon details. |
| Cloud White | #ffffff | neutral | Page background, card surfaces, and text on contrasting colored buttons. |
| Fog Gray | #f2f2f2 | neutral | Subtle background for page sections and the primary canvas, providing a gentle off-white base. |
| Dark Slate | #262626 | neutral | Tertiary text for certain UI elements and subtle borders. |
| Deep Ash | #171717 | neutral | Text for specific list items and button text at lower prominence. |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Segoe UI | Arial | 400, 600 | 11px, 13px, 14px, 15px, 16px, 29px, 37px | 1.00, 1.20, 1.33, 1.45, 1.50, 2.27 | The primary typeface for all text content, from body and navigation to headings. Its system-standard clarity ensures broad accessibility and a consistent, professional tone across all content weights. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777423470635-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777423470635-thumb.jpg |
