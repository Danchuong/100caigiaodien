# Awwwards — Refero Style

- Refero URL: https://styles.refero.design/style/a77a7289-3438-46ba-8194-214739e47514
- Site URL: https://awwwards.com
- ID: a77a7289-3438-46ba-8194-214739e47514
- Theme: light
- Industry: design
- Created: 2026-02-08T16:20:48.000Z
- Ranks: newest: 1217, popular: 539, trending: 1226
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Midnight Graphite | #222222 | neutral | Primary text, headings, prominent icons, button text on light backgrounds. Establishes a bold and clear visual hierarchy against the light neutrals. |
| Arctic White | #ffffff | neutral | Page backgrounds, card backgrounds, button text on dark backgrounds. Provides expansive clean canvases and high contrast. |
| Pale Ash | #e9e9e9 | neutral | Secondary backgrounds for soft elevation and subtle button states. Creates faint visual differentiation without strong color shifts. |
| Deep Pewter | #808080 | neutral | Table borders and dividers. A darker neutral for structural elements. |
| Silver Mist | #dedede | neutral | Subtle borders, inactive elements, supporting icon fills. Provides a light touch of separation and detail. |
| Sunset Orange | #fa5d29 | accent | Link highlights, occasional accent text. A vivid, warm pop against the dominant neutrals for interactive elements or rare emphasis. |
| Lemon Zest | #fff083 | accent | Highlighting badges, occasional alert backgrounds. A secondary vivid accent for less critical attention. |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Inter Tight | Inter | 300, 400, 500, 600 | 10px, 11px, 12px, 13px, 14px, 15px, 16px, 18px, 19px, 21px, 22px, 24px, 32px, 42px, 127px | 0.93, 1.00, 1.10, 1.17, 1.20, 1.27, 1.29, 1.36, 1.44, 1.45, 1.50, 1.70, 1.75, 1.87, 2.00, 2.15, 2.40, 3.00 | The sole typeface for all content. Its narrow metrics and precise line heights from 0.93 to 3.00 create a distinctive, information-dense, modern aesthetic across all scales, from micro-text to impactful display headlines where 127px at 0.93 line height creates a commanding visual block. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775923986587-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775923986587-thumb.jpg |
