# Spazio Maiocchi — Refero Style

- Refero URL: https://styles.refero.design/style/fc0a9d9e-558b-452a-970c-a9f4080211b4
- Site URL: https://afterimage.spaziomaiocchi.com
- ID: fc0a9d9e-558b-452a-970c-a9f4080211b4
- Theme: dark
- Industry: media
- Created: 2026-04-30T02:42:11.435Z
- Ranks: newest: 314, popular: 1223, trending: 1186
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Pitch Black | #000000 | neutral | Page background, primary text on light surfaces, borders in specific UI states |
...
| Smoke Gray | #b3b3b3 | neutral | Medium-contrast borders, control outlines, and structural separators. Do not promote it to the primary CTA color |
| Muted Carbon | #313131 | neutral | Dark elevated surface for cards, headers, and contained panels. Do not promote it to the primary CTA color |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Antique Legacy | Space Mono | 500 | 18px, 69px | 0.80, 1.11 | All textual content, from navigation to headings. This custom typeface defines the brand's unique, condensed, and impactful typographic voice. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777516914765-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777516914765-thumb.jpg |
