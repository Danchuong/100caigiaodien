# Apollographql — Refero Style

- Refero URL: https://styles.refero.design/style/65b30976-3663-40b2-8751-7a360ba74539
- Site URL: https://apollographql.com
- ID: 65b30976-3663-40b2-8751-7a360ba74539
- Theme: mixed
- Industry: devtools
- Created: 2026-02-23T18:29:38.000Z
- Ranks: newest: 1142, popular: 587, trending: 1170
...
| --- | --- | --- | --- | --- | --- |
| Inter | Inter | 400 | 12px, 14px, 16px, 20px, 24px, 30px, 38px, 50px | 0.94, 1.00, 1.10, 1.25, 1.30, 1.33, 1.40, 1.43, 1.50 | The primary typeface for all textual content, from body to display headings. Its wide range of weights and sizes supports a clear content hierarchy, maintaining a contemporary and readable aesthetic across the interface. |
| Fira Code | Fira Code | 500 | 18px | 1.25 | Used specifically for code snippets or technical annotations. Its monospace nature and distinct letter spacing clearly differentiates technical content from standard prose, reinforcing the developer-focused nature of the product. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775932255790-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775932255790-thumb.jpg |
