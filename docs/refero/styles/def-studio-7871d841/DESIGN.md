# def.studio — Refero Style

- Refero URL: https://styles.refero.design/style/7871d841-6703-4193-8119-36bb12c73983
- Site URL: https://def.studio
- ID: 7871d841-6703-4193-8119-36bb12c73983
- Theme: dark
- Industry: design
- Created: 2026-04-30T03:23:55.274Z
- Ranks: newest: 165, popular: 921, trending: 874
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Deep Midnight | #000000 | neutral | Primary page background, unifies the visual field |
| Charcoal Canvas | #1c1c1d | neutral | Secondary background, subtly distinguishes content sections or cards from the main canvas |
| Frost White | #ffffff | neutral | Hairline borders, dividers, input outlines, and card edges on light surfaces. Do not promote it to the primary CTA color |
| Smoked Glass | #efefef | neutral | Subtle borders, ghost button outlines, and supporting text that needs to recede slightly from primary text |
| Steel Gray | #747474 | neutral | Secondary text, metadata, and less prominent descriptive elements |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Synthese | Inter | 300, 400 | 16px, 19px, 96px | 1.20 | Custom font used for all text; its clean, modern lines and light weights contribute to the system's understated yet authoritative feel. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777519419301-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777519419301-thumb.jpg |
