...
- Refero URL: https://styles.refero.design/style/9d16aa65-cef7-4bf7-83c8-91837a248cd9
- Site URL: https://public.com
- ID: 9d16aa65-cef7-4bf7-83c8-91837a248cd9
- Theme: light
- Industry: fintech
- Created: 2026-04-30T00:30:47.624Z
- Ranks: newest: 776, popular: 199, trending: 132
...
| --- | --- | --- | --- | --- | --- |
| Denton | Playfair Display | 300 | 48px, 52px, 80px | 1.00, 1.11, 1.12, 1.13 | Display and primary headings – its light weight at large sizes conveys authority through understatement, setting an intellectual tone. |
| Invest Pro | IBM Plex Serif | 400, 500 | 12px, 14px, 16px, 20px, 24px, 32px | 1.00, 1.13, 1.14, 1.15, 1.17, 1.20, 1.28, 1.29, 1.31, 1.37, 1.38, 1.50 | Secondary headings, subheadings, and emphasized text segments – providing a structured, confident contrast to Inter for key informational blocks. |
| Invest Pro | IBM Plex Serif | 400, 500 | 12px, 14px, 16px, 20px, 24px, 32px | 1.00, 1.13, 1.14, 1.15, 1.17, 1.20, 1.28, 1.29, 1.31, 1.37, 1.38, 1.50 | More emphatic secondary headings and callouts, providing a slightly bolder touch while retaining the core character of Invest Pro. |
| Inter | Inter | 400, 600 | 10px, 11px, 12px, 14px, 16px | 1.00, 1.15, 1.42, 1.43, 1.50, 1.54, 1.60, 2.00 | Body copy, navigation, and detailed information – its neutral, legible form supports dense data and long-form content. |
| Inter | Inter | 400, 600 | 10px, 11px, 12px, 14px, 16px | 1.00, 1.15, 1.42, 1.43, 1.50, 1.54, 1.60, 2.00 | Strong emphasis within body text, labels, and small headings, maintaining high readability at smaller sizes. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777509016634-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777509016634-thumb.jpg |
