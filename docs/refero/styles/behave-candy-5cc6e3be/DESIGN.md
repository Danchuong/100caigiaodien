# BEHAVE Candy — Refero Style

- Refero URL: https://styles.refero.design/style/5cc6e3be-1cbd-4d09-9958-9cb82b2487db
- Site URL: https://www.eatbehave.com
- ID: 5cc6e3be-1cbd-4d09-9958-9cb82b2487db
- Theme: light
- Industry: ecommerce
- Created: 2026-04-30T03:41:01.842Z
- Ranks: newest: 96, popular: 639, trending: 480
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Ultraviolet | #061fff | brand | Primary interactive elements, brand accents, strong borders, key headlines, icon fills, informational text. Its depth makes it commanding and playful |
| Key Lime | #d3ff56 | brand | Primary CTA backgrounds, highlights, active states. This highly saturated green provides a jolt of energy, contrasting sharply with the Ultraviolet |
| Lilac Mist | #efe5ff | neutral | Page backgrounds, card surfaces – a very pale, near-neutral lilac that provides a soft canvas for the brighter brand colors |
| Soft Plum | #ceb3ff | neutral | Secondary card backgrounds, subtle tonal variation in elevated areas |
| Lavender Haze | #dfceff | neutral | Input field backgrounds. A slightly deeper, muted violet than Lilac Mist, offering a gentle differentiation for form elements |
| Pure White | #ffffff | neutral | Content backgrounds, high-contrast text against dark backgrounds, essential borders that frame content without adding color |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Good Sans | Montserrat | 400, 500, 700 | 12px, 14px, 16px, 18px, 22px, 24px, 32px, 53px, 56px, 72px, 86px | 1.00, 1.10, 1.15, 1.20, 1.30, 1.50, 1.51, 2.14, 2.50 | All textual content including headings, body text, navigation, and input fields. Its custom nature provides a unique, friendly yet bold voice, ensuring brand consistency across all type. |
...
| body-sm | 14 | 1.5 | -0.21 |
| body | 16 | 1.5 | -0.24 |
| subheading | 18 | 1.3 | -0.27 |
| heading-sm | 22 | 1.2 | -0.33 |
| heading | 32 | 1.15 | -0.48 |
| heading-lg | 53 | 1.1 | -0.795 |
| display | 86 | 1 | -1.29 |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777520440476-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777520440476-thumb.jpg |
