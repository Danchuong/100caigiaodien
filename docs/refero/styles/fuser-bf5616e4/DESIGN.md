...
- Refero URL: https://styles.refero.design/style/bf5616e4-7bd1-40ce-8b2d-aae84c2e4ebd
- Site URL: https://fuser.studio
- ID: bf5616e4-7bd1-40ce-8b2d-aae84c2e4ebd
- Theme: light
- Industry: ai
- Created: 2026-04-30T00:25:21.436Z
- Ranks: newest: 806, popular: 283, trending: 174
...
| --- | --- | --- | --- | --- | --- |
| Inter Variable | Inter | 300, 400, 500, 600 | 10px, 12px, 13px, 14px, 16px, 18px, 24px, 30px, 36px | 0.80, 1.00, 1.10, 1.20, 1.25, 1.33, 1.40, 1.43, 1.50, 1.56, 1.71 | Body copy, UI labels, navigation, and functional text – Inter provides legibility and a modern, slightly technical feel across its variable weights. |
| Marund | Playfair Display | 400, 450, 500, 600 | 14px, 16px, 17px, 18px, 20px, 22px, 24px, 30px, 48px, 96px | 1.00, 1.10, 1.40, 1.43, 1.50 | Headlines and prominent display text – a custom serif that grounds the interface with distinctiveness and a subtle, sophisticated tone. Its unique stylistic sets ('ss00', 'ss03') contribute significantly to branding. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777508672360-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777508672360-thumb.jpg |
