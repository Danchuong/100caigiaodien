# My Brentano — Refero Style

- Refero URL: https://styles.refero.design/style/d211aaa4-e09b-4ef9-a9bf-f6fa8495de73
- Site URL: https://mybrentano.ch
- ID: d211aaa4-e09b-4ef9-a9bf-f6fa8495de73
- Theme: light
- Industry: ecommerce
- Created: 2026-04-30T02:12:18.705Z
- Ranks: newest: 420, popular: 1195, trending: 1200
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Canvas White | #ffffff | neutral | Page backgrounds, card surfaces, button fills, input backgrounds |
| Ink Black | #000000 | neutral | Primary text, link borders, button borders, navigation borders, input borders – providing crisp definition against light surfaces |
| Charcoal Text | #212529 | neutral | Body text, heading text, list text, primary site borders – a slightly softer alternative to pure black for extensive text blocks and structural outlines |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Studio Feixen Sans Writer Book | Inter | 400 | 12px, 15px, 18px, 25px, 30px, 60px | 1.20, 1.67, 2.08, 2.50 | Primary typeface for all body text, headings, links, and buttons. Its 'Writer Book' style denotes a commitment to legibility and a slightly editorial, handcrafted feel that distinguishes it from standard sans-serifs. |
| Studio Feixen Sans Writer Book | Inter | 700 | 12px, 15px, 18px, 25px, 30px, 60px | 1.20, 1.67, 2.08, 2.50 | Used for emphasized text and headings, maintaining the same clean aesthetic as the regular weight while adding clarity. |
| Studio Feixen Sans Book | Inter | 400 | 15px, 30px | 1.20 | A lighter-touch variant of the primary typeface, used sparingly for specific body elements and input text to provide subtle visual differentiation. |
| Studio Feixen Sans Writer Book Regular |  | 400 | 30px | 1.2 | Studio Feixen Sans Writer Book Regular — detected in extracted data but not described by AI |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777515108907-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777515108907-thumb.jpg |
