# BUTT STUDIO — Refero Style

- Refero URL: https://styles.refero.design/style/c6e55968-fa2d-47c9-b833-2c4ad1e74906
- Site URL: https://www.butt-studio.com
- ID: c6e55968-fa2d-47c9-b833-2c4ad1e74906
- Theme: light
- Industry: design
- Created: 2026-04-30T03:29:10.166Z
- Ranks: newest: 141, popular: 1046, trending: 1042
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Canvas White | #ffffff | neutral | Primary page background, clear surfaces |
| Pitch Black | #000000 | neutral | Primary text, borders, decorative elements — creates strong contrast against light surfaces |
| Deep Space | #131313 | neutral | Dark UI elements backgrounds, content blocks like video players |
| Smoke Gray | #e0e0e0 | neutral | Subtle background for button fills and secondary surface differentiation |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| helvetica | Avenir Next, Arial | 400 | 20px, 40px | 1.00, 1.20 | Body text, navigation links, secondary headings, and button labels. Its neutrality provides a stable baseline against more expressive elements. |
| Caslon | Libre Caslon Display | 400 | 42px | 1.00 | Primary headings and artistic display text. The elegant serif creates a sophisticated, editorial feel. |
| Sometimes Times | Times New Roman (with custom stylistic sets) | 400 | 20px | 1.20 | Specific display text for project titles or highlighted content. Its unique character adds brand personality. |
| helvetica | Avenir Next, Arial | 400 | 20px, 40px | 1.00, 1.20 | Body copy on project descriptions, client lists, and features. Ensures readability in informative sections. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777519736324-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777519736324-thumb.jpg |
