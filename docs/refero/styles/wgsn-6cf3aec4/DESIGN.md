...
- Refero URL: https://styles.refero.design/style/6cf3aec4-d028-44b0-b634-cc93e6c08e3c
- Site URL: https://www.wgsn.com/en
- ID: 6cf3aec4-d028-44b0-b634-cc93e6c08e3c
- Theme: light
- Industry: other
- Created: 2026-04-30T02:23:48.481Z
- Ranks: newest: 381, popular: 1229, trending: 1236
...
| --- | --- | --- | --- | --- | --- |
| DM Sans | system-ui | 400, 500, 600, 700 | 12px, 13px, 14px, 16px, 17px, 18px, 20px, 24px, 28px, 32px, 36px, 40px, 48px, 92px | 0.79, 1.10, 1.17, 1.18, 1.20, 1.33, 1.50, 1.60, 1.90 | The sole typeface, used across all elements from headlines to body text. Its clean, geometric sans-serif nature underpins the system's precise and direct communication style. Varied letter-spacing tightens tracking for larger display text and loosens it slightly for smaller body text, enhancing legibility at different scales. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777515803908-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777515803908-thumb.jpg |
