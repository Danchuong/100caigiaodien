# Holiday 100 — Refero Style

- Refero URL: https://styles.refero.design/style/48fa5bef-d910-40e1-b9b0-c0fcad055c6f
- Site URL: https://shopping.google.com/m/bestthings
- ID: 48fa5bef-d910-40e1-b9b0-c0fcad055c6f
- Theme: dark
- Industry: ecommerce
- Created: 2026-04-30T03:56:15.894Z
- Ranks: newest: 24, popular: 864, trending: 718
...
| --- | --- | --- | --- | --- | --- |
| Crimson Pro |  serif | 200, 400 | 48px, 80px, 220px | 0.91, 1.00 | Primary display and hero headlines. The very light weight (200) for large sizes creates an elegant, almost whispered presence, demanding attention through its unexpected delicacy rather than bold assertion. |
| Google Sans |  system-ui | 200, 400, 500 | 14px, 16px, 24px, 30px | 1.00, 1.14, 1.20, 1.25, 1.43, 1.50, 1.71 | Headings, subheadings, and UI elements. Its clean, slightly humanist form provides clarity and a modern, friendly feel, while consistent tight letter-spacing in larger sizes keeps text compact and impactful. |
| Arial |  system-ui | 400, 700 | 14px | 1.20, 1.43 | Body text and less prominent information like button labels and captions. Its ubiquity ensures high legibility and a neutral, functional bedrock for content. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777521345955-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777521345955-thumb.jpg |
