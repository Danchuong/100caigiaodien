# Hume AI — Refero Style

- Refero URL: https://styles.refero.design/style/2e67105f-9f9a-45b5-9281-29734e753bd6
- Site URL: https://hume.ai
- ID: 2e67105f-9f9a-45b5-9281-29734e753bd6
- Theme: light
- Industry: ai
- Created: 2026-03-21T17:22:36.000Z
- Ranks: newest: 1012, popular: 272, trending: 273
...
| --- | --- | --- | --- | --- | --- |
| Fellix | system-ui, sans-serif | 400, 520 | 12px, 14px, 16px, 18px, 20px, 24px, 30px, 36px, 48px | 1.00, 1.11, 1.20, 1.25, 1.33, 1.43, 1.50, 1.56, 1.63 | Primary typeface for all headings, body text, and UI elements. Its slightly humanist touch makes technical content accessible. Letter spacing of -0.025em (approx -0.6px at 24px) contributes to a tighter, more deliberate aesthetic for headings. |
| PP Fraktion Mono | monospace | 400 | 10px, 12px, 14px | 1.33, 1.43, 1.50 | Secondary typeface for code snippets, data labels, and certain UI elements requiring a precise, technical feel. Its monospaced nature and slight positive letter-spacing (0.025em, approx 0.3px at 12px) clearly distinguishes factual, quantitative content. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775932573314-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775932573314-thumb.jpg |
