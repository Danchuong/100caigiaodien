# Daniela and Moe Wedding 2019 — Refero Style

- Refero URL: https://styles.refero.design/style/0f1b3cd0-de5a-4418-8711-0e1afe04707c
- Site URL: https://danielaandmoe.com
- ID: 0f1b3cd0-de5a-4418-8711-0e1afe04707c
- Theme: light
- Industry: other
- Created: 2026-04-30T03:05:43.510Z
- Ranks: newest: 232, popular: 926, trending: 744
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Canvas Petal | #fef1ec | neutral | Page background, primary surface for sections |
| Paper White | #ffffff | neutral | Card backgrounds, input fields, navigation hover states |
| Midnight Ink | #11223f | neutral | Primary text, headings, input text, borders, navigation links |
| Sunset Blush | #ff5734 | brand | Primary action button background, accented headings, link accents, decorative elements — a warm, vivid contrast to the muted palette |
| Mossy Green | #7e813c | accent | Decorative illustration fill and stroke |
| Deep Forest | #193c35 | accent | Decorative illustration fill and stroke |
| Coral Haze | #f6bba4 | accent | Decorative illustration fill and stroke |
| Dusty Sage | #c6d7d0 | accent | Decorative illustration stroke and fill |
| Azure Whisper | #092a49 | accent | Decorative illustration stroke |
| Sunbeam Gold | #e5ba2b | accent | Decorative illustration fill and stroke |
| Crimson Bloom | #ec4f22 | accent | Decorative illustration fill and stroke |
| Dark Fern | #003322 | accent | Decorative illustration fill |
| Shadow | #000000 | neutral | Decorative illustration fill, icons |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Canela Web | serif | 100, 400, 500 | 24px, 28px, 32px, 48px, 120px | 0.85, 1.00, 1.20, 1.30, 1.40, 1.60, 2.00 | Primary headings and display text, lending a refined, editorial feel. The range of weights and ample line-height for larger sizes allows for expressive yet legible headlines. |
| calibre | sans-serif | 300, 400, 500 | 12px, 16px, 20px, 24px, 36px, 48px | 1.20, 1.40, 1.60, 2.00 | Body text, links, smaller headings, navigation items, and button text. Its subtle letter-spacing provides an open, airy feel, enhancing readability for longer passages. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777518320607-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777518320607-thumb.jpg |
