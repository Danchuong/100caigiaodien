...
- Refero URL: https://styles.refero.design/style/ac14ea36-ea3e-4a25-bd16-11fb50d806fb
- Site URL: https://reboot.studio
- ID: ac14ea36-ea3e-4a25-bd16-11fb50d806fb
- Theme: light
- Industry: agency
- Created: 2026-02-27T11:56:56.000Z
- Ranks: newest: 1117, popular: 608, trending: 815
...
| --- | --- | --- | --- | --- | --- |
| Inter | Inter | 400, 500, 600 | 14px, 16px, 40px | 1.43, 1.50, 1.60, 1.80 | Used across all text roles; headlines use heavier weights, body text maintains readability with 400. Its versatility and clean lines are central to the understated aesthetic. |
| Inter | Inter | 400, 500, 600 | 14px, 16px, 40px | 1.43, 1.50, 1.60, 1.80 | Used for button text and subtle emphasis where a slight increase in weight is needed without becoming bold. |
| Inter | Inter | 400, 500, 600 | 14px, 16px, 40px | 1.43, 1.50, 1.60, 1.80 | Dominant for headings and key emphasis. This exact weight (600) balances prominence with the system's overall light touch. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775925188424-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775925188424-thumb.jpg |
