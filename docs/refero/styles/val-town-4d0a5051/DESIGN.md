# Val Town — Refero Style

- Refero URL: https://styles.refero.design/style/4d0a5051-1c4c-4338-8406-2babdc97915c
- Site URL: https://val.town
- ID: 4d0a5051-1c4c-4338-8406-2babdc97915c
- Theme: light
- Industry: devtools
- Created: 2026-02-08T19:50:07.000Z
- Ranks: newest: 1216, popular: 53, trending: 423
...
| --- | --- | --- | --- | --- | --- |
| IBM Plex Sans | system-ui, sans-serif | 400 | 10px, 12px, 14px, 16px, 18px, 24px, 36px, 48px, 60px, 128px | 1.00, 1.11, 1.14, 1.25, 1.30, 1.33, 1.43, 1.50, 1.56, 1.60 | Primary typeface for all UI elements, headings, and body text. Its neutral yet modern character ensures broad legibility. Compressed letter spacing at larger sizes (`-0.0250em`) provides visual tightness to headlines, while smaller sizes increase to accommodate legibility, indicating a careful type-setting for different contexts. |
| IBM Plex Sans | system-ui, sans-serif | 700 | 10px, 12px, 14px, 16px, 18px, 24px, 36px, 48px, 60px, 128px | 1.00, 1.11, 1.14, 1.25, 1.30, 1.33, 1.43, 1.50, 1.56, 1.60 | Used for strong emphasis in headings, navigation, and key UI labels. The consistent letter spacing strategy with normal weight applies here, ensuring visual consistency across weights. |
| iA Writer Mono | monospace | 400 | 14px, 16px, 20px, 24px, 60px | 1.00, 1.33, 1.40, 1.43, 1.50 | Dedicated to code blocks, technical snippets, and specific data elements, reinforcing the developer-centric nature of the platform. Its fixed-width character evokes a terminal or IDE environment. |
| iA Writer Mono | monospace | 700 | 14px, 16px, 20px, 24px, 60px | 1.00, 1.33, 1.40, 1.43, 1.50 | Used for highlighting important keywords or values within code snippets, providing emphasis where needed without breaking the monospaced aesthetic. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775923478176-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775923478176-thumb.jpg |
| preview video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/4d0a5051-1c4c-4338-8406-2babdc97915c-1777557390653-preview.mp4 |
| preview video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/4d0a5051-1c4c-4338-8406-2babdc97915c-1777557390653-preview-poster.jpg |
| detail video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/4d0a5051-1c4c-4338-8406-2babdc97915c-1777557390653-preview-detail.mp4 |
| detail video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/4d0a5051-1c4c-4338-8406-2babdc97915c-1777557390653-preview-detail-poster.jpg |
