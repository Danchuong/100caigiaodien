# Ciridae — Refero Style

- Refero URL: https://styles.refero.design/style/a1b78a21-a304-482b-8ce5-f612d95d44fe
- Site URL: https://www.ciridae.com
- ID: a1b78a21-a304-482b-8ce5-f612d95d44fe
- Theme: dark
- Industry: ai
- Created: 2026-04-13T16:42:41.000Z
- Ranks: newest: 915, popular: 90, trending: 65
...
| --- | --- | --- | --- | --- | --- |
| Pragmatica Cond | Open Sans Condensed | 400 | 14px, 16px, 20px, 32px, 62px | 0.90, 1.00, 1.05, 1.10, 1.43 | Primary headings, navigation, prominent statements, and general UI labels. Its condensed form and tight letter-spacing create a sharp, efficient aesthetic. |
| Pragmatica | Open Sans | 400 | 15px, 24px | 1.10, 1.20 | Secondary headings and larger body text blocks where slightly more breath is needed compared to Pragmatica Cond. |
| Roboto Mono | Roboto Mono | 400 | 11px, 14px | 0.90, 1.00, 1.10, 1.20 | Body copy and informational text. The monospaced nature subtly reinforces a technical, code-adjacent brand identity. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1776008651273-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1776008651273-thumb.jpg |
