# LottieFiles — Refero Style

- Refero URL: https://styles.refero.design/style/a80507cb-afda-46dd-a2b9-ba91f3a78e78
- Site URL: https://lottiefiles.com
- ID: a80507cb-afda-46dd-a2b9-ba91f3a78e78
- Theme: light
- Industry: design
- Created: 2026-02-19T13:28:03.000Z
- Ranks: newest: 1159, popular: 94, trending: 73
...
| --- | --- | --- | --- | --- | --- |
| DM Sans | DM Sans (Google Fonts) | 400, 500, 600 | 14px, 16px, 18px, 20px, 24px, 32px, 48px, 64px, 96px | 1.04-1.56 | Display headlines and prominent marketing text. The tight letter spacing on larger sizes creates a modern, impactful feel, while maintaining readability at smaller headline sizes. |
| Inter | Inter (Google Fonts) | 400, 500, 600 | 10px, 12px, 14px, 16px, 18px, 24px, 32px | 1.10-1.71 | Body text, navigation, buttons, and most UI elements. Its neutrality and legibility ensure a consistent and approachable voice across the interface, supporting the more expressive DM Sans. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775923945653-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775923945653-thumb.jpg |
