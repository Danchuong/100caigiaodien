# Channel Studio — Refero Style

- Refero URL: https://styles.refero.design/style/4c19bf7b-d5e8-4e2a-b3e3-69a9bde19b7a
- Site URL: https://channel.studio
- ID: 4c19bf7b-d5e8-4e2a-b3e3-69a9bde19b7a
- Theme: dark
- Industry: design
- Created: 2026-04-30T01:41:27.816Z
- Ranks: newest: 544, popular: 703, trending: 582
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Midnight Void | #000000 | neutral | Page backgrounds, large dark surfaces |
| Ghost Gray | #cacaca | neutral | Neutral form states, badge text, and quiet UI feedback where color should stay understated. Do not promote it to the primary CTA color |
| Faded Stone | #727272 | neutral | Muted text, subtle borders |
| Vanguard Red | #ff7777 | brand | Highlighted headings, selected project titles, active links — signals importance and draws attention against the dark canvas |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Lausanne | Inter | 400 | 13px, 15px, 16px, 18px, 45px, 75px | 0.90, 0.95, 1.19, 1.20 | Primary typeface for all text elements. The singular weight (400) creates a consistent, deliberate tone, relying on size for hierarchy. The tight letter spacing for display text maintains visual density and impact. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777513268340-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777513268340-thumb.jpg |
