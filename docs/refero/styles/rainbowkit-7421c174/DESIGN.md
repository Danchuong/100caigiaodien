# RainbowKit — Refero Style

- Refero URL: https://styles.refero.design/style/7421c174-a1b1-4695-a9e7-a82dc6f5ea3b
- Site URL: https://www.rainbowkit.com
- ID: 7421c174-a1b1-4695-a9e7-a82dc6f5ea3b
- Theme: dark
- Industry: devtools
- Created: 2026-04-30T01:48:36.534Z
- Ranks: newest: 514, popular: 1237, trending: 1215
...
| --- | --- | --- | --- | --- | --- |
| SFRounded |  | 400, 500, 600, 700, 800 | 11px, 14px, 16px, 18px, 20px, 24px, 40px, 52px | 1.00, 1.05, 1.17, 1.20, 1.25, 1.29, 1.31, 1.33 | Primary brand typeface for all headings, body text, and UI elements. Its rounded humanist sans-serif aesthetic contributes to the friendly, contemporary feel of the interface across all weights and sizes. |
| Arial |  | 400 | 13px, 16px | 1.20 | Fallback system font primarily for button and icon labels where a generic sans-serif is sufficient and SFRounded might not be loaded, maintaining basic readability. |
| system-ui |  | 400 | 20px | 1.05 | System fallback for general body text at display sizes, ensuring content remains legible and consistent even without custom fonts. |
| SFMono |  | 400 | 14px | 1.00 | Monospace font for code snippets and technical text, ensuring consistent character width important for programming output and command line interfaces. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777513688144-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777513688144-thumb.jpg |
