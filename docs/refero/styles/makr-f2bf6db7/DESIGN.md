...
- Refero URL: https://styles.refero.design/style/f2bf6db7-37b6-4394-be97-6bbb2c45c268
- Site URL: https://makr.com
- ID: f2bf6db7-37b6-4394-be97-6bbb2c45c268
- Theme: light
- Industry: ecommerce
- Created: 2026-04-30T02:19:07.647Z
- Ranks: newest: 396, popular: 858, trending: 705
...
| --- | --- | --- | --- | --- | --- |
| Sohne Web | Inter | 400 | 11px, 12px, 13px, 14px, 16px, 18px, 20px, 32px | 1.15, 1.35, 1.40, 1.45, 1.80 | Primary typeface for all text content: body, headings, links, and buttons. Its clean, utilitarian nature underpins the brand's direct aesthetic. |
| CircularXXMonoWeb | Space Mono | 400 | 13px, 20px | 1.15 | Used sparingly for decorative links or specific callouts, lending a technical, almost machine-generated feel. |

## Type Scale

| Role | Size | Line Height | Letter Spacing |
| --- | --- | --- | --- |
| caption | 11 | 1.45 | 0.165 |
| heading | 18 | 1.35 | 0.27 |
| heading-lg | 20 | 1.15 | 0.6 |
| display | 32 | 1.15 | 0.96 |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777515527119-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777515527119-thumb.jpg |
