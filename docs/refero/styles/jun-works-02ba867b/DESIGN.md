# jun.works — Refero Style

- Refero URL: https://styles.refero.design/style/02ba867b-49e3-4ab4-ad23-c30baf345078
- Site URL: https://jun.works
- ID: 02ba867b-49e3-4ab4-ad23-c30baf345078
- Theme: light
- Industry: design
- Created: 2026-04-30T03:13:34.771Z
- Ranks: newest: 202, popular: 925, trending: 842
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Canvas White | #ffffff | neutral | Page backgrounds, overall site canvas, main surface for content |
...
| Muted Gray | #cccccc | neutral | Subtle borders and decorative fills, providing a slight visual separation or distinction where a full Ink Black is too strong |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Standard | Arial Narrow | 400 | 45px, 54px | 1.12, 1.15, 1.70 | The primary display font for brand identity, headings, and key messaging. Its custom nature and tight letter spacing deliver a distinctive, condensed, and impactful visual presence, designed to be read as graphic elements. |
| Times | Times New Roman | 400 | 13px | 1.20 | Used for all body copy and descriptive text. Its classic, serif appearance provides a contrasting texture to the bespoke 'Standard' font, grounding the content with traditional readability. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777518795719-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777518795719-thumb.jpg |
