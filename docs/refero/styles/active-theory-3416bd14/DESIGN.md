# Active Theory — Refero Style

- Refero URL: https://styles.refero.design/style/3416bd14-96bb-4c23-bd01-b2ea178ba5ce
- Site URL: https://activetheory.net
- ID: 3416bd14-96bb-4c23-bd01-b2ea178ba5ce
- Theme: dark
- Industry: agency
- Created: 2026-01-30T18:03:06.000Z
- Ranks: newest: 1255, popular: 390, trending: 617
...
| --- | --- | --- | --- | --- | --- |
| nbarchitekt | Montserrat | 400, 700 | 10px, 12px, 14px | 1.20, 1.50, 3.00 | The primary typeface for UI elements, body text, and prominent links. Its custom nature gives the interface a distinct, technically precise feel at smaller sizes and a bold presence at larger weights. Weight 700 is reserved for key labels and headings, while weight 400 maintains legibility for body and interactive components. |
| Arial | Arial | 400 | 13px | 1.20 | Used for specific button labels, providing a standard, legible base that subtly contrasts with the custom nbarchitekt font. |
| Times | Times New Roman | 400 | 16px | 1.20, 1.88 | Employed for less critical text and general content, specifically where a traditional serif style is desired. This choice introduces a classic counterpoint to the otherwise modern, technical aesthetic. Its inclusion suggests intentionality for specific content blocks like legal text. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775925461564-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775925461564-thumb.jpg |
