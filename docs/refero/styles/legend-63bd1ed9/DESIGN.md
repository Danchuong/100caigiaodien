...
- Refero URL: https://styles.refero.design/style/63bd1ed9-b161-45fd-8734-85282bd945ec
- Site URL: https://legend.xyz
- ID: 63bd1ed9-b161-45fd-8734-85282bd945ec
- Theme: light
- Industry: crypto
- Created: 2026-04-30T00:19:16.466Z
- Ranks: newest: 837, popular: 116, trending: 83
...
| --- | --- | --- | --- | --- | --- |
| knapp | Inter | 400, 500 | 12px, 16px, 20px, 22px, 44px, 56px | 1.00, 1.10, 1.25, 1.30, 1.40, 1.50 | Primary typeface for headings, body text, and UI elements. Its clean, sans-serif forms with slightly condensed characters convey precision and modernity. While default weight is 400, a bolder 500 is used for key interface elements. |
| diatypeMono | Space Mono | 400 | 11px, 13px | 1.00, 1.35 | Monospaced font for technical details, coordinates, and subtle navigation. Its fixed width creates a structured, data-driven feel and distinguishes it from the primary typeface, hinting at underlying complexity. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777508320444-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777508320444-thumb.jpg |
