...
- Refero URL: https://styles.refero.design/style/c45b115b-dcb5-446d-8952-85aef740f8e4
- Site URL: https://retool.com
- ID: c45b115b-dcb5-446d-8952-85aef740f8e4
- Theme: dark
- Industry: devtools
- Created: 2026-04-02T09:54:55.000Z
- Ranks: newest: 964, popular: 102, trending: 93
...
| --- | --- | --- | --- | --- | --- |
| saansFont | Inter, DM Sans | 300, 380, 570 | 14px, 16px, 18px, 24px, 32px, 36px, 48px, 60px, 72px | 1.00 at 60-72px, 1.05 at 36-48px, 1.20 at 18-32px, 1.50 at 14-16px | Primary typeface for all display, heading, body, and UI text. Weight 300 at 60-72px is anti-conventional — most platforms use 600-700 for hero text; the thin weight creates authority through mass (huge scale) rather than stroke weight. Weight 380 handles body and subheadings. Weight 570 for labels and small UI. Custom font unavailable externally. |
| pxGroteskFont | Space Grotesk, Geist | 400 | 12px, 14px | 1.00, 1.20 | Monospace-adjacent label font for nav, micro-copy, tags, and icon captions. The slight +0.010em tracking at small sizes distinguishes it from body text — reads like interface chrome rather than content. |
| ui-sans-serif | System UI stack | 400 | 16px | 1.50 | Fallback system font for utility text, form inputs, and browser-native UI elements. Not a designed choice — appears only as system default context. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777503779439-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777503779439-thumb.jpg |
| preview video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/c45b115b-dcb5-446d-8952-85aef740f8e4-1777567538461-preview.mp4 |
| preview video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/c45b115b-dcb5-446d-8952-85aef740f8e4-1777567538461-preview-poster.jpg |
| detail video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/c45b115b-dcb5-446d-8952-85aef740f8e4-1777567538461-preview-detail.mp4 |
| detail video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/c45b115b-dcb5-446d-8952-85aef740f8e4-1777567538461-preview-detail-poster.jpg |
