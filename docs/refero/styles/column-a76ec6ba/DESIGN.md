...
- Refero URL: https://styles.refero.design/style/a76ec6ba-20b3-495c-9d89-1e58281e79e7
- Site URL: https://column.com
- ID: a76ec6ba-20b3-495c-9d89-1e58281e79e7
- Theme: light
- Industry: fintech
- Created: 2026-03-22T20:28:02.000Z
- Ranks: newest: 1009, popular: 30, trending: 18
...
| --- | --- | --- | --- | --- | --- |
| SuisseIntl | Inter | 300, 400, 500, 600 | 11px, 12px, 14px, 16px, 18px, 20px, 24px, 28px, 40px, 48px, 52px, 60px | 1.00, 1.10, 1.30, 1.33, 1.38, 1.40, 1.43, 1.50 | Primary typeface for all main content, headings, and UI elements. Its clean, slightly compressed letterforms convey efficiency and sophistication. Weight 600 at 48px headlines commands attention with quiet confidence; weight 300 for subheadings at 28px adds a subtle, approachable gravity. The variable letter-spacing (up to -0.03em at larger sizes) tightens display text for visual impact. |
| SFMono | IBM Plex Mono | 400 | 10px, 12px | 1.50 | Monospaced font for code snippets, financial figures, and technical labels, ensuring precise alignment and clarity for data-driven content. Its consistent width emphasizes the accuracy inherent in banking operations. |
| Inter |  | 400, 500, 600 | 10px, 12px, 14px, 16px, 20px, 24px | 1.00, 1.10, 1.14, 1.33, 1.50 | Secondary typeface, primarily for detailed body text and supporting UI elements. Provides similar legibility to SuisseIntl but with slightly more open letterforms at smaller sizes, aiding readability in high-information densities. |
| SuisseIntlMono | IBM Plex Mono | 400 | 10px, 12px, 14px | 1.50 | Specialized monospaced font for technical outputs and code display within the UI, complementing SFMono for specific interactive code contexts. Its presence reinforces the developer-centric aspect of Column. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775933447592-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775933447592-thumb.jpg |
| preview video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/a76ec6ba-20b3-495c-9d89-1e58281e79e7-1777560786888-preview.mp4 |
| preview video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/a76ec6ba-20b3-495c-9d89-1e58281e79e7-1777560786888-preview-poster.jpg |
| detail video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/a76ec6ba-20b3-495c-9d89-1e58281e79e7-1777560786888-preview-detail.mp4 |
| detail video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/a76ec6ba-20b3-495c-9d89-1e58281e79e7-1777560786888-preview-detail-poster.jpg |
