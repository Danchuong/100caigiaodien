...
- Refero URL: https://styles.refero.design/style/dae7cbf2-0485-433b-8f63-eea8716ad14d
- Site URL: https://equals.com
- ID: dae7cbf2-0485-433b-8f63-eea8716ad14d
- Theme: light
- Industry: saas
- Created: 2026-03-26T19:59:51.000Z
- Ranks: newest: 994, popular: 46, trending: 254
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Analyst Yellow | #FFCC00 | brand | Announcement bar background only — saturated yellow on near-black text creates maximum urgency at minimal surface area, never used elsewhere so it retains its alarm-signal quality |
| Orchid CTA | #B074CE | brand | Primary CTA buttons — warm violet against cream background reads as inviting rather than urgent, distinguishing CTAs from the aggressive red/orange typical of SaaS |
| Brand Green | #20A277 | accent | Finance category accent swatch — one of three role-coded indicator blocks (RevOps red, Founders navy, Finance green) flanking solution rows |
...
| Midnight Ink | #000000 | neutral | All headings, body text, borders, nav links, icons — full black with zero softening; the high contrast against cream is deliberately old-media, not SaaS-neutral |
| Warm Cream | #FAF9F5 | neutral | Page background, section backgrounds — the slight warm yellow tint separates this from clinical white and reinforces the paper/spreadsheet metaphor |
...
| Fog Border | #CDCCC9 | neutral | Nav dropdown shadows, subtle divider lines |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Serrif Condensed | Freight Display Condensed, or Playfair Display with condensed tracking | 400 | 40px, 48px, 110px | 1.00–1.10 | All display and section headings — single weight 400 across all sizes is the anti-convention choice; most SaaS headlines use 700-800, this regular-weight condensed serif whispers editorial authority. The 110px size is used only for hero display text. |
| Unica77 | Inter, Aktiv Grotesk | 400 | 14px, 16px, 18px, 24px | 1.00–1.71 | Every non-heading element: nav links, body copy, buttons, footer, input placeholder, labels. The negative letter-spacing at all sizes tightens an already compact grotesque into something UI-precise — a signature move that makes UI chrome feel considered rather than default. |
| Aeonik Fono | IBM Plex Mono | 400 | 13px | 1.54 | Fine-print body context — 13px utility text likely used for footnotes or micro-labels. Its presence alongside Unica77 suggests a tertiary voice for data footnotes or legal-adjacent content. |
...
| caption | 13 | 1.54 |  |
| body | 16 | 1.5 | -0.08 |
| subheading | 18 | 1.33 | -0.072 |
| heading-sm | 24 | 1.29 |  |
| heading | 40 | 1.1 | -0.8 |
| heading-lg | 48 | 1.04 | -0.48 |
| display | 110 | 1 | -2.2 |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775934084494-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775934084494-thumb.jpg |
| preview video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/dae7cbf2-0485-433b-8f63-eea8716ad14d-1777557229804-preview.mp4 |
| preview video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/dae7cbf2-0485-433b-8f63-eea8716ad14d-1777557229804-preview-poster.jpg |
| detail video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/dae7cbf2-0485-433b-8f63-eea8716ad14d-1777557229804-preview-detail.mp4 |
| detail video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/dae7cbf2-0485-433b-8f63-eea8716ad14d-1777557229804-preview-detail-poster.jpg |
