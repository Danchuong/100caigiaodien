# Regisgrumberg — Refero Style

- Refero URL: https://styles.refero.design/style/1a2ca4fb-1087-4fd0-83ba-590bc63f54ee
- Site URL: https://www.regisgrumberg.com
- ID: 1a2ca4fb-1087-4fd0-83ba-590bc63f54ee
- Theme: dark
- Industry: design
- Created: 2026-04-30T01:42:24.574Z
- Ranks: newest: 540, popular: 1239, trending: 1222
...
| --- | --- | --- | --- | --- | --- |
| monospace | 'IBM Plex Mono', 'Fira Code', 'JetBrains Mono' | 400 | 13px | 1.00, 1.20 | Functional text, small labels, code snippets. Its fixed-width character reinforces a technical, structured feel. |
| Times | 'Times New Roman', 'Georgia' | 400 |  | 1.00 | Likely used for specific stylistic text or as a fallback; its serif nature would provide a high contrast to the primary sans-serifs, creating visual tension. |
| Montserrat | 'Inter', 'Lato' | 400, 600 | 11px, 14px, 18px, 24px, 30px, 36px | 1.00, 1.20, 2.78 | General body text and subheadings. Its clean, geometric form provides excellent readability against dark backgrounds. |
| Anton | 'Oswald', 'Impact' | 500 | 18px, 24px, 48px, 90px, 150px | 1.00, 1.20 | Bold, impactful headlines and display text. Its condensed and heavy style demands attention, creating strong typographic statements. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777513314435-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777513314435-thumb.jpg |
