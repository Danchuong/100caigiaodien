...
- Refero URL: https://styles.refero.design/style/39098e34-b911-4ad3-bcb5-ee80a392cd95
- Site URL: https://joinclyde.com
- ID: 39098e34-b911-4ad3-bcb5-ee80a392cd95
- Theme: dark
- Industry: saas
- Created: 2026-04-30T01:54:33.478Z
- Ranks: newest: 492, popular: 309, trending: 226
...
| --- | --- | --- | --- | --- | --- |
| Recoleta | Playfair Display | 400 | 36px, 47px, 61px, 80px, 125px | 1.00, 1.10 | Display headlines and page titles — the large, highly tracked text creates a distinct, sophisticated visual statement. |
| Oldschool Grotesk | Inter | 300, 400 | 15px, 16px, 21px, 80px, 138px | 1.00, 1.30, 1.40, 1.60 | Body text, subheadings, and UI elements — its subtle tracking and modern sans-serif form balance the Recoleta headlines, providing clear readability. |
| Times | Times New Roman | 400 | 16px | 1.20, 1.25 | System fallback for various UI elements where a classic serif provides visual texture. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777514052561-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777514052561-thumb.jpg |
