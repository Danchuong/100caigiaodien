# Learn UX Design — Refero Style

- Refero URL: https://styles.refero.design/style/fae6a5ec-f32e-4151-bc22-350055d673f7
- Site URL: https://uxcel.com
- ID: fae6a5ec-f32e-4151-bc22-350055d673f7
- Theme: light
- Industry: productivity
- Created: 2026-04-30T00:53:55.954Z
- Ranks: newest: 670, popular: 795, trending: 639
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Ink Black | #05060f | neutral | Primary text, strong borders, dark icons, and high-contrast elements. Creates a commanding presence against the white canvas |
| Virtual Violet | #513deb | brand | Primary call-to-action fills, active navigation states, and key interactive highlights—a vivid, energetic accent |
| Cloud White | #ffffff | neutral | Primary page background, card surfaces, and inverse text for dark interactive elements |
| Whisper Gray | #f8f8f8 | neutral | Secondary background for sections, footer background, and subtle elevated container fills |
| Stone Gray | #696a6f | neutral | Muted text, secondary iconography, and subtle borders for ghost elements |
| Platinum Gray | #d7d7d9 | neutral | Dividers, subtle outlines for neutral buttons, and inactive state borders |
| Interaction Violet | #9282fa | brand | Hover states for primary action elements, a lighter, more playful violet |
| Dark Violet Text | #452dbd | brand | Text for violet-themed badges and other branded copy |
| Success Green | #269432 | semantic | Text for success-oriented badges, indicating positive status |
| Muted Violet Background | #ede8ff | semantic | Background for violet-themed badges, offering a softer tint than the full brand accent |
| Light Success Green | #d4fcd8 | semantic | Background for success badges, providing a gentle indication of positive status |
| Info Blue | #2571cc | semantic | Text for informational badges, denoting specific categories or status |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Inter | system-ui | 400, 500, 600, 700 | 10px, 12px, 14px, 16px, 18px, 20px, 22px, 32px, 40px, 48px, 58px | 1.12, 1.20, 1.30, 1.33, 1.40, 1.43, 1.50, 1.57, 1.60, 1.70, 1.75 | The sole typeface, Inter, handles all typographic duties from headlines to body text. Its clean, geometric sans-serif aesthetic supports clarity and a modern, technical feel. Tightly tracked headlines maintain a crisp, assertive tone without relying on heavy weights. |
...
| heading-sm | 22 | 1.4 |  |
| heading | 32 | 1.33 |  |
| display-sm | 48 | 1.2 | -0.96 |
| display | 58 | 1.12 | -1.45 |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777510399190-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777510399190-thumb.jpg |
