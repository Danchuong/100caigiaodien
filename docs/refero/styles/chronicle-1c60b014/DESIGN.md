# Chronicle — Refero Style

- Refero URL: https://styles.refero.design/style/1c60b014-473b-443b-b0f5-220612feebb7
- Site URL: https://chroniclehq.com
- ID: 1c60b014-473b-443b-b0f5-220612feebb7
- Theme: light
- Industry: saas
- Created: 2026-02-05T09:57:52.000Z
- Ranks: newest: 1231, popular: 134, trending: 113
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Pitch Black | #050505 | neutral | Dark borders and separators for elevated surfaces and inverted UI. Do not promote it to the primary CTA color |
| Midnight | #000000 | neutral | Filled action button backgrounds (Try Chronicle, Talk to sales, Try for free); icon fills; strongest contrast anchor |
| Charcoal | #151515 | neutral | Navigation link text and active nav states |
| Obsidian | #292929 | neutral | Footer fine print and copyright text |
| Graphite | #6b6b6b | neutral | Body text, UI borders, ghost button borders and text — the workhorse mid-tone |
| Pewter | #7e7e7e | neutral | Secondary body copy and captions |
| Ash | #929292 | neutral | Disabled or inactive button text and borders |
| Silver | #b3b3b3 | neutral | Subtle background dividers and muted separators |
| Fog | #e2e2e2 | neutral | Card borders, image borders, input borders — the hairline rule color |
| Limestone | #f3f3f3 | neutral | Alternating section backgrounds, testimonial section canvas, muted surface fills |
| Cloud | #ffffff | neutral | Primary page canvas, card surfaces, link text on filled black buttons |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Diatype | Inter, Helvetica Neue | 400, 500 | 12px, 14px, 16px, 20px, 32px, 48px, 54px | 1.00–1.40 (1.00 at display, 1.05 at large headings, 1.10–1.20 at subheadings, 1.40 at body) | Single typeface for the entire system — headings, body, nav, buttons. Weight 400 for body and secondary text; weight 500 for prominent headings and CTAs. Negative tracking of -0.03em at display sizes creates mechanical compression uncommon in SaaS type — the letterforms feel pressed into the page rather than set on it. No serif, no decorative fallback: if Diatype is absent, the design loses its primary identity marker. |
...
| heading-sm | 32 | 1.1 | -0.74 |
| heading | 48 | 1.05 | -1.44 |
| display | 54 | 1 | -1.62 |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777650581491-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777650581491-thumb.jpg |
| icon | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777650581491-icon.png |
| preview video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1c60b014-473b-443b-b0f5-220612feebb7-1777652507419-preview.mp4 |
| preview video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1c60b014-473b-443b-b0f5-220612feebb7-1777652507419-preview-poster.jpg |
| detail video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1c60b014-473b-443b-b0f5-220612feebb7-1777652507419-preview-detail.mp4 |
| detail video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1c60b014-473b-443b-b0f5-220612feebb7-1777652507419-preview-detail-poster.jpg |
