# Mario Carrillo — Refero Style

- Refero URL: https://styles.refero.design/style/c181d124-242e-469b-a91a-4e44aad49a86
- Site URL: https://marioecg.com
- ID: c181d124-242e-469b-a91a-4e44aad49a86
- Theme: light
- Industry: design
- Created: 2026-04-30T01:33:21.445Z
- Ranks: newest: 575, popular: 215, trending: 140
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Canvas White | #ffffff | neutral | Page backgrounds, left-hand navigation pane background |
| Ink Black | #000000 | neutral | Primary text, navigation links, borders, logo fill |
| Scarlet Flash | #de3333 | brand | Animated navigation background segment within the gradient |
| Ocean Dream | #70b2ff | brand | Animated navigation background segment within the gradient |
| Emerald Glaze | #7bdcb5 | brand | Animated navigation background segment within the gradient |
| Golden Burst | #f9bf03 | brand | Animated navigation background segment within the gradient |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| StudioFeixenSans | Montserrat | 400 | 14px, 16px | 1.00 | All text elements: logo, navigation links, body copy, and footer copyright |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777512768230-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777512768230-thumb.jpg |
