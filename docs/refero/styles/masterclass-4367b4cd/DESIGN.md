# MasterClass — Refero Style

- Refero URL: https://styles.refero.design/style/4367b4cd-b002-4719-a418-cbce020f0d33
- Site URL: https://www.masterclass.com
- ID: 4367b4cd-b002-4719-a418-cbce020f0d33
- Theme: dark
- Industry: media
- Created: 2026-04-30T00:42:21.106Z
- Ranks: newest: 724, popular: 253, trending: 153
...
| --- | --- | --- | --- | --- | --- |
| Sohne | Inter | 400, 600 | 8px, 12px, 14px, 16px, 20px, 22px, 24px, 32px, 48px | 1.00, 1.25, 1.33, 1.45, 1.50, 1.60, 2.50 | Primary typeface for all body text, links, buttons, and most headings up to 48px. Its slightly condensed yet approachable nature supports information density without feeling cramped. |
| Sohne Schmal |  condensed sans-serif like Oswald or Anton | 500 | 64px, 80px | 0.85, 0.90 | Used for large, impactful display headlines, where its 'schmal' (narrow) characteristic allows for bold statements in restricted vertical space. The tight letter-spacing adds to its direct, attention-grabbing feel. |
| Ivar Display Condensed | Condensed serif like Playfair Display SC or IBM Plex Serif | 400 | 64px | 1.10 | An alternative serif for display headings, adding a touch of classic authority and gravitas to select feature titles. Its condensed form maintains visual economy typical of the system. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777509704264-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777509704264-thumb.jpg |
