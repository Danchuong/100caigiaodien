...
- Refero URL: https://styles.refero.design/style/e869e214-f672-4ac3-bfc2-bd25de7b003b
- Site URL: https://base44.com
- ID: e869e214-f672-4ac3-bfc2-bd25de7b003b
- Theme: light
- Industry: ai
- Created: 2026-03-16T14:12:04.000Z
- Ranks: newest: 1036, popular: 16, trending: 19
...
| --- | --- | --- | --- | --- | --- |
| Arial | Arial | 400 | 10px, 13px, 14px | 1.20 | Small functional text like captions, utility links, and fine print. The system font choice maintains legibility at small sizes. |
| wfont_343a2a_5b4cd32fc19d46e1b8c1b142abb27d39 | system-ui | 400 | 22px, 24px, 34px, 51px, 55px, 56px, 63px | 0.90, 1.00, 1.07, 1.10, 1.40 | Display and Major Headings — its generous letter spacing and fluid line heights give large text a soft, open presence. |
| wfont_343a2a_4e484da66ffc4465a05a1c9ea5caf495 | system-ui | 400 | 16px, 20px, 28px, 30px, 42px | 1.00, 1.20, 1.30 | Section headings and content titles — slightly more structured than display text, maintaining readability without feeling dense. |
| wix-madefor-text-v2 | system-ui | 400, 500, 600, 700 | 12px, 14px, 16px, 18px | 1.20, 1.30, 1.40, 1.50, 1.60 | Body text and user input fields — consistent letter spacing across weights ensures clarity in both continuous prose and short UI labels. |
| Madefor-Text | system-ui | 400 | 16px | 1.20 | Navigation and button labels — a steady weight for interactive elements that need to be clear and inviting. |
| Madefor-Display | system-ui | 400 | 10px | 1.20 | Microcopy and specialized decorative text, offering a distinctive voice for minor elements. |
| wfont_343a2a_5b4cd32fc19d46e1b8c1b142abb27d39 |  | 400 | 22px, 24px, 34px, 51px, 55px, 56px, 63px | 0.9, 1, 1.07, 1.1, 1.4 | wfont_343a2a_5b4cd32fc19d46e1b8c1b142abb27d39 — detected in extracted data but not described by AI |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777421369053-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777421369053-thumb.jpg |
| preview video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/e869e214-f672-4ac3-bfc2-bd25de7b003b-1777562967062-preview.mp4 |
| preview video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/e869e214-f672-4ac3-bfc2-bd25de7b003b-1777562967062-preview-poster.jpg |
| detail video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/e869e214-f672-4ac3-bfc2-bd25de7b003b-1777562967062-preview-detail.mp4 |
| detail video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/e869e214-f672-4ac3-bfc2-bd25de7b003b-1777562967062-preview-detail-poster.jpg |
