# Rainbow — Refero Style

- Refero URL: https://styles.refero.design/style/1680693c-aed8-47e8-917a-04eb89497b09
- Site URL: https://rainbow.me
- ID: 1680693c-aed8-47e8-917a-04eb89497b09
- Theme: light
- Industry: crypto
- Created: 2026-02-20T16:40:09.000Z
- Ranks: newest: 1154, popular: 412, trending: 507
...
| --- | --- | --- | --- | --- | --- |
| SF Pro Rounded | system-ui, 'Avenir Next Rounded Std', 'Inter Display' | 400 | 16px, 20px, 24px, 32px, 36px, 42px, 56px, 80px, 96px, 100px | 1.00, 1.10, 1.20 | The primary typeface for headings and prominent body text. Its rounded edges align with the playful, soft aesthetic. The liberal use of bold, heavy, and black weights, combined with tight letter-spacing for display sizes, creates a friendly yet impactful presence. |
| sans-serif | system-ui | 400 | 12px | 1.20 | Smallest body text, links, and minor UI elements. Provides a clean, highly legible foundation for detailed information, contrasting with the rounded display type. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775924191327-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775924191327-thumb.jpg |
