...
- Refero URL: https://styles.refero.design/style/607e0dbf-e2fc-45c9-b939-946b8981c156
- Site URL: https://giga.ai
- ID: 607e0dbf-e2fc-45c9-b939-946b8981c156
- Theme: dark
- Industry: ai
- Created: 2026-04-30T00:22:31.071Z
- Ranks: newest: 819, popular: 534, trending: 332
...
| --- | --- | --- | --- | --- | --- |
| sans-serif |  | 400 | 12px | 1.20 | System fallback, minimal UI text. |
| Inter |  | 300, 400, 500 | 8px, 9px, 10px, 11px, 12px, 13px, 14px, 16px, 29px, 44px | 1.00, 1.36, 1.50, 1.54, 1.64, 1.70, 1.71, 1.75, 1.85, 1.93, 2.00, 2.22 | Primary UI text, body copy, and secondary headlines. Its variable letter-spacing for different sizes provides an adaptive, precise feel without being overtly tracked. |
| Geist Mono |  | 400, 500 | 11px, 12px, 14px | 1.20, 2.00, 2.18 | Monospaced text for data, code snippets, or subtle highlights where a technical, precise voice is needed. The positive tracking provides visual breathing room. |
| Giga Sans Text Trial 500 |  | 400, 500 | 14px | 1.20 | Content body text and detailed descriptive text. |
| Giga Sans Display Trial 500 |  | 400 | 22px | 0.86 | Small display headings, where a compact, almost stacked look is desired due to the tight line height. |
| Inter Display |  | 400, 500 | 16px | 1.50, 1.51, 2.50 | Sub-headings and emphasized body text. The slight tracking enhances readability at smaller display sizes. |
| Emilio Light |  | 300, 400 | 24px, 41px, 48px | 1.20, 1.30 | Primary headlines and hero text. The light weight and negative letter-spacing for larger sizes lend a sense of understated sophistication and calm, rather than shouting. |
| Giga Sans Display Trial 400 |  | 400 | 30px | 1.33, 1.50 | Medium-sized display headings. |
| Giga Sans Text Trial 400 |  | 400 | 14px | 1.20 | Standard body text. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777508520866-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777508520866-thumb.jpg |
