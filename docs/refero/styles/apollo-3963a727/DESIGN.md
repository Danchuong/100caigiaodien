...
- Refero URL: https://styles.refero.design/style/3963a727-8dec-4308-80c0-3ae198d15b87
- Site URL: https://www.apollo.io
- ID: 3963a727-8dec-4308-80c0-3ae198d15b87
- Theme: light
- Industry: saas
- Created: 2026-04-30T00:20:47.210Z
- Ranks: newest: 829, popular: 672, trending: 491
...
| --- | --- | --- | --- | --- | --- |
| Season Mix | Montserrat | 550 | 48px, 56px, 64px, 72px, 88px | 1.00, 1.05, 1.10 | Display and marketing headlines – a semi-bold custom font with tight tracking gives presence without shouting. |
| Soehne | Inter | 400 | 16px, 18px | 1.00, 1.50 | Primary body text, input fields, navigation links, and button labels – a precise, readable sans-serif with subtle positive tracking. |
| Abc Diatype | Roboto Condensed | 400, 700 | 12px, 14px, 16px, 20px, 24px | 1.20, 1.30 | Secondary body text, smaller labels, and bolded elements – a compact sans-serif with tight negative tracking, complementing Soehne with a more condensed feel. |
| Founders Grotesk Mono | IBM Plex Mono | 400 | 12px, 14px | 1.20 | Specific code-like or data-related text – provides a monospaced contrast and reinforces precision. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777508417335-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777508417335-thumb.jpg |
