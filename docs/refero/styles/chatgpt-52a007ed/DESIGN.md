# ChatGPT — Refero Style

- Refero URL: https://styles.refero.design/style/52a007ed-ad1b-46a6-bd44-b76f91df6d0c
- Site URL: https://chatgpt.com
- ID: 52a007ed-ad1b-46a6-bd44-b76f91df6d0c
- Theme: light
- Industry: ai
- Created: 2026-02-14T12:27:34.000Z
- Ranks: newest: 1187, popular: 97, trending: 81
...
| Stone | #8f8f8f | neutral | Placeholder text, inactive icons, subtle borders – an even lighter presence than Pewter, indicating non-primary elements. |
...
| --- | --- | --- | --- | --- | --- |
| ui-sans-serif | system-ui, sans-serif | 400, 500, 600 | 14px, 16px, 18px, 24px | 1.00, 1.43, 1.50, 1.56 | Primary UI font for body text (14px, 16px), navigation labels (14px, 16px), and button text (14px, 16px). Its clarity and availability across platforms ensures consistent readability for core interactions. Headings use 24px weight 600 for emphasis, 18px and 14px uses weight 400 for sub-headings, body, and links. |
| OpenAI Sans | system-ui, sans-serif | 600 | 18px | 1.56 | Used for the primary prompt/headline in the main content area ('Where should we begin?'). Its distinct weight and slightly tighter letter spacing give it a refined, prominent voice that commands attention without being visually loud over other UI text. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775923550174-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775923550174-thumb.jpg |
