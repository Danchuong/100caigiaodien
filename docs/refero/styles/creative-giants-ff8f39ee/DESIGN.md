# Creative Giants — Refero Style

- Refero URL: https://styles.refero.design/style/ff8f39ee-a10e-4a9d-a94d-6993c6084060
- Site URL: https://www.creativegiants.art
- ID: ff8f39ee-a10e-4a9d-a94d-6993c6084060
- Theme: light
- Industry: agency
- Created: 2026-04-01T20:08:57.000Z
- Ranks: newest: 967, popular: 261, trending: 264
...
| --- | --- | --- | --- | --- | --- |
| Switzer | system-ui, sans-serif | 300, 400 | 12px, 14px, 16px, 18px, 20px, 34px, 54px, 64px, 84px | 1.00, 1.25, 1.40, 1.43 | All textual content: body, headings, links, buttons. The custom font provides a unique structural clarity, while varied weights and careful negative letter-spacing for larger sizes prevent it from feeling too rigid, adding a refined, almost architectural feel. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1776009253389-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1776009253389-thumb.jpg |
