# Jacquemus — Refero Style

- Refero URL: https://styles.refero.design/style/0d03310d-bff2-45af-b599-cffd5c41f884
- Site URL: https://jacquemus.com
- ID: 0d03310d-bff2-45af-b599-cffd5c41f884
- Theme: light
- Industry: ecommerce
- Created: 2026-03-10T12:56:47.000Z
- Ranks: newest: 1064, popular: 570, trending: 711
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Pure White | #ffffff | neutral | Page backgrounds, primary surfaces. |
| Ink Black | #000000 | neutral | Primary text, essential outlines, logo text. Creates a strong, uncompromising focal point against Pure White. |
| Charcoal Grey | #2e2e2 | neutral | Secondary brand elements, illustrations, subtle borders and fills. Offers a slightly softer alternative to Ink Black without losing impact. |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Futura PTT | Futura, 'Trebuchet MS', sans-serif | 400 | 10px, 18px | 1.11, 2.00 | All text content: logo, body copy, maintenance messages. The uniform usage of a single, well-spaced, geometric sans-serif typeface maintains a consistent, refined brand voice, prioritizing clarity and precision over stylistic variation. The wide letter-spacing at smaller sizes is a deliberate choice to enhance readability and give a premium feel. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775926234946-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775926234946-thumb.jpg |
