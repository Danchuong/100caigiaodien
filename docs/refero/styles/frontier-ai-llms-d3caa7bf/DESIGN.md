# Frontier AI LLMs — Refero Style

- Refero URL: https://styles.refero.design/style/d3caa7bf-2e2e-489a-845d-5cab274e7a92
- Site URL: https://mistral.ai
- ID: d3caa7bf-2e2e-489a-845d-5cab274e7a92
- Theme: light
- Industry: ai
- Created: 2026-03-30T16:15:55.000Z
- Ranks: newest: 975, popular: 243, trending: 230
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Desert Canvas | #fffaeb | neutral | Primary page background, text container background — provides a warm, sandy base. |
| Midnight Ink | #1f1f1f | neutral | Primary text color for headings and body content, navigation elements, high-contrast buttons — a deep, rich black. |
| Snowdrift | #ffffff | neutral | Button text on dark backgrounds, selected navigation states, specific content blocks. |
| Void Deep | #000000 | neutral | Hover background for buttons, borders for high-contrast elements. |
| Graphite | #3c3c3c | neutral | Secondary text, muted links, subtle button borders. |
| Sandstone Slab | #fff0c2 | neutral | Secondary background color for UI elements, subtle dividers, accent areas. |
| Pale Ochre | #ecdaa2 | neutral | Border color for subtle containers or interactive elements. |
| Horizon Gradient | #b35d20 | brand | Hero background, creating an atmospheric, expansive focal point. |
| Frontier Accent | #fa520f | accent | Accent color for icons, interactive indicators, subtle highlights, and brand presence — a vivid, almost neon orange. |
| Golden Streak | #ffd900 | accent | Decorative background color, likely for abstract graphics or very subtle brand elements. |
| Sunbeam | #ffae00 | accent | Decorative background color, likely for abstract graphics or very subtle brand elements. |
| Faded Red | #e00400 | accent | Decorative background color, likely for abstract graphics or very subtle brand elements. |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Arial | Helvetica Neue, sans-serif | 400 | 14px, 16px, 24px, 32px, 38px, 48px, 56px, 82px | 0.95, 1.00, 1.15, 1.33, 1.43, 1.50 | Primary typeface for all textual content. Its neutral, sans-serif character supports the technical focus while the slightly negative letter spacing for larger sizes creates a refined, impactful presence despite the classic font choice. Used for headlines, body text, buttons, and navigation. |
...
| body | 16 | 1.5 | -0.48 |
| subheading | 24 | 1.33 | -0.72 |
| heading | 32 | 1.15 | -0.96 |
| heading-lg | 38 | 1.15 | -1.14 |
| display | 48 | 1 | -1.44 |
| display-lg | 56 | 0.95 | -1.68 |
| display-xl | 82 | 0.95 | -2.46 |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1776125037404-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1776125037404-thumb.jpg |
| preview video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/d3caa7bf-2e2e-489a-845d-5cab274e7a92-1777583994314-preview.mp4 |
| preview video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/d3caa7bf-2e2e-489a-845d-5cab274e7a92-1777583994314-preview-poster.jpg |
| detail video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/d3caa7bf-2e2e-489a-845d-5cab274e7a92-1777583994314-preview-detail.mp4 |
| detail video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/d3caa7bf-2e2e-489a-845d-5cab274e7a92-1777583994314-preview-detail-poster.jpg |
