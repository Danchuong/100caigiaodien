# Eduardo del Fraile — Refero Style

- Refero URL: https://styles.refero.design/style/e11be5e4-cd8f-410e-bfe1-8763ed62fac3
- Site URL: https://www.eduardodelfraile.com
- ID: e11be5e4-cd8f-410e-bfe1-8763ed62fac3
- Theme: dark
- Industry: design
- Created: 2026-04-30T03:49:25.827Z
- Ranks: newest: 53, popular: 1209, trending: 1164
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Void Black | #000000 | neutral | Page background, primary canvas, content backdrop, providing infinite depth for product photography |
...
| Muted Gray | #888888 | neutral | Secondary text, helper messages, less prominent links — a softer, less assertive contrast than Ghost White |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| AkzidenzGrotesk | Inter | 400, 700 | 14px, 15px, 20px, 21px | 1.30 | The primary typeface for all textual content, including navigation and body text. Its clean, sans-serif lines support legibility without distracting from the visual content. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777520952219-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777520952219-thumb.jpg |
