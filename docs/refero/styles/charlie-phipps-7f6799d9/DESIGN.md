# Charlie Phipps — Refero Style

- Refero URL: https://styles.refero.design/style/7f6799d9-0733-4523-9a94-036b9ad3bf28
- Site URL: https://phippscharlie.com
- ID: 7f6799d9-0733-4523-9a94-036b9ad3bf28
- Theme: dark
- Industry: design
- Created: 2026-04-30T03:30:41.117Z
- Ranks: newest: 134, popular: 784, trending: 675
...
| --- | --- | --- | --- | --- | --- |
| Helvetica Neue | Arial, Helvetica | 400 | 16px, 17px, 19px, 21px, 52px, 64px, 162px | 0.90, 1.00, 1.20 | The primary sans-serif for headlines, body text, and interactive elements. Its neutral character provides clarity and adapts to varying scale and tracking for distinct hierarchal purposes. |
| Times | Times New Roman | 400 | 13px | 1.20 | A serif font used sparingly for atmospheric, smaller captions and metadata, providing a touch of classic contrast against the sans-serif dominance. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777519822891-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777519822891-thumb.jpg |
