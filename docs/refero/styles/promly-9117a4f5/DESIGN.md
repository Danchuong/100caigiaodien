...
- Refero URL: https://styles.refero.design/style/9117a4f5-6171-44ad-aa85-a387a5d80620
- Site URL: https://promlyapp.com
- ID: 9117a4f5-6171-44ad-aa85-a387a5d80620
- Theme: dark
- Industry: other
- Created: 2026-04-30T03:17:13.134Z
- Ranks: newest: 190, popular: 923, trending: 840
...
| --- | --- | --- | --- | --- | --- |
| Avenir | Avenir Next, Lato | 300, 400, 700 | 14px, 16px, 18px, 20px, 25px, 28px, 35px, 45px, 59px, 60px, 64px | 1.07, 1.11, 1.17, 1.25, 1.36, 1.39, 1.40, 1.43, 1.50, 1.57, 1.69 | Primary typeface for all headings, body text, and UI elements. Its clean sans-serif nature provides clarity against dark backgrounds, with a range of weights supporting hierarchy. Tighter tracking on larger headings enhances their presence without overwhelming. |
| Poppins | Montserrat, Open Sans | 700 | 18px | 1.50 | Used for specific button labels, adding a slightly more assertive, block-like feel to calls to action. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777519002768-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777519002768-thumb.jpg |
