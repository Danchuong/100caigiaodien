...
- Refero URL: https://styles.refero.design/style/40030487-56e3-447d-904f-b955ebadd0b5
- Site URL: https://twitch.tv
- ID: 40030487-56e3-447d-904f-b955ebadd0b5
- Theme: light
- Industry: media
- Created: 2026-04-07T09:27:45.000Z
- Ranks: newest: 944, popular: 513, trending: 674
...
| --- | --- | --- | --- | --- | --- |
| Inter | system-ui | 400, 600 | 11px, 12px, 14px | 1.00, 1.10, 1.20, 1.40, 1.50, 1.60 | General body text, navigation items, badges, captions, and most UI elements. Its neutrality allows content to dominate. |
| Roobert | system-ui | 400, 500, 600 | 14px, 18px | 1.10, 1.40 | For key headings and prominent links, where a slightly more custom, structured feel is desired. The moderate letter-spacing creates a compact, modern appearance. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1776105296205-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1776105296205-thumb.jpg |
