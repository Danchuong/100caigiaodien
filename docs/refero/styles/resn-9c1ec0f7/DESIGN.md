...
- Refero URL: https://styles.refero.design/style/9c1ec0f7-f6fb-4388-9fde-760942dedbda
- Site URL: https://resn.co.nz
- ID: 9c1ec0f7-f6fb-4388-9fde-760942dedbda
- Theme: dark
- Industry: agency
- Created: 2026-02-28T10:33:18.000Z
- Ranks: newest: 1111, popular: 667, trending: 853
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Absolute Zero | #000000 | neutral | Primary text, interactive elements in light themes, background and borders for high-contrast sections. |
| Abyssal Night | #141214 | neutral | Dominant background color for the overall page, providing a dark canvas that's just off-black. |
| Polar White | #ffffff | neutral | Primary text on dark backgrounds, active states, and borders against dark elements. |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| sans-serif | Arial, Helvetica | 400 | 9px | 1.20 | Default system fallback for most body text and UI elements, used when 'Fort-Medium' is not specified. |
| Fort-Medium | Montserrat, Open Sans | 400 | 10px | 2.00 | Distinctive typeface for links and small body text, providing a monospace-like, technical feel with generous letter spacing that enhances its graphic presence. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775925510935-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775925510935-thumb.jpg |
