# Studio Gruhl — Refero Style

- Refero URL: https://styles.refero.design/style/9e3fde24-cc7d-4b96-a70a-7c172882aa8f
- Site URL: https://www.studiogruhl.com
- ID: 9e3fde24-cc7d-4b96-a70a-7c172882aa8f
- Theme: dark
- Industry: design
- Created: 2026-04-30T02:09:18.005Z
- Ranks: newest: 431, popular: 859, trending: 819
...
| --- | --- | --- | --- | --- | --- |
| GreedStandard | Helvetica Neue | 400, 700 | 10px, 15px, 16px, 80px | 1.00, 1.15, 1.20 | Dominant typeface for all headings, navigation, and most body text. Its sharp, custom character defines the brand's direct and impactful voice. |
| Arial | Arial | 400 | 13px | 1.20 | Used for specific functional elements like subtle button labels or minor navigation items, providing a standard, legible counterpoint to GreedStandard. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777514938880-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777514938880-thumb.jpg |
