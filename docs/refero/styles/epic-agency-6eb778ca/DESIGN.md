# EPIC agency — Refero Style

- Refero URL: https://styles.refero.design/style/6eb778ca-6808-4cc6-ac8a-7beea5a25c36
- Site URL: https://epic.net
- ID: 6eb778ca-6808-4cc6-ac8a-7beea5a25c36
- Theme: dark
- Industry: agency
- Created: 2026-02-09T11:36:00.000Z
- Ranks: newest: 1214, popular: 499, trending: 654
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Nebula Violet | #271a47 | brand | Page backgrounds, section surfaces, primary interactive button fills. |
| Stardust Shimmer | #dbc9ff | brand | Primary text color for headlines and body, interactive button text, icon outlines — providing high contrast against the dark background. |
| Cosmos Black | #000000 | neutral | Used for specific interactive elements such as `Play Video` button background and text, creating isolated points of absolute darkness. |
| Galactic Gold | #bc994 | accent | Used for secondary links and iconic accents, signaling complementary information or actions without competing with primary CTAs. |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Inter | Inter | 400, 600, 700 | 10px, 11px, 13px, 14px, 16px, 18px | 1.00, 1.33, 1.40, 1.56, 1.65, 1.70, 3.00 | Primary body text, navigation elements, button labels, and secondary interactive components. Its precise metrics ensure readability even at smaller sizes, contrasting with the more decorative display font. |
| Sang Bleu | Playfair Display | 400, 700, 900 | 42px, 80px, 120px | 1.00, 1.20, 1.65 | Display headlines and hero text. This custom, highly stylized serif font provides the primary visual identity, signaling sophistication and unique brand voice through its generous sizing and elegant forms. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775925163303-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775925163303-thumb.jpg |
