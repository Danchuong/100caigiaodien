...
- Refero URL: https://styles.refero.design/style/ff4b9eff-dc0b-4886-bd65-c2f5e9069318
- Site URL: https://henry.codes
- ID: ff4b9eff-dc0b-4886-bd65-c2f5e9069318
- Theme: light
- Industry: design
- Created: 2026-04-30T03:27:37.213Z
- Ranks: newest: 147, popular: 611, trending: 416
...
| --- | --- | --- | --- | --- | --- |
| Neue Montreal | Inter | 400, 700 | 12px, 16px, 20px, 24px, 32px | 1.00, 1.10, 1.20, 1.50 | Primary text, navigation links, body content, and smaller headings. Its contemporary sans-serif form provides clear readability amidst the otherwise stylized design. |
| Louize Display | Anton | 400 | 32px, 35px, 77px, 116px, 126px, 132px | 0.80, 0.90, 1.10, 1.20 | Large, impactful headlines with a distressed, condensed serif character, used to create a strong, almost confrontational visual presence. |
| Louize | Merriweather |  | 16px, 20px, 24px | 1.20, 1.30 | Complementary serif for body text and emphasized statements within more traditional paragraphs, bringing a classic but slightly rugged touch. |
| Manuka | Oswald | 400 | 226px, 371px | 0.75, 0.80 | Overlays and background decorative text elements, used at extremely large scales for atmospheric effect, often partially obscured. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777519635411-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777519635411-thumb.jpg |
