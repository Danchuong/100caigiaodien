...
- Refero URL: https://styles.refero.design/style/13b74e34-b824-4d1d-bd2c-bb9bfbc2d6e1
- Site URL: https://spacex.com
- ID: 13b74e34-b824-4d1d-bd2c-bb9bfbc2d6e1
- Theme: dark
- Industry: other
- Created: 2026-03-04T19:55:18.000Z
- Ranks: newest: 1093, popular: 344, trending: 309
...
| --- | --- | --- | --- | --- | --- |
| D-DIN | Arial, sans-serif | 400, 700 | 10px, 12px, 13px, 16px | 0.94, 1.00, 1.20, 1.50, 1.70, 2.00 | Primary text font for body, navigation, buttons, and most informational elements. Its wide tracking at smaller sizes enforces legibility in a dark UI, creating a precise, technical feel. |
| D-DIN-Bold | Arial Bold, sans-serif | 400 | 48px | 1.00, 1.25 | Used exclusively for prominent headings. Despite being 'bold', its weight is 400 (normal) and the reduced letter-spacing compared to the regular D-DIN, combined with the large size, creates a strong, commanding presence without shouting. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775924876819-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775924876819-thumb.jpg |
