...
- Refero URL: https://styles.refero.design/style/8f623d19-51f6-4da2-bc45-05573cc98283
- Site URL: https://runwayml.com
- ID: 8f623d19-51f6-4da2-bc45-05573cc98283
- Theme: light
- Industry: ai
- Created: 2026-02-01T09:33:10.000Z
- Ranks: newest: 1244, popular: 493, trending: 646
...
| --- | --- | --- | --- | --- | --- |
| abcNormal | Inter, Arial | 400, 450, 500, 600 | 11px, 13px, 14px, 16px, 20px, 24px, 36px, 40px, 48px | 1.00, 1.10, 1.25, 1.30, 1.43, 1.50 | The primary typeface for all text content. Its variable weights from 400 to 600, combined with precise negative letter-spacing, create a distinctive sophisticated technical aesthetic, particularly noticeable in headlines where tight kerning conveys a sense of crafted precision. The wide range of sizes ensures scalability from fine print to large display headings. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775923602945-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775923602945-thumb.jpg |
