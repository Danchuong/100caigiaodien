# Champions4good — Refero Style

- Refero URL: https://styles.refero.design/style/e02671e1-ba31-465f-bb7f-b124bf91ab5e
- Site URL: https://www.champions4good.club
- ID: e02671e1-ba31-465f-bb7f-b124bf91ab5e
- Theme: dark
- Industry: other
- Created: 2026-04-01T11:11:30.000Z
- Ranks: newest: 970, popular: 491, trending: 779
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Royal Plum | #23002b | brand | Page background, significant content blocks — establishes the primary dark theme with a distinct chromatic depth. |
| Hot Pink | #e894ff | accent | Interactive elements like buttons and toggles, highlighted text, card backgrounds — provides a high-contrast accent that feels dynamic and modern. |
| Neon Green | #93ffe4 | accent | Decorative text, subtle accents, highlighting — a vivid, cool counterpoint to the warm pink and deep purple. |
| Sunburst Orange | #ffac47 | accent | Alternative decorative text, secondary highlights — adds another layer of vivid chromatic energy, often seen in headlines. |
| Forest Shard | #002629 | brand | Specific card backgrounds, alternate content areas — introduces a very dark, desaturated teal as a subtle variation in background texture. |
| Espresso Chip | #291900 | brand | Specific card backgrounds, alternate content areas — a very dark, desaturated brown providing another distinct tonal background. |
| Ink Black | #121212 | neutral | Primary body text, headers on light backgrounds — provides strong contrast while avoiding absolute #000. |
| Pure White | #ffffff | neutral | Text on dark backgrounds, icons — ensures maximum readability against the brand's deep chromatic backgrounds. |
| Graphite | #333333 | neutral | Secondary text, subtle borders, some UI elements in light contexts. |
| Deep Plum | #db99f7 | accent | Stroke color for outlined elements, subtle graphical details. |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Druk Condensed Super Desktop | Anton | 400, 500 | 24px, 29px, 32px, 43px, 44px, 151px, 187px, 317px | 0.78, 0.85, 1.00 | Display headlines and hero text — its condensed, heavy-set nature screams attention and is the primary driver of the system's bold, declarative tone. |
| Neue Montreal | Inter | 400, 500, 600 | 12px, 14px, 15px, 16px, 58px | 1.00, 1.10, 1.20, 1.30, 1.40, 1.43 | Body text, navigation, and input labels — a modern, geometric sans-serif that provides clarity and a modern edge, contrasting with the loudness of Druk. Negative letter-spacing keeps it tight and contemporary. |
| Arial | Arial | 400 | 14px | 1.43 | Fallback and minimal UI elements — for high readability in small contexts or as a general system fallback. |
...
| --- | --- | --- | --- |
| heading-sm | 24 | 0.85 |  |
| heading | 44 | 0.85 | 0.005 |
| heading-lg | 58 | 1.1 | -0.48 |
| display | 317 | 0.78 | 0.008 |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1776007947245-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1776007947245-thumb.jpg |
