...
- Refero URL: https://styles.refero.design/style/f89bad29-019a-48d7-9724-c40a0d7d8171
- Site URL: https://legora.com
- ID: f89bad29-019a-48d7-9724-c40a0d7d8171
- Theme: light
- Industry: ai
- Created: 2026-04-30T00:28:01.130Z
- Ranks: newest: 792, popular: 111, trending: 84
...
| --- | --- | --- | --- | --- | --- |
| sans-serif | Arial, Helvetica | 400 | 12px | 1.20 | System fallback for small UI elements and utility text. |
| Suisse Intl Book | Inter | 450 | 11px, 13px, 14px, 16px | 0.80, 1.25, 1.30 | Primary body text, labels, and paragraph content. The 'Book' weight at 450 provides a substantial yet refined feel. Its specific font features ('blwf', 'cv03', 'cv04', 'cv09', 'cv11') are critical for the brand's typographic identity. |
| Aktiv Grotesk VF Variable Regular | Inter | 400 | 15px, 20px | 1.30 | Subheadings and supporting headlines in product descriptions. The regular weight keeps it grounded. |
| Rhymes Display Light | Lora | 300 | 24px, 32px, 88px | 0.95, 1.10 | Emphasis headlines. The highly distinctive 'Light' weight (300) for large display sizes creates an unusually refined and open feel, conveying authority through restraint rather than boldness. |
| Playfair Display | Playfair Display | 400 | 80px | 1.00 | Prominent display headlines, particularly the main hero title. Its serif elegance adds a touch of classic sophistication. |
| Inter | Inter | 400 | 12px | 1.20 | Secondary utility text and metadata, providing a clear sans-serif contrast. |
| Suisse Intl Medium | Inter | 500 | 13px | 1.00 | Input labels and placeholder text, providing clear readability. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777508844863-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777508844863-thumb.jpg |
