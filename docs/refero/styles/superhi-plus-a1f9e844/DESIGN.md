# SuperHi Plus — Refero Style

- Refero URL: https://styles.refero.design/style/a1f9e844-c4b6-4526-9cfc-81208c50aee1
- Site URL: https://superhi.plus
- ID: a1f9e844-c4b6-4526-9cfc-81208c50aee1
- Theme: dark
- Industry: other
- Created: 2026-04-30T01:20:56.073Z
- Ranks: newest: 624, popular: 1011, trending: 1039
...
| --- | --- | --- | --- | --- | --- |
| Haas Grot Disp Web | Inter | 400 | 16px, 18px, 24px, 32px, 42px, 56px, 85px | 1.13, 1.14, 1.20, 1.25, 1.33, 1.50 | The singular typeface for all content, from headlines to body text. Its simplicity and compact letterforms contribute to the brand's direct and digital aesthetic. All text maintains a weight of 400, relying on size and color for hierarchy. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777512035493-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777512035493-thumb.jpg |
