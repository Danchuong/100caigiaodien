# Lattice — Refero Style

- Refero URL: https://styles.refero.design/style/cbb335e5-c8df-49be-a0fc-0ec5dfa0d61f
- Site URL: https://lattice.com
- ID: cbb335e5-c8df-49be-a0fc-0ec5dfa0d61f
- Theme: light
- Industry: saas
- Created: 2026-04-30T00:33:58.011Z
- Ranks: newest: 762, popular: 678, trending: 492
...
| --- | --- | --- | --- | --- | --- |
| Matter | Inter | 400, 500 | 11px, 13px, 14px, 16px, 17px, 18px, 19px, 22px, 47px, 72px | 0.90, 1.00, 1.10, 1.20, 1.30 | Primary typeface for all textual content, from headings to body text. Its crisp, modern lines establish a professional yet approachable tone. The tight letter tracking at larger sizes maintains visual density, while its consistent presence underpins the brand's direct communication style. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777509200621-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777509200621-thumb.jpg |
