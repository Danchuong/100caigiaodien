...
- Refero URL: https://styles.refero.design/style/d417b42f-824d-45ba-a02e-cbef3b8ea0d8
- Site URL: https://framer.com
- ID: d417b42f-824d-45ba-a02e-cbef3b8ea0d8
- Theme: dark
- Industry: design
- Created: 2026-03-20T16:32:24.000Z
- Ranks: newest: 1015, popular: 19, trending: 60
...
| --- | --- | --- | --- | --- | --- |
| GT Walsheim Framer Medium | Montserrat | 500 | 110px | 0.85 | Display headline. Extremely large, tight kerning for maximum impact. |
| GT Walsheim Medium | Montserrat | 500 | 32px, 62px, 85px | 0.95, 1.00, 1.13 | Primary headings (H1-H3). Characterized by compact line height and slight negative letter-spacing for a bold, condensed feel. Features stylistic alternates and tabular numbers. |
| Mona Sans | Inter | 500 | 12px, 13px, 17px, 18px, 62px | 1.00, 1.20, 1.30, 1.70, 2.28 | Secondary headings (H4-H6). Offers a more neutral counterpart to GT Walsheim for less prominent titles. |
| Inter Variable | Inter | 400 | 8px, 12px, 13px, 14px, 15px, 18px, 24px | 0.80, 1.00, 1.07, 1.20, 1.30, 1.40 | Body text, subheadings, labels. Highly versatile with broad stylistic controls, ensuring clarity across various information densities. Features a wide range of stylistic sets. |
| Inter | Inter | 400, 500, 600, 700 | 10px, 12px, 13px, 14px, 15px, 16px, 20px, 22px | 0.83, 1.00, 1.10, 1.15, 1.20, 1.30, 1.40, 1.60 | Paragraphs, navigation, general UI text. Provides robust readability with specific handling for tabular numbers and stylistic alternates. |
| Open Runde | Varela Round | 600 | 9px | 1.11 | Fine print, metadata. Distinctive small-caps style via stylistic sets. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1776081981265-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1776081981265-thumb.jpg |
| preview video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/d417b42f-824d-45ba-a02e-cbef3b8ea0d8-1777555555669-preview.mp4 |
| preview video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/d417b42f-824d-45ba-a02e-cbef3b8ea0d8-1777555555669-preview-poster.jpg |
| detail video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/d417b42f-824d-45ba-a02e-cbef3b8ea0d8-1777555555669-preview-detail.mp4 |
| detail video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/d417b42f-824d-45ba-a02e-cbef3b8ea0d8-1777555555669-preview-detail-poster.jpg |
