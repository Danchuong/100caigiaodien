...
- Refero URL: https://styles.refero.design/style/1a03b8d7-9204-4c16-ad3c-16306f99fba9
- Site URL: https://clay.earth
- ID: 1a03b8d7-9204-4c16-ad3c-16306f99fba9
- Theme: dark
- Industry: productivity
- Created: 2026-04-30T00:46:38.424Z
- Ranks: newest: 701, popular: 372, trending: 250
...
| --- | --- | --- | --- | --- | --- |
| Verlag | Inter | 400, 600, 700 | 9px, 10px, 12px, 14px, 16px, 18px, 20px | 1.00, 1.10, 1.33, 1.35, 1.38, 1.40, 1.50, 1.69, 2.25, 2.70, 3.00 | Primary text and UI elements. The narrow letter spacing ensures high information density even at smaller sizes in the dark UI. This font is custom, providing a unique, compact 'typewriter' feel. |
| VerlagCondensed | Oswald | 700, 900 | 48px, 64px | 1.00 | Display headlines. The condensed nature and heavy weights provide strong impact and directness, contrasting with the more restrained body text. The tight line height emphasizes the single phrase. |
| ChronicleTextG1Roman | Lora | 400 | 22px | 1.55 | Specialized editorial headings or pull quotes. This serif font adds a touch of classic sophistication, providing a visual break from the sans-serif system to highlight key content with a more traditional voice. |
| system-ui | sans-serif | 500, 600 | 10px, 14px, 15px | 1.14, 1.33, 2.00 | Fallback and utilitarian text where system rendering is prioritized for small labels and tooltips. The wider letter-spacing at smaller sizes improves legibility. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777509968405-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777509968405-thumb.jpg |
