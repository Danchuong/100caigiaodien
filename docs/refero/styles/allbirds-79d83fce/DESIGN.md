# Allbirds — Refero Style

- Refero URL: https://styles.refero.design/style/79d83fce-84bf-4e12-8039-5d283c98917c
- Site URL: https://allbirds.com
- ID: 79d83fce-84bf-4e12-8039-5d283c98917c
- Theme: light
- Industry: ecommerce
- Created: 2026-01-30T11:09:43.000Z
- Ranks: newest: 1257, popular: 391, trending: 974
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Black Ink | #000000 | neutral | Primary text, brand accents, button text on light backgrounds, borders. |
| White Linen | #ffffff | neutral | Page backgrounds, card surfaces, button backgrounds, text on dark backgrounds. |
| Charcoal Slate | #212121 | neutral | Secondary text, dark button backgrounds, navigation elements, subtle borders. |
| Warm Mist | #e0dacf | neutral | Subtle section backgrounds, atmospheric accents maintaining a light theme. |
| Storm Gray | #525252 | neutral | Muted secondary text, outlines, and subtle shadows. |
| Muted Olive | #222519 | neutral | Background for specific product sections, offering slight earthy contrast. |
| Desert Clay | #a57e75 | brand | Product background swatches, indicating natural tones. |
| Sky Dust | #879aab | brand | Product background swatches, introducing a cool, soft hue. |
| Sandstone Tan | #d1b0a4 | brand | Product background swatches, a light, earthy neutral. |
| Sunlit Ochre | #9e8949 | brand | Product background swatches, a warm and inviting accent. |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Geograph | Inter | 400, 500, 700 | 12px, 14px, 16px, 20px, 24px | 1.00, 1.25, 1.33, 1.40, 1.43, 1.50, 1.67 | Primary UI font for body text, navigation, buttons, and general informational display. Its clean geometric shape ensures readability across various sizes, anchoring the user interface. |
| Self Modern | Playfair Display | 400 | 18px, 40px | 1.00, 1.20, 1.50, 1.78 | Used for distinctive, editorial-style headlines and display text, particularly 'Bold By Nature'. Its traditional serif form provides a contrast to the sans-serif, adding a touch of sophisticated naturalism. |
| HurmeGeometricSans3-Regular | Montserrat | 400 | 14px | 1.14 | Limited use, primarily for specific button text where a slightly more open, geometric feel is desired, reinforcing the modern and clean aesthetic. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775924481316-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775924481316-thumb.jpg |
| preview video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/79d83fce-84bf-4e12-8039-5d283c98917c-1777561466604-preview.mp4 |
| preview video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/79d83fce-84bf-4e12-8039-5d283c98917c-1777561466604-preview-poster.jpg |
| detail video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/79d83fce-84bf-4e12-8039-5d283c98917c-1777561466604-preview-detail.mp4 |
| detail video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/79d83fce-84bf-4e12-8039-5d283c98917c-1777561466604-preview-detail-poster.jpg |
