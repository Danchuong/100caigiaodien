...
- Refero URL: https://styles.refero.design/style/0dad8530-9422-4d9e-8622-1f50ee4bc702
- Site URL: https://klim.co.nz
- ID: 0dad8530-9422-4d9e-8622-1f50ee4bc702
- Theme: dark
- Industry: design
- Created: 2026-04-30T03:34:36.029Z
- Ranks: newest: 123, popular: 1148, trending: 1103
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Pitch Black | #000000 | neutral | Primary page background, text on light surfaces, filled button backgrounds. Creates a strong, confident base for content |
| Ghost Gray | #555555 | neutral | Subtle border colors for outlined elements and cards, secondary body text on dark backgrounds. Softer contrast for less prominent information |
| Input Dark | #1c1c1c | neutral | Background for input fields and other utility UI elements. Darker than base background to suggest interactivity |
| Text White | #ffffff | neutral | Primary text color, outlined button borders, element borders on dark backgrounds. Ensures high readability against dark surfaces |
| Ocean Blue | #24a7f2 | accent | Highlight accents for interactive elements and call-to-action backgrounds, used sparingly to draw focus |
| Forest Green | #3c585f | accent | Alternative highlight accent for interactive elements and call-to-action backgrounds. Provides variety while maintaining saturation |
| Fire Orange | #d33c03 | accent | Accent color for interactive elements, links, and highlighted content. A vibrant, warm pop against the dark theme |
| Vivid Red | #e90702 | accent | Link color for specific emphasized text elements |
| Neon Teal | #93ffe6 | accent | Link color for specific emphasized text elements |
| Muted Peach | #ffe6d9 | accent | Link color for specific emphasized text elements |
| Lemon Yellow | #ffff79 | accent | Link color for specific emphasized text elements |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| SOEHNE | Inter | 400, 700 | 16px, 36px | 0.98, 1.19, 1.20, 1.33, 1.50 | Primary typeface for all UI elements, body text, and some headings. Its clean, geometric form provides a contemporary feel and excellent readability across various weights and sizes. Weight 700 is reserved for strong emphasis and certain navigational elements, while 400 is the workhorse. |
| SOEHNE_IKON | Inter | 400 | 16px | 1.20, 1.33, 1.50 | Specialized variant of Soehne, likely for icon-like characters or specific display elements. Used minimally, maintaining character of the main typeface while allowing for specific glyphs. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777520054937-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777520054937-thumb.jpg |
