# Factory.ai — Refero Style

- Refero URL: https://styles.refero.design/style/13d6fc89-eba2-4724-ac37-20f4f2e5efec
- Site URL: https://factory.ai
- ID: 13d6fc89-eba2-4724-ac37-20f4f2e5efec
- Theme: light
- Industry: ai
- Created: 2026-04-02T09:25:14.000Z
- Ranks: newest: 965, popular: 230, trending: 238
...
| --- | --- | --- | --- | --- | --- |
| Geist | Inter | 400 | 14px, 16px, 18px, 24px, 48px, 60px | 1.00, 1.20, 1.50 | Primary typeface for all headings, body text, navigation, and general UI. The carefully tuned negative letter-spacing, particularly at larger sizes, creates a composed, intentional feel, preventing headlines from feeling loose. |
| Geist Mono | JetBrains Mono | 400 | 12px, 14px, 16px, 18px | 1.00, 1.20, 1.38, 1.50 | Used for code snippets, CLI instructions, and any content requiring a fixed-width, precise presentation. Its subtle negative letter-spacing maintains a tight, readable block structure. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775932553513-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775932553513-thumb.jpg |
