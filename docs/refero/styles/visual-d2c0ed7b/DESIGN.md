...
- Refero URL: https://styles.refero.design/style/d2c0ed7b-c649-4d77-91de-1bd69dd10a9e
- Site URL: https://designstripe.com
- ID: d2c0ed7b-c649-4d77-91de-1bd69dd10a9e
- Theme: light
- Industry: ai
- Created: 2026-04-30T02:23:31.042Z
- Ranks: newest: 382, popular: 237, trending: 146
...
| --- | --- | --- | --- | --- | --- |
| fontSerif | Playfair Display | 300, 400 | 24px, 32px, 48px, 64px, 96px | 0.94, 1.00, 1.13 | Primary headings and large display text. The low weights (300, 400) give an authoritative yet approachable feel, avoiding the harshness of bold serif headlines. |
| fontMono | IBM Plex Mono | 300, 400, 500 | 12px, 14px, 16px, 20px, 28px, 48px | 1.00, 1.33, 1.41, 1.50 | Body text, navigation, buttons, and all functional interface elements. The monospaced feel adds a technical, precise undertone without sacrificing readability, especially at smaller sizes. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777515757469-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777515757469-thumb.jpg |
