# KidSuper World — Refero Style

- Refero URL: https://styles.refero.design/style/5f953a7e-c8e9-4e71-872f-4e7ffb7e7264
- Site URL: https://kidsuper.world
- ID: 5f953a7e-c8e9-4e71-872f-4e7ffb7e7264
- Theme: light
- Industry: agency
- Created: 2026-03-24T16:25:40.000Z
- Ranks: newest: 1003, popular: 569, trending: 603
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Canvas White | #ffffff | neutral | Primary background for all pages, providing a clean, almost tactile surface for content. Its pervasive use reinforces the sketchbook analogy. |
| Ink Black | #000000 | neutral | Used for all text, borders, and interactive elements, mirroring the mark-making of pen on paper. This stark contrast ensures readability against the bright background. |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Abc Diatype Mono | Space Mono | 400, 500 | 12px, 16px | 1.00, 1.15, 1.20, 1.30 | Primary typeface for body text, navigation items, buttons, and footers. Its monospaced nature contributes to the raw, code-like, or journal entry feel, deliberately sacrificing some traditional readability for distinct brand character. It lends a utilitarian and precise tone to all textual content. |
| Neue Haas Grotesk Display | Helvetica Neue (Display) | 800 | 60px | 1.00 | Used exclusively for large, impactful headings. Its heavy weight and large size create a bold, almost stencil-like presence, contrasting with the subtlety of the monospaced text to deliver a direct, undeniable statement. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775926146585-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775926146585-thumb.jpg |
