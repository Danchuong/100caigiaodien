# Exhibition Magazine — Refero Style

- Refero URL: https://styles.refero.design/style/597355de-6167-4f37-8f14-b3897919a94c
- Site URL: https://exhibition-magazine.com
- ID: 597355de-6167-4f37-8f14-b3897919a94c
- Theme: light
- Industry: media
- Created: 2026-04-30T02:58:40.169Z
- Ranks: newest: 256, popular: 1051, trending: 1027
...
| --- | --- | --- | --- | --- | --- |
| Cochin | Georgia | 400 | 16px, 46px | 1.20, 1.50 | Primary body text and descriptive links. Its humanist serifs provide a classic, editorial feel against the modern sans-serifs, a deliberate contrast for readability and character. |
| DIN | Inter | 400 | 25px, 36px, 40px, 50px, 52px, 90px, 100px | 0.75, 0.80, 1.00, 1.20 | Dominant display typography for headings, titles, and calls to action. Its condensed, strong sans-serif form exudes a bold, confident voice, with tight letter-spacing enhancing its impact. |
| forma-djr-display | Roboto Mono | 500 | 13px | 1.60 | Small, highly tracked uppercase text for descriptors and meta-information. The wide letter-spacing adds a contemporary, functional touch for annotation. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777517891383-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777517891383-thumb.jpg |
