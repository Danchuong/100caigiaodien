...
- Refero URL: https://styles.refero.design/style/5d273906-0110-48cf-99cd-63a72eb9c586
- Site URL: https://www.gte.xyz
- ID: 5d273906-0110-48cf-99cd-63a72eb9c586
- Theme: mixed
- Industry: fintech
- Created: 2026-04-30T00:23:48.067Z
- Ranks: newest: 812, popular: 666, trending: 450
...
| --- | --- | --- | --- | --- | --- |
| sans-serif | Arial | 400 | 12px | 1.20 | Smallest UI labels and utility text, defaulting to system sans-serif for optimal legibility at compact sizes. |
| Ogg Text Light | serif system font | 300, 400 | 28px, 40px, 80px | 0.95, 1.00, 1.10, 1.20 | Display and large headings. The light weight and calligraphic features ('blwf', 'cv03', 'cv04', 'cv09', 'cv11') convey a refined, authoritative tone, balancing the technical subject matter with an artisanal feel. |
| PP Supply Mono | monospace system font | 400, 500 | 18px | 1.20 | Subheadings, navigational links, and emphasized body text. Its monospaced nature evokes a programmatic, precise feel, reinforcing the core product identity. |
| Inter | Inter | 400, 500 | 12px, 14px, 16px, 18px | 1.00, 1.20, 1.30 | Body copy, input fields, and smaller informational text. Its clean, utilitarian nature ensures readability for dense information. |
| PP Supply Mono Regular |  | 400 | 14px, 16px | 1, 1.2, 1.4 | PP Supply Mono Regular — detected in extracted data but not described by AI |
| PP Supply Mono Medium |  | 400, 500 | 14px, 16px, 20px | 0.75, 1.1, 1.2, 1.4 | PP Supply Mono Medium — detected in extracted data but not described by AI |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777508598341-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777508598341-thumb.jpg |
