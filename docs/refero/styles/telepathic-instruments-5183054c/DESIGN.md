# Telepathic Instruments — Refero Style

- Refero URL: https://styles.refero.design/style/5183054c-4c6e-4ecf-bd90-f7d794d5eb17
- Site URL: https://telepathicinstruments.com
- ID: 5183054c-4c6e-4ecf-bd90-f7d794d5eb17
- Theme: light
- Industry: other
- Created: 2026-04-30T00:26:54.569Z
- Ranks: newest: 797, popular: 292, trending: 172
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Canvas | #e5e7eb | neutral | Page background, primary surface, subtle borders |
| Charcoal | #000000 | neutral | Primary text, solid button backgrounds, strong outlines, header bar background |
| Snow | #ffffff | neutral | Button text on dark backgrounds, card backgrounds, light text accents |
| Steel | #a3a3a3 | neutral | Muted text, secondary navigation, input borders, icon strokes |
| Ash | #191919 | neutral | Darker background accents, subtle fills in complex elements |
| Mercury | #c2c2c2 | neutral | Subtle background accents, dividers |
| Powder | #dddee2 | neutral | Light background accents, very subtle surface differentiators |
| Muted Sage | #d7cdb8 | neutral | Decorative graphical elements, subtle background textures |
| Amber Glow | #ff6c2f | brand | Orange action color for filled buttons, selected navigation states, and focused conversion moments. |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Suisse Intl | Inter | 400 | 12px, 16px, 18px, 20px, 24px, 100px | 0.85, 1.20, 1.25, 1.40, 1.50 | Primary text, headings, general UI labels. The tighter letter-spacing at larger sizes (-0.0300em for 100px) enhances its controlled, technical feel. |
| Suisse Intl Mono | JetBrains Mono | 400 | 12px, 14px, 16px | 1.00, 1.20, 1.25, 1.33, 1.43, 1.50 | Code snippets, data displays, subtle navigation items, input values. Its fixed-width nature reinforces the technical aesthetic. |
...
| body | 16 | 1.5 | 0 |
| subheading | 18 | 1.4 | 0 |
| heading-sm | 20 | 1.25 | 0 |
| heading | 24 | 1.2 | 0 |
| display | 100 | 0.85 | -0.03 |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777508789649-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777508789649-thumb.jpg |
