...
- Refero URL: https://styles.refero.design/style/f11750fc-d7c0-4d26-b32a-3b1d2098ae34
- Site URL: https://dji.com
- ID: f11750fc-d7c0-4d26-b32a-3b1d2098ae34
- Theme: light
- Industry: ecommerce
- Created: 2026-04-04T13:08:26.000Z
- Ranks: newest: 957, popular: 357, trending: 365
...
| --- | --- | --- | --- | --- | --- |
| Open Sans | system-ui, sans-serif | 300, 400, 500, 600 | 12px, 14px, 16px, 18px, 20px, 24px, 32px, 40px | 1.00, 1.10, 1.13, 1.17, 1.20, 1.25, 1.33, 1.43, 1.50, 2.00 | The primary typeface for all content, from navigation to body text and headings. Its clean, geometric forms provide excellent readability across various weights and sizes, supporting the tech-focused aesthetic. The varied letter-spacing at larger sizes adds a subtle sense of precision. |
| Arial | system-ui, sans-serif | 400 | 13px | 1.20 | Used for specific, small button texts, maintaining system-level legibility for minor controls. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775932957915-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775932957915-thumb.jpg |
