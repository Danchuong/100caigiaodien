# Airtable — Refero Style

- Refero URL: https://styles.refero.design/style/f4ef80f4-f6e5-4aea-8045-f99efaf208b8
- Site URL: https://airtable.com
- ID: f4ef80f4-f6e5-4aea-8045-f99efaf208b8
- Theme: light
- Industry: productivity
- Created: 2026-04-12T11:02:27.000Z
- Ranks: newest: 929, popular: 93, trending: 71
...
| --- | --- | --- | --- | --- | --- |
| Haas Groot Disp | IBM Plex Sans | 400, 900 | 20px, 48px | 1.50 | Headline font. Used for prominent headings and titles like 'All your teams, all their workflows'. The thick weight at 48px creates a bold, authoritative statement without being overly aggressive due to the spacious line height. |
| Haas | Inter | 400, 500, 600 | 14px, 16px, 18px, 20px, 24px, 32px, 40px | 1.15, 1.20, 1.25, 1.30, 1.35, 1.50 | Primary UI font for body text, navigation, and most interactive elements. Weight 400 maintains approachability. Sizes range from small captions to larger subheadings, ensuring versatility. Letter spacing is slightly positive on smaller text to enhance legibility, tightening to normal at larger sizes. |
| Haas | Inter | 400, 500, 600 | 14px, 16px, 18px, 20px, 24px, 32px, 40px | 1.15, 1.20, 1.25, 1.30, 1.35, 1.50 | Medium weight for secondary interactive elements, button text, and emphasized body copy. Provides a subtle distinction from regular body text without becoming too heavy. |
| Haas | Inter | 400, 500, 600 | 14px, 16px, 18px, 20px, 24px, 32px, 40px | 1.15, 1.20, 1.25, 1.30, 1.35, 1.50 | Semibold weight used for navigation headings, strong labels, and section titles where additional emphasis is paramount. It provides hierarchy and readability against lighter backgrounds. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1776119056975-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1776119056975-thumb.jpg |
