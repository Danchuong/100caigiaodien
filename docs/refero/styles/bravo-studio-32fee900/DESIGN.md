# BRAVÒ STUDIO — Refero Style

- Refero URL: https://styles.refero.design/style/32fee900-17a5-4753-b08d-3c73f2d2f71f
- Site URL: https://brv.studio
- ID: 32fee900-17a5-4753-b08d-3c73f2d2f71f
- Theme: dark
- Industry: media
- Created: 2026-04-30T03:01:27.031Z
- Ranks: newest: 247, popular: 550, trending: 340
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Plum Canvas | #4D004B | brand | Page background – creates a dark, theatrical stage for content, especially media |
| Ghostly Slate | #dedede | neutral | Primary text for navigation and informational elements, subtle borders |
| Pure White | #ffffff | neutral | High-contrast informational text, subtle borders, often used for header text against dark content sections |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| GTAmerica Condensed | IBM Plex Sans Condensed | 400 | 16px, 17px | 1.06, 1.20 | Used for all text, from navigation to body copy, maintaining a consistent, refined voice with its condensed form. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777518072911-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777518072911-thumb.jpg |
