# Smiling Wolf — Refero Style

- Refero URL: https://styles.refero.design/style/75be52f8-4dbe-45da-9a0e-a11bc92f6927
- Site URL: https://www.smilingwolf.co.uk
- ID: 75be52f8-4dbe-45da-9a0e-a11bc92f6927
- Theme: light
- Industry: agency
- Created: 2026-04-30T02:55:25.607Z
- Ranks: newest: 267, popular: 1188, trending: 1202
...
| --- | --- | --- | --- | --- | --- |
| Bagoss Standard | serif | 385, 400, 520 | 14px, 20px, 59px, 63px | 0.98, 1.00, 1.15, 1.40 | Primary headings and body text, conveying a distinctive and precise brand voice. The tight letter-spacing and custom features contribute to a refined, almost type-specimen feel. Weights 400 and 520 are used for prominent headings, while 385 is for lighter body text. |
| General Grotesque Mono | monospace | 400 | 9px, 10px | 1.60 | Small labels, metadata, and structured information where monospaced precision is desired. The generous letter-spacing enhances readability at small sizes. |
| sans-serif | Arial | 400 | 12px | 1.20 | System fallback for small utility text like navigation links or ancillary information where a robust, universally available sans-serif is appropriate. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777517703855-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777517703855-thumb.jpg |
