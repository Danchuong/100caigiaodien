# Playful — Refero Style

- Refero URL: https://styles.refero.design/style/f93ac72e-73b2-4b2c-80eb-351ddfa56f4d
- Site URL: https://playful.software
- ID: f93ac72e-73b2-4b2c-80eb-351ddfa56f4d
- Theme: light
- Industry: productivity
- Created: 2026-04-30T03:10:35.534Z
- Ranks: newest: 214, popular: 108, trending: 76
...
| --- | --- | --- | --- | --- | --- |
| Inter | system-ui, sans-serif | 400, 500, 600, 700, 900 | 14px, 16px, 18px, 26px, 30px, 70px, 79px | 1.00, 1.15, 1.19, 1.20, 1.23, 1.33, 1.70 | The primary typeface for all text. Its weights are used for impactful headlines at larger sizes and for clear, concise body text. The tight letter spacing for display sizes gives it a modern, compact feel. |
| Arial | Helvetica Neue, Helvetica, sans-serif | 400, 600, 700 | 13px, 15px, 16px, 20px | 1.20, 1.40 | Used for accessibility-focused elements like button labels and form inputs, providing robust legibility. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777518617395-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777518617395-thumb.jpg |
