# Stable Audio — Refero Style

- Refero URL: https://styles.refero.design/style/c363a216-873c-4112-b960-8e823db76f74
- Site URL: https://stableaudio.com
- ID: c363a216-873c-4112-b960-8e823db76f74
- Theme: light
- Industry: ai
- Created: 2026-04-06T10:24:47.000Z
- Ranks: newest: 948, popular: 585, trending: 883
...
| --- | --- | --- | --- | --- | --- |
| Inter | system-ui, sans-serif | 400, 700 | 12px, 14px, 16px, 18px, 20px, 30px, 40px | 1.00, 1.15, 1.33, 1.50, 1.71, 1.78 | The sole typeface, Inter, handles all text roles. Its variable weights provide flexibility, but the consistent family choice ensures cohesion. The subtle negative letter-spacing on larger sizes creates a tighter, more deliberate appearance, while standard spacing on smaller text maintains readability. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775932653717-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775932653717-thumb.jpg |
