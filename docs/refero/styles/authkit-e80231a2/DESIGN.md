# Authkit — Refero Style

- Refero URL: https://styles.refero.design/style/e80231a2-e4d6-406a-a2c9-2e6109679690
- Site URL: https://authkit.com
- ID: e80231a2-e4d6-406a-a2c9-2e6109679690
- Theme: dark
- Industry: devtools
- Created: 2026-02-09T15:33:38.000Z
- Ranks: newest: 1211, popular: 42, trending: 22
...
| --- | --- | --- | --- | --- | --- |
| Untitled Sans | Inter | 400, 500, 600, 700 | 12px, 14px, 16px, 18px, 24px | 1.17, 1.20, 1.33, 1.43, 1.50, 2.29, 2.57 | Used for all general body text, form elements, button labels, and secondary information. The slight negative letter spacing creates a compact, refined feel. |
| aeonikPro | Space Grotesk | 400, 500 | 28px, 44px, 48px | 1.14, 1.16, 1.17, 1.20 | Exclusively for prominent headings and display text. Its distinct, clean geometry defines the primary content hierarchy and brand voice, appearing slightly wider than Untitled Sans for visual contrast. |
| dotDigital | IBM Plex Mono | 400 | 15px | 1.20 | Used for specific, small informational text. The `tnum` font feature setting ensures consistent monospaced numbers, ideal for technical details or data display. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775923220797-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775923220797-thumb.jpg |
| preview video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/e80231a2-e4d6-406a-a2c9-2e6109679690-1777560541994-preview.mp4 |
| preview video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/e80231a2-e4d6-406a-a2c9-2e6109679690-1777560541994-preview-poster.jpg |
| detail video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/e80231a2-e4d6-406a-a2c9-2e6109679690-1777560541994-preview-detail.mp4 |
| detail video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/e80231a2-e4d6-406a-a2c9-2e6109679690-1777560541994-preview-detail-poster.jpg |
