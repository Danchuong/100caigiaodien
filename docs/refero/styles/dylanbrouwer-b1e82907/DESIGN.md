# Dylanbrouwer — Refero Style

- Refero URL: https://styles.refero.design/style/b1e82907-d1cf-46cd-8ae7-3561c5b15fd0
- Site URL: https://www.dylanbrouwer.design
- ID: b1e82907-d1cf-46cd-8ae7-3561c5b15fd0
- Theme: light
- Industry: design
- Created: 2026-04-30T01:53:24.867Z
- Ranks: newest: 497, popular: 464, trending: 266
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Ink Slate | #3c3a3e | neutral | Neutral form states, badge text, and quiet UI feedback where color should stay understated. Do not promote it to the primary CTA color |
| Ghost Gray | #a2a2a2 | neutral | Secondary text, navigation items, borders, and subtle graphical elements. It provides a softer contrast against darker backgrounds or for less prominent text |
| Canvas White | #ffffff | neutral | Page backgrounds, card backgrounds, and a high-contrast text color against dark elements. Used extensively to create spacious, light areas |
| Platinum Mist | #c9c7cc | neutral | Subtle text variations, borders, and light background elements. It offers a very soft contrast against white or for divider lines |
| Silver Dust | #f1f1f1 | neutral | Backgrounds for alternating sections, subtle card backgrounds, and minor border elements. Contributes to the layered, almost monochrome background structure |
| Cool Stone | #7b7a7c | neutral | Muted text or decorative borders on light surfaces. Provides a medium-dark neutral for various UI elements |
| Deep Space | #161616 | neutral | Darkest background for sections, text, and elements requiring strong contrast, particularly against bright white. Nearly black, used sparingly for emphasis |
| Sunrise Orange | #ff4c24 | accent | Highly vivid accent for decorative elements, images, and brand highlights. Used for its pop against the largely monochromatic UI |
| Action Orange | #ff6436 | accent | Orange state accent for badges, validation surfaces, and short status labels. Do not promote it to the primary CTA color |
| Grey Scale Gradient | #000000 | neutral | Backgrounds, especially for hero sections, creating a dramatic, deep to light transition that influences content visibility |
| Dark Overlay Gradient | #040305 | neutral | Overlays and atmospheric backgrounds where elements need to stand out against a dark, dramatic backdrop |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Die Grotesk B | Arial, Helvetica, sans-serif | 500 | 12px, 17px, 18px, 21px, 36px, 54px, 60px | 1.00, 1.10, 1.25, 1.30 | Primary headings, navigation, and key informational text. Its singular 500 weight emphasizes uniformity and industrial clarity, despite variations in size and tracking. |
| IBM Plex Mono | Consolas, Monaco, monospace | 500, 600 | 12px, 14px | 1.00, 1.20, 1.30 | Utility text, timestamps, code snippets, and minor labels. Its monospace nature provides a technical, data-driven feel in smaller contexts. |
| ABC Gravity Variable | Arial, Helvetica, sans-serif | 400, 500 | 12px, 24px, 96px, 274px, 288px | 0.74, 1.00, 1.30 | Display typography, primarily for hero headlines and impactful, oversized visual statements. Its variable nature allows extreme scale and tight tracking, creating monumental text as a visual centerpiece. |
...
| heading-sm | 21 | 1.1 | -0.21 |
| heading | 36 | 1.1 | -0.36 |
| heading-lg | 54 | 1 | -1.08 |
| display | 288 | 0.74 | -5.76 |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777513977142-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777513977142-thumb.jpg |
