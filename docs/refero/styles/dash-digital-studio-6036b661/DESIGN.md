# Dash Digital Studio — Refero Style

- Refero URL: https://styles.refero.design/style/6036b661-3886-4f76-a5e6-bb8960eb7db5
- Site URL: https://dashdigital.studio
- ID: 6036b661-3886-4f76-a5e6-bb8960eb7db5
- Theme: light
- Industry: agency
- Created: 2026-04-30T01:46:18.939Z
- Ranks: newest: 525, popular: 662, trending: 433
...
| --- | --- | --- | --- | --- | --- |
| Founders Grotesk | Inter | 300, 400 | 12px, 14px, 16px, 17px, 22px, 40px, 70px, 101px | 0.80, 0.88, 0.90, 1.00, 1.17, 1.20 | Primary typeface for all headings, body text, and UI elements. Its strong presence and precise letter-spacing (-0.03em for display sizes, -0.023em for large headings) establish a confident, almost architectural tone. Weight 300 for large headings creates a sense of gravitas without shouting. |
| Editorial Neue | Playfair Display | 400 | 16px | 0.90 | Used sparingly for subtle decorative text elements, secondary information, and captions. Its very tight letter-spacing (-0.06em) creates a distinctive, almost logotype-like quality for small text blocks. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777513521951-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777513521951-thumb.jpg |
