# beehiiv — Refero Style

- Refero URL: https://styles.refero.design/style/350b1557-56f0-4361-8c8b-b7a88081982b
- Site URL: https://beehiiv.com
- ID: 350b1557-56f0-4361-8c8b-b7a88081982b
- Theme: dark
- Industry: saas
- Created: 2026-01-25T19:20:23.000Z
- Ranks: newest: 1272, popular: 306, trending: 350
...
| --- | --- | --- | --- | --- | --- |
| Satoshi | Inter | 400, 500, 600, 700 | 12px, 14px, 16px, 18px, 20px, 24px, 48px | 1.20, 1.25, 1.33, 1.40, 1.43, 1.50, 1.56 | Body copy, links, navigation, buttons, and most informational text. The consistent positive letter-spacing adds a subtle, open feel contrasting with the UI's precision. |
| Clash Grotesk | Archivo | 400, 700 | 16px, 20px, 48px, 60px, 72px | 1.00, 1.20, 1.40, 1.50 | Headlines and display text. Its geometric structure provides a strong, modern presence at larger sizes, reinforcing the tech-oriented brand. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775924730522-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775924730522-thumb.jpg |
