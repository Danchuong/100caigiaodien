...
- Refero URL: https://styles.refero.design/style/ab650279-aa18-43e5-a998-34190d7bedc7
- Site URL: https://fable.co
- ID: ab650279-aa18-43e5-a998-34190d7bedc7
- Theme: light
- Industry: media
- Created: 2026-04-30T03:39:13.201Z
- Ranks: newest: 101, popular: 698, trending: 533
...
| --- | --- | --- | --- | --- | --- |
| Inter | system-ui, sans-serif | 400, 500, 600, 700 | 8px, 10px, 12px, 14px, 15px, 16px, 18px, 20px, 24px, 30px | 1.00, 1.13, 1.17, 1.25, 1.33, 1.42, 1.43, 1.50, 1.60 | Primary body text, labels, small print, and various interface elements. The tight tracking at larger sizes gives it a modern, compact feel. |
| Heldane Display | serif | 400, 500 | 22px, 26px, 48px, 72px, 80px | 0.86, 0.88, 0.94, 1.08, 1.09 | Striking, large-scale headlines. The generous x-height and tight line-height create presence, conveying a sense of classic literature with a modern twist, especially effective at very large sizes like 72px and 80px for hero sections. |
| Aktiv Grotesk | system-ui, sans-serif | 400 | 13px | 1.50 | Used sparingly for specific informational text, like small captions or sub-labels, complementing Inter without overtly competing. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777520321292-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777520321292-thumb.jpg |
