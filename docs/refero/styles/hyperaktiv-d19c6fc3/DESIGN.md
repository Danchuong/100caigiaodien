# HyperAktiv — Refero Style

- Refero URL: https://styles.refero.design/style/d19c6fc3-1fc6-44a0-9c22-a0a82f7f79b4
- Site URL: https://hyperaktiv.li
- ID: d19c6fc3-1fc6-44a0-9c22-a0a82f7f79b4
- Theme: light
- Industry: other
- Created: 2026-04-30T02:57:58.173Z
- Ranks: newest: 259, popular: 647, trending: 455
...
| --- | --- | --- | --- | --- | --- |
| Studiofeixensans | Arial Black, Impact | 400, 700 | 14px, 16px, 20px, 22px, 25px, 28px, 42px, 72px, 80px, 90px | 0.89, 1.00, 1.20, 1.22, 1.43, 1.50, 2.00 | Headings and prominent display text that demand immediate attention. Its heavy weights and condensed appearance contribute to the system's direct, impactful tone. |
| DM Sans | Inter, Lato | 400 | 14px, 16px, 20px | 1.25, 1.43 | Body copy, input text, and more subtle information. Its legibility balances the bold, aggressive nature of the display font. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777517851496-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777517851496-thumb.jpg |
