# Ordinal — Refero Style

- Refero URL: https://styles.refero.design/style/4657db98-0c6c-4848-91e9-c339f3bb7815
- Site URL: https://www.meetassembly.com
- ID: 4657db98-0c6c-4848-91e9-c339f3bb7815
- Theme: dark
- Industry: saas
- Created: 2026-04-30T00:43:27.975Z
- Ranks: newest: 716, popular: 916, trending: 836
...
| --- | --- | --- | --- | --- | --- |
| Inter | system-ui | 400, 500 | 13px, 17px, 27px, 40px, 53px, 60px | 1.00, 1.20, 1.50 | Primary typeface for all UI elements, headlines, body text, and links. Its clean, modern lines support the system's focus on clarity and efficiency, with moderate tracking at larger sizes (-0.0300em for 60px and -0.0100em for 40px and 53px) to prevent headlines from feeling too loose. |
| Inconsolata-Eyebrow | monospace | 400, 500 | 13px, 17px | 1.00, 1.50 | Used for smaller, functional UI text like badges, navigation, and supplementary information. Its slightly wider, geometric nature provides a subtle contrast to Inter, adding a 'coding-like' or 'system' feel without being overly technical. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777509780773-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777509780773-thumb.jpg |
