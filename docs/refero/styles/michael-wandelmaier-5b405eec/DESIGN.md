# Michael Wandelmaier — Refero Style

- Refero URL: https://styles.refero.design/style/5b405eec-67ba-4dd0-8dab-ace000151a78
- Site URL: https://wandelmaier.com
- ID: 5b405eec-67ba-4dd0-8dab-ace000151a78
- Theme: dark
- Industry: design
- Created: 2026-04-30T02:34:43.010Z
- Ranks: newest: 344, popular: 688, trending: 589
...
| --- | --- | --- | --- | --- | --- |
| PolySans | system-ui | 100 | 12px, 24px, 32px, 187px | 0.90, 1.00, 1.33, 2.50, 2.67 | Headings and prominent display text that demand attention with a wide, almost whispering character. Its extreme lightness is a signature element. |
| Canela Web | Playfair Display | 100 | 40px, 50px, 80px | 1.20, 1.30, 2.40 | Editorial headings, creating an elegant, serif counterpoint to the sans-serif. Its light weight keeps it refined. |
| sans-serif | Arial | 400 | 16px | 1.20 | Body text and functional UI elements where clarity and neutrality are prioritized. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777516460921-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777516460921-thumb.jpg |
