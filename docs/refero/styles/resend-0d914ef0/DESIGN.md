...
- Refero URL: https://styles.refero.design/style/0d914ef0-fa84-4c60-a9aa-cef0b5eb6e5d
- Site URL: https://resend.com
- ID: 0d914ef0-fa84-4c60-a9aa-cef0b5eb6e5d
- Theme: dark
- Industry: devtools
- Created: 2026-03-08T15:13:01.000Z
- Ranks: newest: 1073, popular: 28, trending: 39
...
| --- | --- | --- | --- | --- | --- |
| Inter | Inter (free via Google Fonts) | 400, 500, 600 | 12px, 14px, 16px, 18px, 24px | 1.33–1.60 | All UI chrome — nav, buttons, body copy, captions, links. The workhorse that disappears into the interface. 600 weight used for interactive emphasis, 400 for running text. |
| Domaine | DM Serif Display, Playfair Display | 400 | 77px, 96px | 1.00 | Display-only serif for the largest hero statements and section closers. Weight 400 at near-100px is anti-convention — most dev tools use grotesque sans at this scale, the serif creates authority through editorial restraint. Tightest tracking in the system. |
| ABCFavorit | ABC Favorit (commercial), Söhne, GT America | 400, 500 | 14px, 16px, 20px, 56px | 1.00–1.50 | Section headings and subheadings. At 56px weight 400 with -0.05em tracking, punches well above its point size. At 14-20px used for feature labels and callouts. The custom geometric grotesque gives sharper corners than Inter, distinguishing marketing headings from UI copy. |
| CommitMono | JetBrains Mono, Fira Code | 400 | 12px, 14px, 16px | 1.33–1.50 | Code samples, badge labels, filename strings, and terminal-style inline snippets. Distinguishes developer content from prose at a glance — the monospace voice signals 'this is actual code', not metaphor. |
| Helvetica |  | 400, 600, 700 | 14px | 1, 1.71 | Helvetica — detected in extracted data but not described by AI |
| -apple-system |  | 400 | 14px | 1.5, 1.55 | -apple-system — detected in extracted data but not described by AI |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777504739936-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777504739936-thumb.jpg |
| preview video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/0d914ef0-fa84-4c60-a9aa-cef0b5eb6e5d-1777557430073-preview.mp4 |
| preview video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/0d914ef0-fa84-4c60-a9aa-cef0b5eb6e5d-1777557430073-preview-poster.jpg |
| detail video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/0d914ef0-fa84-4c60-a9aa-cef0b5eb6e5d-1777557430073-preview-detail.mp4 |
| detail video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/0d914ef0-fa84-4c60-a9aa-cef0b5eb6e5d-1777557430073-preview-detail-poster.jpg |
