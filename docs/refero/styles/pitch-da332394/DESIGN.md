...
- Refero URL: https://styles.refero.design/style/da332394-784c-4df2-9e66-c3f7b1d28f28
- Site URL: https://pitch.com
- ID: da332394-784c-4df2-9e66-c3f7b1d28f28
- Theme: light
- Industry: productivity
- Created: 2026-03-03T12:47:21.000Z
- Ranks: newest: 1100, popular: 60, trending: 721
...
| --- | --- | --- | --- | --- | --- |
| Eina01 | Inter | 400, 600, 700, 800 | 13px, 14px, 15px, 16px, 18px, 22px, 24px, 28px | 1.00, 1.10, 1.20, 1.30, 1.40, 1.60, 1.69, 2.00, 2.25 | Primary UI and body text font. Its regular weights (400, 600) ensure readability for extensive copy, while its extended size range supports diverse UI elements from caption to sub-heading. Used for links, icons, buttons, and general informational text. |
| Mark Pro | Montserrat | 700, 800 | 13px, 27px, 28px, 42px, 60px, 80px | 1.00, 1.10, 1.30, 1.40, 1.85 | Distinctive display font for headings and prominent card titles. Its heavier weights (700, 800) and tighter letter-spacing create a bold, modern statement without being aggressive, contributing significantly to brand identity. Used across major headings and highlighted content. |
| Arial | sans-serif | 400 | 13px | 1.20 | System fallback for specific button text, ensuring accessibility if custom fonts are unavailable. Used sparingly. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1776118920648-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1776118920648-thumb.jpg |
| preview video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/da332394-784c-4df2-9e66-c3f7b1d28f28-1777554493298-preview.mp4 |
| preview video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/da332394-784c-4df2-9e66-c3f7b1d28f28-1777554493298-preview-poster.jpg |
| detail video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/da332394-784c-4df2-9e66-c3f7b1d28f28-1777554493298-preview-detail.mp4 |
| detail video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/da332394-784c-4df2-9e66-c3f7b1d28f28-1777554493298-preview-detail-poster.jpg |
