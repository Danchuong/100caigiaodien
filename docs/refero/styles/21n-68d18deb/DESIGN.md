...
- Refero URL: https://styles.refero.design/style/68d18deb-bb09-4258-8024-001af9c844c0
- Site URL: https://memotron.app
- ID: 68d18deb-bb09-4258-8024-001af9c844c0
- Theme: light
- Industry: other
- Created: 2026-03-05T12:03:03.000Z
- Ranks: newest: 1091, popular: 252, trending: 258
...
| --- | --- | --- | --- | --- | --- |
| Sen | system-ui, sans-serif | 400, 500, 600, 700 | 13px, 15px, 16px, 17px, 19px, 22px, 36px, 44px, 56px | 1.07, 1.25, 1.50, 1.75, 1.94, 2.21 | Primary typeface for all text content; its clean, geometric forms with slightly rounded terminals contribute to both modern clarity for headings and comfortable readability for body text. The range of weights provides flexibility for hierarchy without introducing a second font family. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775933489320-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775933489320-thumb.jpg |
