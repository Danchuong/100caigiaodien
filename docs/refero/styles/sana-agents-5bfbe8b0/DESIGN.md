# Sana Agents — Refero Style

- Refero URL: https://styles.refero.design/style/5bfbe8b0-de0e-470f-b130-929f50437160
- Site URL: https://sana.ai
- ID: 5bfbe8b0-de0e-470f-b130-929f50437160
- Theme: light
- Industry: ai
- Created: 2026-03-05T20:20:57.000Z
- Ranks: newest: 1088, popular: 99, trending: 79
...
| --- | --- | --- | --- | --- | --- |
| Sana Serif | Playfair Display | 400 | 72px | 1.10 | Display headings. The single 72px size and serif face at weight 400 make a strong, non-shouting statement, conveying established authority. |
| Sana Sans | Inter | 400, 450, 500 | 13px, 14px, 16px, 20px | 1.20, 1.40, 1.43, 1.50 | Body text, navigation, buttons, and most interactive elements. Its varied weights provide flexibility for hierarchy while maintaining a clean, modern feel across interface elements. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775932624961-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775932624961-thumb.jpg |
