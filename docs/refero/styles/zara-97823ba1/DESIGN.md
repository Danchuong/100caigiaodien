...
- Refero URL: https://styles.refero.design/style/97823ba1-ee1e-489d-aefd-8d72a578669a
- Site URL: https://zara.com
- ID: 97823ba1-ee1e-489d-aefd-8d72a578669a
- Theme: light
- Industry: ecommerce
- Created: 2026-03-02T16:12:17.000Z
- Ranks: newest: 1105, popular: 528, trending: 621
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Pitch Black | #000000 | neutral | Primary text, borders, icons, form outlines. This is the dominant dark against the luminous white. |
| Luminous White | #ffffff | neutral | Page backgrounds, card surfaces, button fills – the expansive canvas for all content. |
| Subtle Gray | #757575 | neutral | Secondary text, subtle borders, inactive states – provides a slight tonal variation without introducing color. |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| Helvetica Now Text | Helvetica Neue, Arial, sans-serif | 300, 400 | 11px, 12px, 13px, 15px, 16px | 1.00, 1.23, 1.45, 1.50, 1.54, 1.60 | Universal sans-serif for all text, conveying a contemporary and no-nonsense tone. The consistent use of only two weights across all sizes reinforces the brand's directness. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775926257707-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775926257707-thumb.jpg |
