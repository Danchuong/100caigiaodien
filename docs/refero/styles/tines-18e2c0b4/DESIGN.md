...
- Refero URL: https://styles.refero.design/style/18e2c0b4-f29c-4e84-90b0-1d8066b59409
- Site URL: https://www.tines.com
- ID: 18e2c0b4-f29c-4e84-90b0-1d8066b59409
- Theme: light
- Industry: saas
- Created: 2026-04-30T00:54:58.224Z
- Ranks: newest: 665, popular: 757, trending: 657
...
| --- | --- | --- | --- | --- | --- |
| Roobert | system-ui | 400, 500, 600, 700, 900 | 10px, 11px, 12px, 13px, 14px, 16px, 18px | 1.00, 1.15, 1.20, 1.25, 1.40 | Primary sans-serif for all body text, navigational elements, and most UI components. Its geometric neutrality balances the more expressive display font. |
| Reckless | serif | 300, 400, 500, 600, 700 | 20px, 22px, 24px, 26px, 28px, 46px, 52px, 64px, 72px | 0.90, 0.98, 1.00, 1.05, 1.10, 1.20, 1.40 | Display serif font for all primary headlines and marketing copy. Its subtle elegance provides a distinctive character, contrasting with the utilitarian sans-serif. The negative letter-spacing for large sizes creates a tight, considered appearance. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777510457315-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777510457315-thumb.jpg |
