...
- Refero URL: https://styles.refero.design/style/6f428c12-ba43-48e3-9a52-299ec1ce509b
- Site URL: https://19-86.fr
- ID: 6f428c12-ba43-48e3-9a52-299ec1ce509b
- Theme: light
- Industry: agency
- Created: 2026-02-18T13:30:35.000Z
- Ranks: newest: 1167, popular: 542, trending: 631
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Obsidian Black | #000000 | neutral | Primary text, headings, table lines, accent dots — provides stark contrast on white, suggesting permanence and clarity. |
| Pure White | #FFFFFF | neutral | Page backgrounds, surface elements — establishes a clean, expansive canvas. |
| Ash Gray | #8C8C8C | neutral | Link text in inactive state — offers a subtle desaturation from primary black, indicating interactive but not primary status. |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| store_norske_ja_light | Montserrat | 400 | 24px, 490px | 1.00, 1.20 | All textual content, from body copy to oversized display numbers. The single light weight (400) even at large sizes is the signature, providing an authoritative yet non-aggressive presence due to its subtlety. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775926168148-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775926168148-thumb.jpg |
