...
- Refero URL: https://styles.refero.design/style/43c1b150-0dab-42f9-9bce-fe0be3dde26c
- Site URL: https://delphi.ai
- ID: 43c1b150-0dab-42f9-9bce-fe0be3dde26c
- Theme: light
- Industry: ai
- Created: 2026-01-28T11:34:45.000Z
- Ranks: newest: 1264, popular: 95, trending: 90
...
| --- | --- | --- | --- | --- | --- |
| Martina Plantijn Light | Source Serif Pro | 300, 400, 700 | 10px, 12px, 14px, 15px, 20px, 24px, 40px, 56px, 64px | 1.00, 1.20, 1.22, 1.32, 1.34 | Primary display and headline font for all large text, creating an inviting, antique, and intellectual tone. The liberal use of negative letter-spacing for large sizes is a signature choice, drawing characters closer for a cohesive, refined look. |
| Inter | Inter | 400, 500 | 10px, 13px, 14px, 15px, 17px | 1.00, 1.20, 1.40 | Dominant sans-serif for body text, navigation items, and descriptions, providing contemporary readability against the more expressive display font. |
| sans-serif | Arial | 400 | 12px | 1.20 | Fallback and utilitarian text where robust readability is paramount, such as system messages or very small captions. |
| Roboto Mono | Roboto Mono | 400 | 13px | 1.40 | Monospaced font used for data, code snippets, or any content requiring exact character alignment. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775923753149-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775923753149-thumb.jpg |
| preview video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/43c1b150-0dab-42f9-9bce-fe0be3dde26c-1777561018396-preview.mp4 |
| preview video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/43c1b150-0dab-42f9-9bce-fe0be3dde26c-1777561018396-preview-poster.jpg |
| detail video | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/43c1b150-0dab-42f9-9bce-fe0be3dde26c-1777561018396-preview-detail.mp4 |
| detail video poster | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/43c1b150-0dab-42f9-9bce-fe0be3dde26c-1777561018396-preview-detail-poster.jpg |
