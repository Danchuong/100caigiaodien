# v0 by Vercel — Refero Style

- Refero URL: https://styles.refero.design/style/50aa2b8e-4760-4379-a3c1-59b65d8576a7
- Site URL: https://v0.dev
- ID: 50aa2b8e-4760-4379-a3c1-59b65d8576a7
- Theme: light
- Industry: ai
- Created: 2026-03-02T14:07:22.000Z
- Ranks: newest: 1106, popular: 180, trending: 522
...
| --- | --- | --- | --- | --- | --- |
| GeistSans | Inter | 400, 500, 600 | 13px, 14px, 15px, 16px, 18px, 20px, 24px, 32px, 48px | 1.00, 1.17, 1.25, 1.30, 1.33, 1.43, 1.50, 1.56 | The universal font for all UI text, from body copy to display headings. Weight 600 is used for major headlines, 500 for buttons, and 400 for body text. Its signature is the aggressive negative letter-spacing at large sizes, creating dense, block-like headlines. |
| GeistMono | IBM Plex Mono | 400 | 10px | 1.50 | Used for small, technical annotations or user statistics where tabular alignment is beneficial. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775929113104-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775929113104-thumb.jpg |
