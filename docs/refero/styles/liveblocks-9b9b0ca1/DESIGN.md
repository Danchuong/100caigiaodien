# Liveblocks — Refero Style

- Refero URL: https://styles.refero.design/style/9b9b0ca1-5067-4115-b62f-ee0e43d1f37f
- Site URL: https://liveblocks.io
- ID: 9b9b0ca1-5067-4115-b62f-ee0e43d1f37f
- Theme: dark
- Industry: devtools
- Created: 2026-02-11T10:43:40.000Z
- Ranks: newest: 1202, popular: 327, trending: 375
...
| --- | --- | --- | --- | --- | --- |
| suisse | system-ui | 400 | 10px, 11px, 12px, 14px, 16px, 20px, 24px, 32px, 48px, 52px, 60px, 64px | 1.00, 1.05, 1.10, 1.20, 1.25, 1.33, 1.38, 1.43, 1.50 | Primary typeface for all UI elements, headings, body text, and navigation. Its condensed nature at smaller sizes paired with expansive line heights for headlines creates a modern, precise feel. The use of custom letter-spacing across different sizes provides refined typographic control. |
| JetBrains Mono | monospace | 400, 500 | 10px, 14px | 1.00, 1.43 | Monospaced font for code snippets, technical details, and any output requiring precise alignment. Its uniform character width reinforces the data-driven aesthetic. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775923154919-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775923154919-thumb.jpg |
