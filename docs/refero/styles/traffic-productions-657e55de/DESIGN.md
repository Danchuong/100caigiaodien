# Traffic Productions — Refero Style

- Refero URL: https://styles.refero.design/style/657e55de-8cff-4d24-9a4e-17d3b7593a55
- Site URL: https://traffic.productions
- ID: 657e55de-8cff-4d24-9a4e-17d3b7593a55
- Theme: light
- Industry: agency
- Created: 2026-02-17T17:35:33.000Z
- Ranks: newest: 1171, popular: 319, trending: 313
...
| --- | --- | --- | --- | --- | --- |
| Suisse | Open Sans Condensed / Source Sans 3 (condensed weights) | 400, 700 | 12px, 18px, 30px, 54px, 84px, 108px | 0.89, 0.93, 0.96, 1.00, 1.17 | The sole typeface, Suisse, is a custom condensed sans-serif, giving the entire site a direct, impactful, and almost industrial voice. The tight letter-spacing and low line-height create dense blocks of text, resembling a printed layout rather than a fluid digital interface. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775927611871-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775927611871-thumb.jpg |
