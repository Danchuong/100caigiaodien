# Peloton — Refero Style

- Refero URL: https://styles.refero.design/style/355e8465-df7d-486a-9d76-2ace37d076a2
- Site URL: https://onepeloton.com
- ID: 355e8465-df7d-486a-9d76-2ace37d076a2
- Theme: dark
- Industry: ecommerce
- Created: 2026-01-30T20:49:55.000Z
- Ranks: newest: 1252, popular: 535, trending: 871
...
| --- | --- | --- | --- | --- | --- |
| Inter | system-ui, sans-serif | 300, 400, 500, 600, 700 | 12px, 14px, 15px, 16px, 18px, 20px, 26px, 32px, 36px, 48px | 1.07, 1.20, 1.25, 1.30, 1.33, 1.38, 1.39, 1.50, 1.69, 1.71 | The sole typeface, Inter, handles all text roles from body to display. Its modern, sans-serif neutrality supports the technical-yet-approachable brand image. Usage of varied weights, particularly 300 for some larger text and a prominent 0.0250em tracking on some elements, allows for distinct vocal tones without introducing new fonts. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775924991526-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1775924991526-thumb.jpg |
