...
- Refero URL: https://styles.refero.design/style/cbd8a058-6ecb-4f1b-9b5a-2bf2597826ee
- Site URL: https://sprig.com
- ID: cbd8a058-6ecb-4f1b-9b5a-2bf2597826ee
- Theme: light
- Industry: ai
- Created: 2026-04-30T01:02:04.534Z
- Ranks: newest: 641, popular: 1039, trending: 989
...
| --- | --- | --- | --- | --- | --- |
| ABC Diatype | Inter | 400, 500 | 14px, 16px, 24px, 32px, 40px | 1.20, 1.30, 1.40 | Headings, body text, links, and buttons. Its clean, geometric forms provide a modern, functional voice. |
| TT Commons Pro | Montserrat | 400 | 16px, 18px, 40px | 1.50 | Used for specific body text, hero text, and badges, complementing ABC Diatype with geometric simplicity. |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777510882930-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777510882930-thumb.jpg |
