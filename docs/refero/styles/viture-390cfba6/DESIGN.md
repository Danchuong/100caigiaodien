...
- Refero URL: https://styles.refero.design/style/390cfba6-8c2f-4273-8c9e-750d470b6e2e
- Site URL: https://www.viture.com
- ID: 390cfba6-8c2f-4273-8c9e-750d470b6e2e
- Theme: light
- Industry: ecommerce
- Created: 2026-04-30T01:32:42.708Z
- Ranks: newest: 577, popular: 875, trending: 771
...
| Name | Hex | Group | Role |
| --- | --- | --- | --- |
| Midnight | #0c0c0c | neutral | Primary text, deep surface backgrounds, strong borders — establishing the core dark contrast against light surfaces |
| Canvas White | #ffffff | neutral | Page backgrounds, card surfaces, primary button text, interactive element outlines — providing luminosity and clean separation |
| Ash Gray | #7e7e7f | neutral | Muted text, secondary information, subtle borders — offering a softer contrast than Midnight |
| Ink Black | #000000 | neutral | Footer backgrounds, overlay elements — for maximum depth and visual separation |
| Silver Mist | #949597 | neutral | Subtle background panels, alternative card backgrounds, ghost button fills — for soft structural differentiation |
| Light Frost | #f7f7f8 | neutral | Elevated card backgrounds, input fields — a slightly off-white serving as a secondary surface |
| Pale Clay | #eff0f3 | neutral | Tertiary card backgrounds, subtle UI elements — a very light gray for minimal contrast against Canvas White |
| Storm Gray | #5b5c5d | neutral | Placeholder text, subtle contextual accents — providing a medium-dark neutral for interface details |
| Muted Clay | #abacae | neutral | Lightest grey for disabled states, hairline borders, very soft secondary text |
| Blaze Orange | #ff5f34 | brand | Primary calls to action, accent branding, active states, important links — providing a vibrant focal point; Error messages, destructive actions, form validation feedback — consistent with brand orange but in semantic context; Branded hero sections, spotlight effects on product imagery — creating a dynamic, electric visual |
| Deep Sunset Gradient | #ff2900 | brand | Promotional banners, background washes for featured content — a rich, dramatic multi-hue blend |

## Typography

| Family | Substitute | Weights | Sizes | Line Height | Role |
| --- | --- | --- | --- | --- | --- |
| FontSeasonSans | Inter | 400, 500, 600, 700, 800 | 12px, 14px, 16px, 20px, 23px, 28px, 32px, 60px, 72px, 105px, 340px | 1.00, 1.20, 1.25, 1.33, 1.35, 1.38, 1.40, 1.43, 1.50, 1.63 | The primary typeface for all text content, from subtle captions to heroic display headings. Its versatility across weights and a range of sizes supports both clarity in detail and strong visual impact for brand messaging. Varied letter-spacing tightens very small text and provides openness for large headings. |

## Type Scale

| Role | Size | Line Height | Letter Spacing |
| --- | --- | --- | --- |
| caption | 12 | 1.4 | 0.144 |
| body-sm | 14 | 1.5 | 0.28 |
| body | 16 | 1.63 | 0.416 |
| subheading | 20 | 1.35 | 1 |
| heading-sm | 23 | 1.33 |  |
| heading | 28 | 1.25 |  |
| heading-lg | 32 | 1.2 |  |
| display | 60 | 1 |  |
...
| Type | URL |
| --- | --- |
| screenshot | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777512735526-screenshot.jpg |
| thumbnail | https://ysxnuuuj3kqhdyj2.public.blob.vercel-storage.com/1777512735526-thumb.jpg |
