...
12. Chỉ đổi status trong `100-design-board.md` khi đã pass QA/delivery.
...
```text
docs/archive/100-home-design-research/
docs/archive/client-fit-research/
```
