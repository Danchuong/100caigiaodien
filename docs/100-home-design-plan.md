...
1. Mở `100-home-styles.md`.
2. Đọc block đúng `des-N`.
3. Tạo hoặc cập nhật brief trong `docs/design-research/des-briefs/des-N.md`.
4. Chọn source stack: getdesign chính, Refero phụ, direction game/news/directory.
5. Chỉ sau khi brief đủ rõ mới sửa source theme.
...
11. Chỉ đổi status trong `100-home-styles.md` khi đã pass QA/delivery.
