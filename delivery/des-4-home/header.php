...
$des4_nav_title_filter = static function ( $items ) {
            ...
            <div class="head-nav-row">
                <div class="container">
                    <nav id="primary-menu" class="main-navigation" aria-label="Primary menu">
                        <?php
                        add_filter( 'wp_nav_menu_objects', $des4_nav_title_filter );
                        wp_nav_menu(
                            array(
                        ...
                        remove_filter( 'wp_nav_menu_objects', $des4_nav_title_filter );
                        ?>
                    </nav>
                </div>
            </div>
