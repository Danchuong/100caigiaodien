        ...
        <span class="game-tile-rating" aria-label="<?php echo esc_attr( sprintf( __( '%s out of 5 stars', 'h5game' ), $rating_label ) ); ?>">
            <span class="game-tile-stars" aria-hidden="true">
                <?php for ( $star = 1; $star <= 5; $star++ ) : ?>
                    ...
                    } elseif ( $has_half && $star === $full_stars + 1 ) {
                        $star_class = 'is-half';
                    }
                    ?>
    ...
    <div class="container">
        <div class="mosaic-lead">
            <div class="mosaic-lead-left">
                <div class="mosaic-kicker">Featured Channel</div>
                <h1 class="mosaic-title">Game stories, reviews, and playable picks for today.</h1>
            </div>
        </div>
        ...
        if ( $mosaic_query->have_posts() ) :
            ...
            <div class="mosaic-grid">
                ...
                while ( $mosaic_query->have_posts() ) :
                    ...
                    $card_class  .= $image_url ? ' has-image' : ' has-fallback';
                    ?>
                    <a class="<?php echo esc_attr( $card_class ); ?>" href="<?php echo esc_url( get_permalink() ); ?>">
                        <span class="mosaic-image"<?php echo $image_url ? ' style="background-image: url(' . esc_url( $image_url ) . ')"' : ''; ?>></span>
        ...
        if ( $blog_query->have_posts() ) :
            ...
            <div class="blog-wall">
                ...
                while ( $blog_query->have_posts() ) :
                    ...
                    $image_url = has_post_thumbnail() ? wp_get_attachment_url( get_post_thumbnail_id() ) : '';
                    ?>
                    <a class="blog-wall-item<?php echo $image_url ? ' has-image' : ' has-fallback'; ?>" href="<?php echo esc_url( get_permalink() ); ?>">
                        <span class="blog-wall-image"<?php echo $image_url ? ' style="background-image: url(' . esc_url( $image_url ) . ')"' : ''; ?>></span>
        ...
        if ( $review_query->have_posts() ) :
            ...
            <div class="review-lane">
                ...
                while ( $review_query->have_posts() ) :
                    ...
                    $image_url = has_post_thumbnail() ? wp_get_attachment_url( get_post_thumbnail_id() ) : '';
                    ?>
                    <a class="review-lane-item<?php echo $image_url ? ' has-image' : ' has-fallback'; ?>" href="<?php echo esc_url( get_permalink() ); ?>">
                        <span class="review-lane-image"<?php echo $image_url ? ' style="background-image: url(' . esc_url( $image_url ) . ')"' : ''; ?>></span>
        ...
        if ( $game_query->have_posts() ) :
            ...
            <div class="game-tile-grid">
                ...
                while ( $game_query->have_posts() ) :
                    ...
                    $image_url = has_post_thumbnail() ? wp_get_attachment_url( get_post_thumbnail_id() ) : '';
                    ?>
                    <a class="game-tile<?php echo $image_url ? ' has-image' : ' has-fallback'; ?>" href="<?php echo esc_url( get_permalink() ); ?>">
                        <span class="game-tile-image"<?php echo $image_url ? ' style="background-image: url(' . esc_url( $image_url ) . ')"' : ''; ?>></span>
